...
> string buyercontract_batch_download_v1(pki_buyercontract_id => $pki_buyercontract_id, buyercontract_batch_download_v1_request => $buyercontract_batch_download_v1_request)
...
my $buyercontract_batch_download_v1_request = EzmaxApi::Object::BuyercontractBatchDownloadV1Request->new(); # BuyercontractBatchDownloadV1Request | 

eval {
    my $result = $api_instance->buyercontract_batch_download_v1(pki_buyercontract_id => $pki_buyercontract_id, buyercontract_batch_download_v1_request => $buyercontract_batch_download_v1_request);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling ObjectBuyercontractApi->buyercontract_batch_download_v1: $@\n";
}
```
...
> BuyercontractGetAttachmentsV1Response buyercontract_get_attachments_v1(pki_buyercontract_id => $pki_buyercontract_id)
...
eval {
    my $result = $api_instance->buyercontract_get_attachments_v1(pki_buyercontract_id => $pki_buyercontract_id);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling ObjectBuyercontractApi->buyercontract_get_attachments_v1: $@\n";
}
```
