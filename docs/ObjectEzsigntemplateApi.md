...
> EzsigntemplateEditObjectV3Response ezsigntemplate_edit_object_v3(pki_ezsigntemplate_id => $pki_ezsigntemplate_id, ezsigntemplate_edit_object_v3_request => $ezsigntemplate_edit_object_v3_request)
