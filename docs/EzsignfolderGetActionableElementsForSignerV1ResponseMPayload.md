# EzmaxApi::Object::EzsignfolderGetActionableElementsForSignerV1ResponseMPayload

## Load the model package
```perl
use EzmaxApi::Object::EzsignfolderGetActionableElementsForSignerV1ResponseMPayload;
```
