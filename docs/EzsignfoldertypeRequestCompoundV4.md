# EzmaxApi::Object::EzsignfoldertypeRequestCompoundV4

## Load the model package
```perl
use EzmaxApi::Object::EzsignfoldertypeRequestCompoundV4;
```
...
**a_fki_userlogintype_id** | **ARRAY[int]** |  | 
**a_fki_usergroup_id_all** | **ARRAY[int]** |  | [optional] 
**a_fki_usergroup_id_restricted** | **ARRAY[int]** |  | [optional] 
**a_fki_usergroup_id_template** | **ARRAY[int]** |  | [optional] 
...
**e_ezsignfoldertype_documentmerge** | [**FieldEEzsignfoldertypeDocumentmerge**](FieldEEzsignfoldertypeDocumentmerge.md) |  | [optional] 
