# EzmaxApi::Object::EzsigntemplateglobalannotationResponse

## Load the model package
```perl
use EzmaxApi::Object::EzsigntemplateglobalannotationResponse;
```
...
**fki_ezsigntemplateglobaldocumentpage_id** | **int** | The unique ID of the Ezsigntemplateglobaldocumentpage | 
