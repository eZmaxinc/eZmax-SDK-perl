...
> string invoice_batch_download_v1(pki_invoice_id => $pki_invoice_id, invoice_batch_download_v1_request => $invoice_batch_download_v1_request)
...
my $invoice_batch_download_v1_request = EzmaxApi::Object::InvoiceBatchDownloadV1Request->new(); # InvoiceBatchDownloadV1Request | 

eval {
    my $result = $api_instance->invoice_batch_download_v1(pki_invoice_id => $pki_invoice_id, invoice_batch_download_v1_request => $invoice_batch_download_v1_request);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling ObjectInvoiceApi->invoice_batch_download_v1: $@\n";
}
```
