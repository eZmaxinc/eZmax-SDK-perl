...
> EzsigntemplatepackagesignerCreateObjectV2Response ezsigntemplatepackagesigner_create_object_v2(ezsigntemplatepackagesigner_create_object_v2_request => $ezsigntemplatepackagesigner_create_object_v2_request)
...
my $ezsigntemplatepackagesigner_create_object_v2_request = EzmaxApi::Object::EzsigntemplatepackagesignerCreateObjectV2Request->new(); # EzsigntemplatepackagesignerCreateObjectV2Request | 

eval {
    my $result = $api_instance->ezsigntemplatepackagesigner_create_object_v2(ezsigntemplatepackagesigner_create_object_v2_request => $ezsigntemplatepackagesigner_create_object_v2_request);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling ObjectEzsigntemplatepackagesignerApi->ezsigntemplatepackagesigner_create_object_v2: $@\n";
}
```
...
> EzsigntemplatepackagesignerEditObjectV2Response ezsigntemplatepackagesigner_edit_object_v2(pki_ezsigntemplatepackagesigner_id => $pki_ezsigntemplatepackagesigner_id, ezsigntemplatepackagesigner_edit_object_v2_request => $ezsigntemplatepackagesigner_edit_object_v2_request)
...
my $pki_ezsigntemplatepackagesigner_id = 56; # int | 
my $ezsigntemplatepackagesigner_edit_object_v2_request = EzmaxApi::Object::EzsigntemplatepackagesignerEditObjectV2Request->new(); # EzsigntemplatepackagesignerEditObjectV2Request | 

eval {
    my $result = $api_instance->ezsigntemplatepackagesigner_edit_object_v2(pki_ezsigntemplatepackagesigner_id => $pki_ezsigntemplatepackagesigner_id, ezsigntemplatepackagesigner_edit_object_v2_request => $ezsigntemplatepackagesigner_edit_object_v2_request);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling ObjectEzsigntemplatepackagesignerApi->ezsigntemplatepackagesigner_edit_object_v2: $@\n";
}
```
...
> EzsigntemplatepackagesignerGetObjectV3Response ezsigntemplatepackagesigner_get_object_v3(pki_ezsigntemplatepackagesigner_id => $pki_ezsigntemplatepackagesigner_id)
...
eval {
    my $result = $api_instance->ezsigntemplatepackagesigner_get_object_v3(pki_ezsigntemplatepackagesigner_id => $pki_ezsigntemplatepackagesigner_id);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling ObjectEzsigntemplatepackagesignerApi->ezsigntemplatepackagesigner_get_object_v3: $@\n";
}
```
