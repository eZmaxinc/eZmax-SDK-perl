...
> EzsigntemplatepackagesignerGetObjectV1Response ezsigntemplatepackagesigner_get_object_v1(pki_ezsigntemplatepackagesigner_id => $pki_ezsigntemplatepackagesigner_id)
...
eval {
    my $result = $api_instance->ezsigntemplatepackagesigner_get_object_v1(pki_ezsigntemplatepackagesigner_id => $pki_ezsigntemplatepackagesigner_id);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling ObjectEzsigntemplatepackagesignerApi->ezsigntemplatepackagesigner_get_object_v1: $@\n";
}
```
