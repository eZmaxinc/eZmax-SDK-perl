# EzmaxApi::Object::EzsigndocumentCreateEzsignelementsPositionedByWordV2Request

## Load the model package
```perl
use EzmaxApi::Object::EzsigndocumentCreateEzsignelementsPositionedByWordV2Request;
```
