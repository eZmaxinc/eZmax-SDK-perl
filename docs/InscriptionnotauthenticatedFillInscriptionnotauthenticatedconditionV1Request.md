# EzmaxApi::Object::InscriptionnotauthenticatedFillInscriptionnotauthenticatedconditionV1Request

## Load the model package
```perl
use EzmaxApi::Object::InscriptionnotauthenticatedFillInscriptionnotauthenticatedconditionV1Request;
```
