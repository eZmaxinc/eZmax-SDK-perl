...
> EzsigntemplatepackagemembershipGetObjectV1Response ezsigntemplatepackagemembership_get_object_v1(pki_ezsigntemplatepackagemembership_id => $pki_ezsigntemplatepackagemembership_id)
...
eval {
    my $result = $api_instance->ezsigntemplatepackagemembership_get_object_v1(pki_ezsigntemplatepackagemembership_id => $pki_ezsigntemplatepackagemembership_id);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling ObjectEzsigntemplatepackagemembershipApi->ezsigntemplatepackagemembership_get_object_v1: $@\n";
}
```
