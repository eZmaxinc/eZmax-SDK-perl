# EzmaxApi::Object::EzsigndocumentResponseCompoundV3

## Load the model package
```perl
use EzmaxApi::Object::EzsigndocumentResponseCompoundV3;
```
...
**i_ezsigndocument_steptotal** | **int** | The total number of steps | 
**i_ezsigndocument_stepcurrent** | **int** | The current step | 
