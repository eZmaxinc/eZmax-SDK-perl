# EzmaxApi::Object::EzsigndocumentGetActionableElementsForSignerV1ResponseMPayload

## Load the model package
```perl
use EzmaxApi::Object::EzsigndocumentGetActionableElementsForSignerV1ResponseMPayload;
```
