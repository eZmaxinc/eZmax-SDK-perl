...
> CommonGetAutocompleteV1Response branding_get_autocomplete_v1(s_selector => $s_selector, e_filter_active => $e_filter_active, s_query => $s_query, accept_language => $accept_language)
...
eval {
    my $result = $api_instance->branding_get_autocomplete_v1(s_selector => $s_selector, e_filter_active => $e_filter_active, s_query => $s_query, accept_language => $accept_language);
    print Dumper($result);
};
if ($@) {
...
> BrandingGetObjectV1Response branding_get_object_v1(pki_branding_id => $pki_branding_id)
...
eval {
    my $result = $api_instance->branding_get_object_v1(pki_branding_id => $pki_branding_id);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling ObjectBrandingApi->branding_get_object_v1: $@\n";
}
```
