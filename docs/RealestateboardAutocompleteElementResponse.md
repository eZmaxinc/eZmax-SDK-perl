# EzmaxApi::Object::RealestateboardAutocompleteElementResponse

## Load the model package
```perl
use EzmaxApi::Object::RealestateboardAutocompleteElementResponse;
```

## Properties
Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**pki_realestateboard_id** | **int** | The unique ID of the Activesession | 
