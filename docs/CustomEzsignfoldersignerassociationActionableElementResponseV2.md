# EzmaxApi::Object::CustomEzsignfoldersignerassociationActionableElementResponseV2

## Load the model package
```perl
use EzmaxApi::Object::CustomEzsignfoldersignerassociationActionableElementResponseV2;
```
