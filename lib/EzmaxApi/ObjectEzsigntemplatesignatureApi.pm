...
# Create a new Ezsigntemplatesignature
#
# @param EzsigntemplatesignatureCreateObjectV3Request $ezsigntemplatesignature_create_object_v3_request  (required)
{
    my $params = {
    'ezsigntemplatesignature_create_object_v3_request' => {
        data_type => 'EzsigntemplatesignatureCreateObjectV3Request',
        description => '',
        required => '1',
    },
    };
    __PACKAGE__->method_documentation->{ 'ezsigntemplatesignature_create_object_v3' } = {
        summary => 'Create a new Ezsigntemplatesignature',
        params => $params,
...
#
sub ezsigntemplatesignature_create_object_v3 {
    my ($self, %args) = @_;

    # verify the required parameter 'ezsigntemplatesignature_create_object_v3_request' is set
    unless (exists $args{'ezsigntemplatesignature_create_object_v3_request'}) {
      croak("Missing the required parameter 'ezsigntemplatesignature_create_object_v3_request' when calling ezsigntemplatesignature_create_object_v3");
    }

    # parse inputs
    my $_resource_path = '/3/object/ezsigntemplatesignature';
    ...
    my $_body_data;
    # body params
    if ( exists $args{'ezsigntemplatesignature_create_object_v3_request'}) {
        $_body_data = $args{'ezsigntemplatesignature_create_object_v3_request'};
    }
    ...
    my $_response_object = $self->{api_client}->deserialize('EzsigntemplatesignatureCreateObjectV3Response', $response);
    return $_response_object;
}
...
#
# @param int $pki_ezsigntemplatesignature_id  (required)
# @param EzsigntemplatesignatureEditObjectV3Request $ezsigntemplatesignature_edit_object_v3_request  (required)
{
    my $params = {
    'pki_ezsigntemplatesignature_id' => {
        data_type => 'int',
    ...
    'ezsigntemplatesignature_edit_object_v3_request' => {
        data_type => 'EzsigntemplatesignatureEditObjectV3Request',
        description => '',
        required => '1',
    },
    };
    __PACKAGE__->method_documentation->{ 'ezsigntemplatesignature_edit_object_v3' } = {
...
#
sub ezsigntemplatesignature_edit_object_v3 {
    my ($self, %args) = @_;

    # verify the required parameter 'pki_ezsigntemplatesignature_id' is set
    unless (exists $args{'pki_ezsigntemplatesignature_id'}) {
      croak("Missing the required parameter 'pki_ezsigntemplatesignature_id' when calling ezsigntemplatesignature_edit_object_v3");
    }

    # verify the required parameter 'ezsigntemplatesignature_edit_object_v3_request' is set
    unless (exists $args{'ezsigntemplatesignature_edit_object_v3_request'}) {
      croak("Missing the required parameter 'ezsigntemplatesignature_edit_object_v3_request' when calling ezsigntemplatesignature_edit_object_v3");
    }
    ...
    my $_body_data;
    # body params
    if ( exists $args{'ezsigntemplatesignature_edit_object_v3_request'}) {
        $_body_data = $args{'ezsigntemplatesignature_edit_object_v3_request'};
    }
    ...
    my $_response_object = $self->{api_client}->deserialize('EzsigntemplatesignatureEditObjectV3Response', $response);
    return $_response_object;
}
...
# @param int $pki_ezsigntemplatesignature_id  (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'ezsigntemplatesignature_get_object_v4' } = {
...
#
sub ezsigntemplatesignature_get_object_v4 {
    my ($self, %args) = @_;

    # verify the required parameter 'pki_ezsigntemplatesignature_id' is set
    unless (exists $args{'pki_ezsigntemplatesignature_id'}) {
      croak("Missing the required parameter 'pki_ezsigntemplatesignature_id' when calling ezsigntemplatesignature_get_object_v4");
    }

    # parse inputs
    my $_resource_path = '/4/object/ezsigntemplatesignature/{pkiEzsigntemplatesignatureID}';
    ...
    my $_response_object = $self->{api_client}->deserialize('EzsigntemplatesignatureGetObjectV4Response', $response);
    return $_response_object;
}
