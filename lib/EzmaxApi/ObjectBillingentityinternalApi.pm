...
# @param int $pki_billingentityinternal_id The unique ID of the Billingentityinternal (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'billingentityinternal_delete_object_v1' } = {
        summary => 'Delete an existing Billingentityinternal',
        params => $params,
        returns => 'BillingentityinternalDeleteObjectV1Response',
        };
}
# @return BillingentityinternalDeleteObjectV1Response
#
sub billingentityinternal_delete_object_v1 {
    my ($self, %args) = @_;

    # verify the required parameter 'pki_billingentityinternal_id' is set
    unless (exists $args{'pki_billingentityinternal_id'}) {
      croak("Missing the required parameter 'pki_billingentityinternal_id' when calling billingentityinternal_delete_object_v1");
    }
    ...
    my $_response_object = $self->{api_client}->deserialize('BillingentityinternalDeleteObjectV1Response', $response);
    return $_response_object;
}
