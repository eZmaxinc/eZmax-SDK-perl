...
# Create a new Ezsignbulksend
#
# @param EzsignbulksendCreateObjectV2Request $ezsignbulksend_create_object_v2_request  (required)
{
    my $params = {
    'ezsignbulksend_create_object_v2_request' => {
        data_type => 'EzsignbulksendCreateObjectV2Request',
        description => '',
        required => '1',
    },
    };
    __PACKAGE__->method_documentation->{ 'ezsignbulksend_create_object_v2' } = {
        summary => 'Create a new Ezsignbulksend',
        params => $params,
...
#
sub ezsignbulksend_create_object_v2 {
    my ($self, %args) = @_;

    # verify the required parameter 'ezsignbulksend_create_object_v2_request' is set
    unless (exists $args{'ezsignbulksend_create_object_v2_request'}) {
      croak("Missing the required parameter 'ezsignbulksend_create_object_v2_request' when calling ezsignbulksend_create_object_v2");
    }

    # parse inputs
    my $_resource_path = '/2/object/ezsignbulksend';
    ...
    my $_body_data;
    # body params
    if ( exists $args{'ezsignbulksend_create_object_v2_request'}) {
        $_body_data = $args{'ezsignbulksend_create_object_v2_request'};
    }
    ...
    my $_response_object = $self->{api_client}->deserialize('EzsignbulksendCreateObjectV2Response', $response);
    return $_response_object;
}
...
#
# @param int $pki_ezsignbulksend_id  (required)
# @param EzsignbulksendEditObjectV2Request $ezsignbulksend_edit_object_v2_request  (required)
{
    my $params = {
    'pki_ezsignbulksend_id' => {
        data_type => 'int',
    ...
    'ezsignbulksend_edit_object_v2_request' => {
        data_type => 'EzsignbulksendEditObjectV2Request',
        description => '',
        required => '1',
    },
    };
    __PACKAGE__->method_documentation->{ 'ezsignbulksend_edit_object_v2' } = {
...
#
sub ezsignbulksend_edit_object_v2 {
    my ($self, %args) = @_;

    # verify the required parameter 'pki_ezsignbulksend_id' is set
    unless (exists $args{'pki_ezsignbulksend_id'}) {
      croak("Missing the required parameter 'pki_ezsignbulksend_id' when calling ezsignbulksend_edit_object_v2");
    }

    # verify the required parameter 'ezsignbulksend_edit_object_v2_request' is set
    unless (exists $args{'ezsignbulksend_edit_object_v2_request'}) {
      croak("Missing the required parameter 'ezsignbulksend_edit_object_v2_request' when calling ezsignbulksend_edit_object_v2");
    }
    ...
    my $_body_data;
    # body params
    if ( exists $args{'ezsignbulksend_edit_object_v2_request'}) {
        $_body_data = $args{'ezsignbulksend_edit_object_v2_request'};
    }
    ...
    my $_response_object = $self->{api_client}->deserialize('EzsignbulksendEditObjectV2Response', $response);
    return $_response_object;
}
...
# @param boolean $b_include_proof include the complete evidence archive including all of the above and more (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'ezsignbulksend_get_batch_file_v1' } = {
...
# @return string
#
sub ezsignbulksend_get_batch_file_v1 {
    my ($self, %args) = @_;

    # verify the required parameter 'pki_ezsignbulksend_id' is set
    unless (exists $args{'pki_ezsignbulksend_id'}) {
      croak("Missing the required parameter 'pki_ezsignbulksend_id' when calling ezsignbulksend_get_batch_file_v1");
    }

    # parse inputs
    my $_resource_path = '/1/object/ezsignbulksend/{pkiEzsignbulksendID}/getBatchFile';
...
# @param int $pki_ezsignbulksend_id  (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'ezsignbulksend_get_object_v3' } = {
        summary => 'Retrieve an existing Ezsignbulksend',
        params => $params,
...
#
sub ezsignbulksend_get_object_v3 {
    my ($self, %args) = @_;

    # verify the required parameter 'pki_ezsignbulksend_id' is set
    unless (exists $args{'pki_ezsignbulksend_id'}) {
      croak("Missing the required parameter 'pki_ezsignbulksend_id' when calling ezsignbulksend_get_object_v3");
    }

    # parse inputs
    my $_resource_path = '/3/object/ezsignbulksend/{pkiEzsignbulksendID}';
    ...
    my $_response_object = $self->{api_client}->deserialize('EzsignbulksendGetObjectV3Response', $response);
    return $_response_object;
}
...
# @param int $pki_ezsignbulksend_id  (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'ezsignbulksend_get_object_v4' } = {
        summary => 'Retrieve an existing Ezsignbulksend',
        params => $params,
...
#
sub ezsignbulksend_get_object_v4 {
    my ($self, %args) = @_;

    # verify the required parameter 'pki_ezsignbulksend_id' is set
    unless (exists $args{'pki_ezsignbulksend_id'}) {
      croak("Missing the required parameter 'pki_ezsignbulksend_id' when calling ezsignbulksend_get_object_v4");
    }

    # parse inputs
    my $_resource_path = '/4/object/ezsignbulksend/{pkiEzsignbulksendID}';
    ...
    my $_response_object = $self->{api_client}->deserialize('EzsignbulksendGetObjectV4Response', $response);
    return $_response_object;
}
