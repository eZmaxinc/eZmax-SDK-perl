...
# @param int $pki_ezsigntemplatepackagemembership_id  (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'ezsigntemplatepackagemembership_get_object_v3' } = {
        summary => 'Retrieve an existing Ezsigntemplatepackagemembership',
        params => $params,
...
#
sub ezsigntemplatepackagemembership_get_object_v3 {
    my ($self, %args) = @_;

    # verify the required parameter 'pki_ezsigntemplatepackagemembership_id' is set
    unless (exists $args{'pki_ezsigntemplatepackagemembership_id'}) {
      croak("Missing the required parameter 'pki_ezsigntemplatepackagemembership_id' when calling ezsigntemplatepackagemembership_get_object_v3");
    }

    # parse inputs
    my $_resource_path = '/3/object/ezsigntemplatepackagemembership/{pkiEzsigntemplatepackagemembershipID}';
    ...
    my $_response_object = $self->{api_client}->deserialize('EzsigntemplatepackagemembershipGetObjectV3Response', $response);
    return $_response_object;
}
