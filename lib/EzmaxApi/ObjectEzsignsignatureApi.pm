...
# Create a new Ezsignsignature
#
# @param EzsignsignatureCreateObjectV3Request $ezsignsignature_create_object_v3_request  (required)
{
    my $params = {
    'ezsignsignature_create_object_v3_request' => {
        data_type => 'EzsignsignatureCreateObjectV3Request',
        description => '',
        required => '1',
    },
    };
    __PACKAGE__->method_documentation->{ 'ezsignsignature_create_object_v3' } = {
        summary => 'Create a new Ezsignsignature',
        params => $params,
...
#
sub ezsignsignature_create_object_v3 {
    my ($self, %args) = @_;

    # verify the required parameter 'ezsignsignature_create_object_v3_request' is set
    unless (exists $args{'ezsignsignature_create_object_v3_request'}) {
      croak("Missing the required parameter 'ezsignsignature_create_object_v3_request' when calling ezsignsignature_create_object_v3");
    }

    # parse inputs
    my $_resource_path = '/3/object/ezsignsignature';
    ...
    my $_body_data;
    # body params
    if ( exists $args{'ezsignsignature_create_object_v3_request'}) {
        $_body_data = $args{'ezsignsignature_create_object_v3_request'};
    }
    ...
    my $_response_object = $self->{api_client}->deserialize('EzsignsignatureCreateObjectV3Response', $response);
    return $_response_object;
}
...
# Create a new Ezsignsignature
#
# @param EzsignsignatureCreateObjectV4Request $ezsignsignature_create_object_v4_request  (required)
{
    my $params = {
    'ezsignsignature_create_object_v4_request' => {
        data_type => 'EzsignsignatureCreateObjectV4Request',
        description => '',
        required => '1',
    },
    };
    __PACKAGE__->method_documentation->{ 'ezsignsignature_create_object_v4' } = {
        summary => 'Create a new Ezsignsignature',
        params => $params,
...
#
sub ezsignsignature_create_object_v4 {
    my ($self, %args) = @_;

    # verify the required parameter 'ezsignsignature_create_object_v4_request' is set
    unless (exists $args{'ezsignsignature_create_object_v4_request'}) {
      croak("Missing the required parameter 'ezsignsignature_create_object_v4_request' when calling ezsignsignature_create_object_v4");
    }

    # parse inputs
    my $_resource_path = '/4/object/ezsignsignature';
    ...
    my $_body_data;
    # body params
    if ( exists $args{'ezsignsignature_create_object_v4_request'}) {
        $_body_data = $args{'ezsignsignature_create_object_v4_request'};
    }
    ...
    my $_response_object = $self->{api_client}->deserialize('EzsignsignatureCreateObjectV4Response', $response);
    return $_response_object;
}
...
#
# @param int $pki_ezsignsignature_id  (required)
# @param EzsignsignatureEditObjectV2Request $ezsignsignature_edit_object_v2_request  (required)
{
    my $params = {
    'pki_ezsignsignature_id' => {
        data_type => 'int',
    ...
    'ezsignsignature_edit_object_v2_request' => {
        data_type => 'EzsignsignatureEditObjectV2Request',
        description => '',
        required => '1',
    },
    };
...
sub ezsignsignature_edit_object_v2 {
    ...
    # verify the required parameter 'pki_ezsignsignature_id' is set
    unless (exists $args{'pki_ezsignsignature_id'}) {
      croak("Missing the required parameter 'pki_ezsignsignature_id' when calling ezsignsignature_edit_object_v2");
    }

    # verify the required parameter 'ezsignsignature_edit_object_v2_request' is set
    unless (exists $args{'ezsignsignature_edit_object_v2_request'}) {
      croak("Missing the required parameter 'ezsignsignature_edit_object_v2_request' when calling ezsignsignature_edit_object_v2");
    }
    ...
    my $_body_data;
    # body params
    if ( exists $args{'ezsignsignature_edit_object_v2_request'}) {
        $_body_data = $args{'ezsignsignature_edit_object_v2_request'};
    }
...
#
# @param int $pki_ezsignsignature_id  (required)
# @param EzsignsignatureEditObjectV3Request $ezsignsignature_edit_object_v3_request  (required)
{
    my $params = {
    'pki_ezsignsignature_id' => {
        data_type => 'int',
    ...
    'ezsignsignature_edit_object_v3_request' => {
        data_type => 'EzsignsignatureEditObjectV3Request',
        description => '',
        required => '1',
    },
    };
    __PACKAGE__->method_documentation->{ 'ezsignsignature_edit_object_v3' } = {
        summary => 'Edit an existing Ezsignsignature',
        params => $params,
...
#
sub ezsignsignature_edit_object_v3 {
    my ($self, %args) = @_;

    # verify the required parameter 'pki_ezsignsignature_id' is set
    unless (exists $args{'pki_ezsignsignature_id'}) {
      croak("Missing the required parameter 'pki_ezsignsignature_id' when calling ezsignsignature_edit_object_v3");
    }

    # verify the required parameter 'ezsignsignature_edit_object_v3_request' is set
    unless (exists $args{'ezsignsignature_edit_object_v3_request'}) {
      croak("Missing the required parameter 'ezsignsignature_edit_object_v3_request' when calling ezsignsignature_edit_object_v3");
    }

    # parse inputs
    my $_resource_path = '/3/object/ezsignsignature/{pkiEzsignsignatureID}';
    ...
    my $_body_data;
    # body params
    if ( exists $args{'ezsignsignature_edit_object_v3_request'}) {
        $_body_data = $args{'ezsignsignature_edit_object_v3_request'};
    }
    ...
    my $_response_object = $self->{api_client}->deserialize('EzsignsignatureEditObjectV3Response', $response);
    return $_response_object;
}
...
# @param int $pki_ezsignsignature_id  (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'ezsignsignature_get_ezsignsignatureattachment_v1' } = {
...
#
sub ezsignsignature_get_ezsignsignatureattachment_v1 {
    my ($self, %args) = @_;

    # verify the required parameter 'pki_ezsignsignature_id' is set
    unless (exists $args{'pki_ezsignsignature_id'}) {
      croak("Missing the required parameter 'pki_ezsignsignature_id' when calling ezsignsignature_get_ezsignsignatureattachment_v1");
    }

    # parse inputs
    my $_resource_path = '/1/object/ezsignsignature/{pkiEzsignsignatureID}/getEzsignsignatureattachment';
    ...
    my $_response_object = $self->{api_client}->deserialize('EzsignsignatureGetEzsignsignatureattachmentV1Response', $response);
    return $_response_object;
}
...
#
{
    ...
    __PACKAGE__->method_documentation->{ 'ezsignsignature_get_ezsignsignatures_automatic_v1' } = {
...
#
sub ezsignsignature_get_ezsignsignatures_automatic_v1 {
    my ($self, %args) = @_;

    # parse inputs
    my $_resource_path = '/1/object/ezsignsignature/getEzsignsignaturesAutomatic';
    ...
    my $_response_object = $self->{api_client}->deserialize('EzsignsignatureGetEzsignsignaturesAutomaticV1Response', $response);
    return $_response_object;
}
...
# @param int $pki_ezsignsignature_id  (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'ezsignsignature_get_object_v3' } = {
...
#
sub ezsignsignature_get_object_v3 {
    my ($self, %args) = @_;

    # verify the required parameter 'pki_ezsignsignature_id' is set
    unless (exists $args{'pki_ezsignsignature_id'}) {
      croak("Missing the required parameter 'pki_ezsignsignature_id' when calling ezsignsignature_get_object_v3");
    }
    ...
    my $_response_object = $self->{api_client}->deserialize('EzsignsignatureGetObjectV3Response', $response);
    return $_response_object;
}
...
# @param int $pki_ezsignsignature_id  (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'ezsignsignature_get_object_v4' } = {
        summary => 'Retrieve an existing Ezsignsignature',
        params => $params,
...
#
sub ezsignsignature_get_object_v4 {
    my ($self, %args) = @_;

    # verify the required parameter 'pki_ezsignsignature_id' is set
    unless (exists $args{'pki_ezsignsignature_id'}) {
      croak("Missing the required parameter 'pki_ezsignsignature_id' when calling ezsignsignature_get_object_v4");
    }

    # parse inputs
    my $_resource_path = '/4/object/ezsignsignature/{pkiEzsignsignatureID}';
    ...
    my $_response_object = $self->{api_client}->deserialize('EzsignsignatureGetObjectV4Response', $response);
    return $_response_object;
}
