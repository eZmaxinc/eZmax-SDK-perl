...
#
package EzmaxApi::ObjectSecretquestionApi;
...
#
# @param string $s_selector The type of Secretquestions to return (required)
...
# @param HeaderAcceptLanguage $accept_language  (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'secretquestion_get_autocomplete_v1' } = {
...
#
sub secretquestion_get_autocomplete_v1 {
    my ($self, %args) = @_;

    # verify the required parameter 's_selector' is set
    unless (exists $args{'s_selector'}) {
      croak("Missing the required parameter 's_selector' when calling secretquestion_get_autocomplete_v1");
    }

    # parse inputs
    my $_resource_path = '/1/object/secretquestion/getAutocomplete/{sSelector}';
...
# @param HeaderAcceptLanguage $accept_language  (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'secretquestion_get_autocomplete_v2' } = {
        summary => 'Retrieve Secretquestions and IDs',
        params => $params,
...
#
sub secretquestion_get_autocomplete_v2 {
    my ($self, %args) = @_;

    # verify the required parameter 's_selector' is set
    unless (exists $args{'s_selector'}) {
      croak("Missing the required parameter 's_selector' when calling secretquestion_get_autocomplete_v2");
    }

    # parse inputs
    my $_resource_path = '/2/object/secretquestion/getAutocomplete/{sSelector}';
    ...
    my $_response_object = $self->{api_client}->deserialize('SecretquestionGetAutocompleteV2Response', $response);
    return $_response_object;
}
