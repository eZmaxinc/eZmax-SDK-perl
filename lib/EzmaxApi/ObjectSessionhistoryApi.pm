...
#
package EzmaxApi::ObjectSessionhistoryApi;
...
# @param string $s_filter  (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'sessionhistory_get_list_v1' } = {
...
#
sub sessionhistory_get_list_v1 {
    my ($self, %args) = @_;

    # parse inputs
    my $_resource_path = '/1/object/sessionhistory/getList';
    ...
    my $_response_object = $self->{api_client}->deserialize('SessionhistoryGetListV1Response', $response);
