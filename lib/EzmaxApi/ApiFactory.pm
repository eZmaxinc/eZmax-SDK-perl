...
usesub EzmaxApi::Object;

use EzmaxApi::ApiClient;

=head1 Name

    EzmaxApi::ApiFactory - constructs APIs to retrieve EzmaxApi objects

=head1 Synopsis

    package My::Petstore::App;

    use EzmaxApi::ApiFactory;

    my $api_factory = EzmaxApi::ApiFactory->new( ... ); # any args for ApiClient constructor

    # later...
    my $pet_api = $api_factory->get_api('Pet');

    # $pet_api isa EzmaxApi::PetApi
...
my %_apis = map { $_ =~ /^EzmaxApi::(.*)$/; $1 => $_ }
            grep {$_ =~ /Api$/}
            usesub 'EzmaxApi';

=head1 new($api_client)

    create a new EzmaxApi::ApiFactory instance with the given EzmaxApi::ApiClient instance.

=head1 new(%parameters)

    Any parameters are optional, and are passed to and stored on the api_client object.

    See L<EzmaxApi::ApiClient> and L<EzmaxApi::Configuration> for valid parameters
