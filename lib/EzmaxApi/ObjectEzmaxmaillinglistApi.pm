...
#
package EzmaxApi::ObjectEzmaxmaillinglistApi;
...
# @param string $s_filter  (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'ezmaxmaillinglist_get_list_v1' } = {
...
#
sub ezmaxmaillinglist_get_list_v1 {
    my ($self, %args) = @_;

    # parse inputs
    my $_resource_path = '/1/object/ezmaxmaillinglist/getList';
    ...
    my $_response_object = $self->{api_client}->deserialize('EzmaxmaillinglistGetListV1Response', $response);
