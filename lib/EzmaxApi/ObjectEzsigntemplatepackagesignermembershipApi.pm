...
# @param int $pki_ezsigntemplatepackagesignermembership_id  (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'ezsigntemplatepackagesignermembership_get_object_v2' } = {
...
#
sub ezsigntemplatepackagesignermembership_get_object_v2 {
    my ($self, %args) = @_;

    # verify the required parameter 'pki_ezsigntemplatepackagesignermembership_id' is set
    unless (exists $args{'pki_ezsigntemplatepackagesignermembership_id'}) {
      croak("Missing the required parameter 'pki_ezsigntemplatepackagesignermembership_id' when calling ezsigntemplatepackagesignermembership_get_object_v2");
    }

    # parse inputs
    my $_resource_path = '/2/object/ezsigntemplatepackagesignermembership/{pkiEzsigntemplatepackagesignermembershipID}';
    ...
    my $_response_object = $self->{api_client}->deserialize('EzsigntemplatepackagesignermembershipGetObjectV2Response', $response);
    return $_response_object;
}
