...
#
# @param DiscussionChatV1Request $discussion_chat_v1_request  (required)
{
    my $params = {
    'discussion_chat_v1_request' => {
        data_type => 'DiscussionChatV1Request',
        description => '',
        required => '1',
    },
    };
    __PACKAGE__->method_documentation->{ 'discussion_chat_v1' } = {
        summary => 'Have a Discussion with the AI Chatbot',
        params => $params,
...
#
sub discussion_chat_v1 {
    my ($self, %args) = @_;

    # verify the required parameter 'discussion_chat_v1_request' is set
    unless (exists $args{'discussion_chat_v1_request'}) {
      croak("Missing the required parameter 'discussion_chat_v1_request' when calling discussion_chat_v1");
    }

    # parse inputs
    my $_resource_path = '/1/object/discussion/chat';
    ...
    my $_body_data;
    # body params
    if ( exists $args{'discussion_chat_v1_request'}) {
        $_body_data = $args{'discussion_chat_v1_request'};
    }
    ...
    my $_response_object = $self->{api_client}->deserialize('DiscussionChatV1200Response', $response);
