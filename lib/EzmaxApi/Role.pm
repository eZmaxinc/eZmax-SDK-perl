...
has _cfg => ( is => 'ro',
              isa => 'EzmaxApi::Configuration',
              default => sub { EzmaxApi::Configuration->new() },
              );
...
sub _build_af {
    ...
    return EzmaxApi::ApiFactory->new(%args);
}
...
=head2 eZmax API Definition (Full) version: 1.2.2
