...
#
# @param int $pki_ezsigntemplatepackage_id  (required)
# @param EzsigntemplatepackageEditEzsigntemplatepackagesignersV2Request $ezsigntemplatepackage_edit_ezsigntemplatepackagesigners_v2_request  (required)
{
    my $params = {
    'pki_ezsigntemplatepackage_id' => {
        data_type => 'int',
    ...
    'ezsigntemplatepackage_edit_ezsigntemplatepackagesigners_v2_request' => {
        data_type => 'EzsigntemplatepackageEditEzsigntemplatepackagesignersV2Request',
        description => '',
        required => '1',
    },
    };
    __PACKAGE__->method_documentation->{ 'ezsigntemplatepackage_edit_ezsigntemplatepackagesigners_v2' } = {
        summary => 'Edit multiple Ezsigntemplatepackagesigners',
        params => $params,
...
#
sub ezsigntemplatepackage_edit_ezsigntemplatepackagesigners_v2 {
    my ($self, %args) = @_;

    # verify the required parameter 'pki_ezsigntemplatepackage_id' is set
    unless (exists $args{'pki_ezsigntemplatepackage_id'}) {
      croak("Missing the required parameter 'pki_ezsigntemplatepackage_id' when calling ezsigntemplatepackage_edit_ezsigntemplatepackagesigners_v2");
    }

    # verify the required parameter 'ezsigntemplatepackage_edit_ezsigntemplatepackagesigners_v2_request' is set
    unless (exists $args{'ezsigntemplatepackage_edit_ezsigntemplatepackagesigners_v2_request'}) {
      croak("Missing the required parameter 'ezsigntemplatepackage_edit_ezsigntemplatepackagesigners_v2_request' when calling ezsigntemplatepackage_edit_ezsigntemplatepackagesigners_v2");
    }

    # parse inputs
    my $_resource_path = '/2/object/ezsigntemplatepackage/{pkiEzsigntemplatepackageID}/editEzsigntemplatepackagesigners';
    ...
    my $_body_data;
    # body params
    if ( exists $args{'ezsigntemplatepackage_edit_ezsigntemplatepackagesigners_v2_request'}) {
        $_body_data = $args{'ezsigntemplatepackage_edit_ezsigntemplatepackagesigners_v2_request'};
    }
    ...
    my $_response_object = $self->{api_client}->deserialize('EzsigntemplatepackageEditEzsigntemplatepackagesignersV2Response', $response);
    return $_response_object;
}
...
# @param int $pki_ezsigntemplatepackage_id  (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'ezsigntemplatepackage_get_object_v3' } = {
        summary => 'Retrieve an existing Ezsigntemplatepackage',
        params => $params,
...
#
sub ezsigntemplatepackage_get_object_v3 {
    my ($self, %args) = @_;

    # verify the required parameter 'pki_ezsigntemplatepackage_id' is set
    unless (exists $args{'pki_ezsigntemplatepackage_id'}) {
      croak("Missing the required parameter 'pki_ezsigntemplatepackage_id' when calling ezsigntemplatepackage_get_object_v3");
    }

    # parse inputs
    my $_resource_path = '/3/object/ezsigntemplatepackage/{pkiEzsigntemplatepackageID}';
    ...
    my $_response_object = $self->{api_client}->deserialize('EzsigntemplatepackageGetObjectV3Response', $response);
    return $_response_object;
}
