...
# Create a new Apikey
#
# @param ARRAY[ApikeyCreateObjectV1Request] $apikey_create_object_v1_request  (required)
{
    my $params = {
    'apikey_create_object_v1_request' => {
        data_type => 'ARRAY[ApikeyCreateObjectV1Request]',
        description => '',
        required => '1',
    },
    };
    __PACKAGE__->method_documentation->{ 'apikey_create_object_v1' } = {
        summary => 'Create a new Apikey',
        params => $params,
        returns => 'ApikeyCreateObjectV1Response',
        };
}
# @return ApikeyCreateObjectV1Response
#
sub apikey_create_object_v1 {
    my ($self, %args) = @_;

    # verify the required parameter 'apikey_create_object_v1_request' is set
    unless (exists $args{'apikey_create_object_v1_request'}) {
      croak("Missing the required parameter 'apikey_create_object_v1_request' when calling apikey_create_object_v1");
    }

    # parse inputs
    my $_resource_path = '/1/object/apikey';
    ...
    my $_body_data;
    # body params
    if ( exists $args{'apikey_create_object_v1_request'}) {
        $_body_data = $args{'apikey_create_object_v1_request'};
    }
    ...
    my $_response_object = $self->{api_client}->deserialize('ApikeyCreateObjectV1Response', $response);
