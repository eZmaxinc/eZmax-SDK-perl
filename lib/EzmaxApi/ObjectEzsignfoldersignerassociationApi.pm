...
# @param int $pki_ezsignfoldersignerassociation_id The unique ID of the Ezsignfoldersignerassociation (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'ezsignfoldersignerassociation_get_object_get_children_v1' } = { 
...
# @return void
#
sub ezsignfoldersignerassociation_get_object_get_children_v1 {
    my ($self, %args) = @_;

    # verify the required parameter 'pki_ezsignfoldersignerassociation_id' is set
    unless (exists $args{'pki_ezsignfoldersignerassociation_id'}) {
      croak("Missing the required parameter 'pki_ezsignfoldersignerassociation_id' when calling ezsignfoldersignerassociation_get_object_get_children_v1");
    }
