...
# @param int $pki_ezsigntemplatedocument_id  (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'ezsigntemplatedocument_download_v1' } = {
...
# @return void
#
sub ezsigntemplatedocument_download_v1 {
    my ($self, %args) = @_;

    # verify the required parameter 'pki_ezsigntemplatedocument_id' is set
    unless (exists $args{'pki_ezsigntemplatedocument_id'}) {
      croak("Missing the required parameter 'pki_ezsigntemplatedocument_id' when calling ezsigntemplatedocument_download_v1");
    }

    # parse inputs
    my $_resource_path = '/1/object/ezsigntemplatedocument/{pkiEzsigntemplatedocumentID}/download';
...
#
# @param int $pki_ezsigntemplatedocument_id  (required)
# @param EzsigntemplatedocumentEditEzsigntemplateannotationsV1Request $ezsigntemplatedocument_edit_ezsigntemplateannotations_v1_request  (required)
{
    my $params = {
    'pki_ezsigntemplatedocument_id' => {
        data_type => 'int',
    ...
    'ezsigntemplatedocument_edit_ezsigntemplateannotations_v1_request' => {
        data_type => 'EzsigntemplatedocumentEditEzsigntemplateannotationsV1Request',
        description => '',
        required => '1',
    },
    };
    __PACKAGE__->method_documentation->{ 'ezsigntemplatedocument_edit_ezsigntemplateannotations_v1' } = {
...
#
sub ezsigntemplatedocument_edit_ezsigntemplateannotations_v1 {
    my ($self, %args) = @_;

    # verify the required parameter 'pki_ezsigntemplatedocument_id' is set
    unless (exists $args{'pki_ezsigntemplatedocument_id'}) {
      croak("Missing the required parameter 'pki_ezsigntemplatedocument_id' when calling ezsigntemplatedocument_edit_ezsigntemplateannotations_v1");
    }

    # verify the required parameter 'ezsigntemplatedocument_edit_ezsigntemplateannotations_v1_request' is set
    unless (exists $args{'ezsigntemplatedocument_edit_ezsigntemplateannotations_v1_request'}) {
      croak("Missing the required parameter 'ezsigntemplatedocument_edit_ezsigntemplateannotations_v1_request' when calling ezsigntemplatedocument_edit_ezsigntemplateannotations_v1");
    }

    # parse inputs
    my $_resource_path = '/1/object/ezsigntemplatedocument/{pkiEzsigntemplatedocumentID}/editEzsigntemplateannotations';
    ...
    my $_body_data;
    # body params
    if ( exists $args{'ezsigntemplatedocument_edit_ezsigntemplateannotations_v1_request'}) {
        $_body_data = $args{'ezsigntemplatedocument_edit_ezsigntemplateannotations_v1_request'};
    }
    ...
    my $_response_object = $self->{api_client}->deserialize('EzsigntemplatedocumentEditEzsigntemplateannotationsV1Response', $response);
    return $_response_object;
}
...
#
# @param int $pki_ezsigntemplatedocument_id  (required)
# @param EzsigntemplatedocumentEditEzsigntemplatedocumentpagerecognitionsV1Request $ezsigntemplatedocument_edit_ezsigntemplatedocumentpagerecognitions_v1_request  (required)
{
    my $params = {
    'pki_ezsigntemplatedocument_id' => {
        data_type => 'int',
    ...
    'ezsigntemplatedocument_edit_ezsigntemplatedocumentpagerecognitions_v1_request' => {
        data_type => 'EzsigntemplatedocumentEditEzsigntemplatedocumentpagerecognitionsV1Request',
        description => '',
        required => '1',
    },
    };
    __PACKAGE__->method_documentation->{ 'ezsigntemplatedocument_edit_ezsigntemplatedocumentpagerecognitions_v1' } = {
...
#
sub ezsigntemplatedocument_edit_ezsigntemplatedocumentpagerecognitions_v1 {
    my ($self, %args) = @_;

    # verify the required parameter 'pki_ezsigntemplatedocument_id' is set
    unless (exists $args{'pki_ezsigntemplatedocument_id'}) {
      croak("Missing the required parameter 'pki_ezsigntemplatedocument_id' when calling ezsigntemplatedocument_edit_ezsigntemplatedocumentpagerecognitions_v1");
    }

    # verify the required parameter 'ezsigntemplatedocument_edit_ezsigntemplatedocumentpagerecognitions_v1_request' is set
    unless (exists $args{'ezsigntemplatedocument_edit_ezsigntemplatedocumentpagerecognitions_v1_request'}) {
      croak("Missing the required parameter 'ezsigntemplatedocument_edit_ezsigntemplatedocumentpagerecognitions_v1_request' when calling ezsigntemplatedocument_edit_ezsigntemplatedocumentpagerecognitions_v1");
    }

    # parse inputs
    my $_resource_path = '/1/object/ezsigntemplatedocument/{pkiEzsigntemplatedocumentID}/editEzsigntemplatedocumentpagerecognitions';
    ...
    my $_body_data;
    # body params
    if ( exists $args{'ezsigntemplatedocument_edit_ezsigntemplatedocumentpagerecognitions_v1_request'}) {
        $_body_data = $args{'ezsigntemplatedocument_edit_ezsigntemplatedocumentpagerecognitions_v1_request'};
    }
    ...
    my $_response_object = $self->{api_client}->deserialize('EzsigntemplatedocumentEditEzsigntemplatedocumentpagerecognitionsV1Response', $response);
    return $_response_object;
}
...
#
# @param int $pki_ezsigntemplatedocument_id  (required)
# @param EzsigntemplatedocumentEditEzsigntemplatesignaturesV2Request $ezsigntemplatedocument_edit_ezsigntemplatesignatures_v2_request  (required)
{
    my $params = {
    'pki_ezsigntemplatedocument_id' => {
        data_type => 'int',
    ...
    'ezsigntemplatedocument_edit_ezsigntemplatesignatures_v2_request' => {
        data_type => 'EzsigntemplatedocumentEditEzsigntemplatesignaturesV2Request',
        description => '',
        required => '1',
    },
    };
    __PACKAGE__->method_documentation->{ 'ezsigntemplatedocument_edit_ezsigntemplatesignatures_v2' } = {
        summary => 'Edit multiple Ezsigntemplatesignatures',
        params => $params,
...
#
sub ezsigntemplatedocument_edit_ezsigntemplatesignatures_v2 {
    my ($self, %args) = @_;

    # verify the required parameter 'pki_ezsigntemplatedocument_id' is set
    unless (exists $args{'pki_ezsigntemplatedocument_id'}) {
      croak("Missing the required parameter 'pki_ezsigntemplatedocument_id' when calling ezsigntemplatedocument_edit_ezsigntemplatesignatures_v2");
    }

    # verify the required parameter 'ezsigntemplatedocument_edit_ezsigntemplatesignatures_v2_request' is set
    unless (exists $args{'ezsigntemplatedocument_edit_ezsigntemplatesignatures_v2_request'}) {
      croak("Missing the required parameter 'ezsigntemplatedocument_edit_ezsigntemplatesignatures_v2_request' when calling ezsigntemplatedocument_edit_ezsigntemplatesignatures_v2");
    }

    # parse inputs
    my $_resource_path = '/2/object/ezsigntemplatedocument/{pkiEzsigntemplatedocumentID}/editEzsigntemplatesignatures';
    ...
    my $_body_data;
    # body params
    if ( exists $args{'ezsigntemplatedocument_edit_ezsigntemplatesignatures_v2_request'}) {
        $_body_data = $args{'ezsigntemplatedocument_edit_ezsigntemplatesignatures_v2_request'};
    }
    ...
    my $_response_object = $self->{api_client}->deserialize('EzsigntemplatedocumentEditEzsigntemplatesignaturesV2Response', $response);
    return $_response_object;
}
...
#
# @param int $pki_ezsigntemplatedocument_id  (required)
# @param EzsigntemplatedocumentExtractTextV1Request $ezsigntemplatedocument_extract_text_v1_request  (required)
{
    my $params = {
    'pki_ezsigntemplatedocument_id' => {
        data_type => 'int',
    ...
    'ezsigntemplatedocument_extract_text_v1_request' => {
        data_type => 'EzsigntemplatedocumentExtractTextV1Request',
        description => '',
        required => '1',
    },
    };
    __PACKAGE__->method_documentation->{ 'ezsigntemplatedocument_extract_text_v1' } = {
...
#
sub ezsigntemplatedocument_extract_text_v1 {
    my ($self, %args) = @_;

    # verify the required parameter 'pki_ezsigntemplatedocument_id' is set
    unless (exists $args{'pki_ezsigntemplatedocument_id'}) {
      croak("Missing the required parameter 'pki_ezsigntemplatedocument_id' when calling ezsigntemplatedocument_extract_text_v1");
    }

    # verify the required parameter 'ezsigntemplatedocument_extract_text_v1_request' is set
    unless (exists $args{'ezsigntemplatedocument_extract_text_v1_request'}) {
      croak("Missing the required parameter 'ezsigntemplatedocument_extract_text_v1_request' when calling ezsigntemplatedocument_extract_text_v1");
    }

    # parse inputs
    my $_resource_path = '/1/object/ezsigntemplatedocument/{pkiEzsigntemplatedocumentID}/extractText';
    ...
    my $_body_data;
    # body params
    if ( exists $args{'ezsigntemplatedocument_extract_text_v1_request'}) {
        $_body_data = $args{'ezsigntemplatedocument_extract_text_v1_request'};
    }
    ...
    my $_response_object = $self->{api_client}->deserialize('EzsigntemplatedocumentExtractTextV1Response', $response);
    return $_response_object;
}
...
sub ezsigntemplatedocument_flatten_v1 {
    ...
    # verify the required parameter 'pki_ezsigntemplatedocument_id' is set
    unless (exists $args{'pki_ezsigntemplatedocument_id'}) {
      croak("Missing the required parameter 'pki_ezsigntemplatedocument_id' when calling ezsigntemplatedocument_flatten_v1");
    }

    # verify the required parameter 'body' is set
    unless (exists $args{'body'}) {
      croak("Missing the required parameter 'body' when calling ezsigntemplatedocument_flatten_v1");
    }

    # parse inputs
    my $_resource_path = '/1/object/ezsigntemplatedocument/{pkiEzsigntemplatedocumentID}/flatten';
...
# @param int $pki_ezsigntemplatedocument_id  (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'ezsigntemplatedocument_get_ezsigntemplateannotations_v1' } = {
...
#
sub ezsigntemplatedocument_get_ezsigntemplateannotations_v1 {
    my ($self, %args) = @_;

    # verify the required parameter 'pki_ezsigntemplatedocument_id' is set
    unless (exists $args{'pki_ezsigntemplatedocument_id'}) {
      croak("Missing the required parameter 'pki_ezsigntemplatedocument_id' when calling ezsigntemplatedocument_get_ezsigntemplateannotations_v1");
    }

    # parse inputs
    my $_resource_path = '/1/object/ezsigntemplatedocument/{pkiEzsigntemplatedocumentID}/getEzsigntemplateannotations';
    ...
    my $_response_object = $self->{api_client}->deserialize('EzsigntemplatedocumentGetEzsigntemplateannotationsV1Response', $response);
    return $_response_object;
}
...
# @param int $pki_ezsigntemplatedocument_id  (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'ezsigntemplatedocument_get_ezsigntemplatedocumentpagerecognitions_v1' } = {
...
#
sub ezsigntemplatedocument_get_ezsigntemplatedocumentpagerecognitions_v1 {
    my ($self, %args) = @_;

    # verify the required parameter 'pki_ezsigntemplatedocument_id' is set
    unless (exists $args{'pki_ezsigntemplatedocument_id'}) {
      croak("Missing the required parameter 'pki_ezsigntemplatedocument_id' when calling ezsigntemplatedocument_get_ezsigntemplatedocumentpagerecognitions_v1");
    }

    # parse inputs
    my $_resource_path = '/1/object/ezsigntemplatedocument/{pkiEzsigntemplatedocumentID}/getEzsigntemplatedocumentpagerecognitions';
    ...
    my $_response_object = $self->{api_client}->deserialize('EzsigntemplatedocumentGetEzsigntemplatedocumentpagerecognitionsV1Response', $response);
    return $_response_object;
}
...
# @param int $pki_ezsigntemplatedocument_id  (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'ezsigntemplatedocument_get_ezsigntemplatesignatures_v2' } = {
...
#
sub ezsigntemplatedocument_get_ezsigntemplatesignatures_v2 {
    my ($self, %args) = @_;

    # verify the required parameter 'pki_ezsigntemplatedocument_id' is set
    unless (exists $args{'pki_ezsigntemplatedocument_id'}) {
      croak("Missing the required parameter 'pki_ezsigntemplatedocument_id' when calling ezsigntemplatedocument_get_ezsigntemplatesignatures_v2");
    }

    # parse inputs
    my $_resource_path = '/2/object/ezsigntemplatedocument/{pkiEzsigntemplatedocumentID}/getEzsigntemplatesignatures';
    ...
    my $_response_object = $self->{api_client}->deserialize('EzsigntemplatedocumentGetEzsigntemplatesignaturesV2Response', $response);
    return $_response_object;
}
