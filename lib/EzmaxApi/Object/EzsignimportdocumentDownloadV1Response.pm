...
#
package EzmaxApi::Object::EzsignimportdocumentDownloadV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /1/object/ezsignimportdocument/{pkiEzsignimportdocumentID}/download',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'object',
        base_name => 'mPayload',
        description => 'Response for GET /1/object/ezsignimportdocument/{pkiEzsignimportdocumentID}/download',
        format => '',
        read_only => '',
            },
});
