...
#
package EzmaxApi::Object::EzsigntemplatedocumentEditEzsigntemplatesignaturesV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for PUT /1/object/ezsigntemplatedocument/{pkiEzsigntemplatedocumentID}/editEzsigntemplatesignatures',
...
__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'EzsigntemplatedocumentEditEzsigntemplatesignaturesV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
