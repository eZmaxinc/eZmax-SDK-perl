...
#
package EzmaxApi::Object::DiscussionCreateObjectV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for POST /1/object/discussion',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'DiscussionCreateObjectV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
