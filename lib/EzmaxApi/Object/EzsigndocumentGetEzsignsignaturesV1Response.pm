...
#
package EzmaxApi::Object::EzsigndocumentGetEzsignsignaturesV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for the /1/object/ezsigndocument/{pkiEzsigndocument}/getEzsignsignatures API Request',
...
__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'EzsigndocumentGetEzsignsignaturesV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
