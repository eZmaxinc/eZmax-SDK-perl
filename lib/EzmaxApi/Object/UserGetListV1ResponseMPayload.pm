...
#
package EzmaxApi::Object::UserGetListV1ResponseMPayload;
...
__PACKAGE__->class_documentation({description => 'Payload for GET /1/object/user/getList',
...
__PACKAGE__->method_documentation({
    ...
    'a_obj_user' => {
        datatype => 'ARRAY[UserListElement]',
        base_name => 'a_objUser',
        description => '',
        format => '',
        read_only => '',
