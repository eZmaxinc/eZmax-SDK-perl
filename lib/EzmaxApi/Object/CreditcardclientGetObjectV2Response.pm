...
#
package EzmaxApi::Object::CreditcardclientGetObjectV2Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /2/object/creditcardclient/{pkiCreditcardclientID}',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'CreditcardclientGetObjectV2ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
