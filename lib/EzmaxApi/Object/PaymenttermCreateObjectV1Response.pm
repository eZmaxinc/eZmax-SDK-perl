...
#
package EzmaxApi::Object::PaymenttermCreateObjectV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for POST /1/object/paymentterm',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'PaymenttermCreateObjectV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
