...
#
package EzmaxApi::Object::UNUSEDEzsignfolderEditObjectV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for the /1/object/ezsignfolder/editObject API Request',
