...
#
package EzmaxApi::Object::EzsignfoldertypeGetListV1ResponseMPayload;
...
__PACKAGE__->class_documentation({description => 'Payload for the /1/object/ezsignfoldertype/getList API Request',
...
__PACKAGE__->method_documentation({
    'a_obj_ezsignfoldertype' => {
        datatype => 'ARRAY[EzsignfoldertypeListElement]',
