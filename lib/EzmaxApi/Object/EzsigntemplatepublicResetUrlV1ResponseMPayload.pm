...
#
package EzmaxApi::Object::EzsigntemplatepublicResetUrlV1ResponseMPayload;
...
__PACKAGE__->class_documentation({description => 'Payload for POST /1/object/ezsigntemplatepublic/{pkiEzsigntemplatepublicID}/resetUrl',
