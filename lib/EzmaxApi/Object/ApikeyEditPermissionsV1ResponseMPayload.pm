...
#
package EzmaxApi::Object::ApikeyEditPermissionsV1ResponseMPayload;
...
__PACKAGE__->class_documentation({description => 'Payload for PUT /1/object/apikey/{pkiApikeyID}/editPermissions',
