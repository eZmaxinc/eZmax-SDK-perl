...
#
package EzmaxApi::Object::EzsigndocumentApplyEzsigntemplateglobalV2Response;
...
__PACKAGE__->class_documentation({description => 'Response for POST /2/object/ezsigndocument/{pkiEzsigndocument}/applyEzsigntemplateglobal',
                                  class => 'EzsigndocumentApplyEzsigntemplateglobalV2Response',
                                  required => [], # TODO
}                                 );
