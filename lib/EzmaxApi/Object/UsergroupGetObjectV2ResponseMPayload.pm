...
#
package EzmaxApi::Object::UsergroupGetObjectV2ResponseMPayload;
...
__PACKAGE__->class_documentation({description => 'Payload for GET /2/object/usergroup/{pkiUsergroupID}',
