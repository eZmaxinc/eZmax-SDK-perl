...
#
package EzmaxApi::Object::BuyercontractGetListV1ResponseMPayload;
...
__PACKAGE__->class_documentation({description => 'Payload for GET /1/object/buyercontract/getList',
...
__PACKAGE__->method_documentation({
    ...
    'a_obj_buyercontract' => {
        datatype => 'ARRAY[BuyercontractListElement]',
        base_name => 'a_objBuyercontract',
        description => '',
        format => '',
        read_only => '',
            },
