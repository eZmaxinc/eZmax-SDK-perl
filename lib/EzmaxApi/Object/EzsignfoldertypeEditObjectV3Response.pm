...
#
package EzmaxApi::Object::EzsignfoldertypeEditObjectV3Response;
...
__PACKAGE__->class_documentation({description => 'Response for PUT /3/object/ezsignfoldertype/{pkiEzsignfoldertypeID}',
