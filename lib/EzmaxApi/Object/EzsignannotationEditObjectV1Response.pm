...
#
package EzmaxApi::Object::EzsignannotationEditObjectV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for PUT /1/object/ezsignannotation/{pkiEzsignannotationID}',
