...
#
package EzmaxApi::Object::EzsignsignatureGetObjectV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for the /1/object/ezsignsignature/getObject API Request',
