...
#
package EzmaxApi::Object::UserEditColleaguesV2Response;
...
__PACKAGE__->class_documentation({description => 'Response for PUT /2/object/user/{pkiUserID}/editColleagues',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'UserEditColleaguesV2ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
