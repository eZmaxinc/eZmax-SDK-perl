...
#
package EzmaxApi::Object::NotificationtestGetElementsV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /1/object/notificationtest/{pkiNotificationtestID}/getElements',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'NotificationtestGetElementsV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
