...
#
package EzmaxApi::Object::CommunicationreferenceRequestCompound;
...
__PACKAGE__->class_documentation({description => 'A Communicationreference Object and children',
...
__PACKAGE__->method_documentation({
    'pki_communicationreference_id' => {
        datatype => 'int',
        base_name => 'pkiCommunicationreferenceID',
        description => 'The unique ID of the Communicationreference',
        format => '',
        read_only => '',
            },
...
__PACKAGE__->openapi_types( {
    'pki_communicationreference_id' => 'int',
