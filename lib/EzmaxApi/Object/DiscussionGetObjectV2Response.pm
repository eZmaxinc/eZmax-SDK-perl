...
#
package EzmaxApi::Object::DiscussionGetObjectV2Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /2/object/discussion/{pkiDiscussionID}',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'DiscussionGetObjectV2ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
