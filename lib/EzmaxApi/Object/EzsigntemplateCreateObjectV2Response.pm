...
#
package EzmaxApi::Object::EzsigntemplateCreateObjectV2Response;
...
__PACKAGE__->class_documentation({description => 'Response for POST /2/object/ezsigntemplate',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'EzsigntemplateCreateObjectV2ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
