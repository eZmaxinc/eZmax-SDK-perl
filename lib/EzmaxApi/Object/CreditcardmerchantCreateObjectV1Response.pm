...
#
package EzmaxApi::Object::CreditcardmerchantCreateObjectV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for POST /1/object/creditcardmerchant',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'CreditcardmerchantCreateObjectV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
