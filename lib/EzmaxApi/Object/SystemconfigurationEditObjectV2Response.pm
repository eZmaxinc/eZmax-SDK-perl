...
#
package EzmaxApi::Object::SystemconfigurationEditObjectV2Response;
...
__PACKAGE__->class_documentation({description => 'Response for PUT /1/object/systemconfiguration/{pkiSystemconfigurationID}',
                                  class => 'SystemconfigurationEditObjectV2Response',
                                  required => [], # TODO
}                                 );
