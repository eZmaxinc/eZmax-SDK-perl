...
#
package EzmaxApi::Object::EzsigndocumentEditEzsignformfieldgroupsV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for PUT /1/object/ezsigndocument/{pkiEzsigndocumentID}/editEzsignformfieldgroups',
...
__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'EzsigndocumentEditEzsignformfieldgroupsV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
