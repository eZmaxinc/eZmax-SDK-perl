...
#
package EzmaxApi::Object::EzsignbulksendtransmissionGetEzsignsignaturesAutomaticV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /1/object/ezsignbulksendtransmission/{pkiEzsignbulksendtransmissionID}/getEzsignsignaturesAutomatic',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'EzsignbulksendtransmissionGetEzsignsignaturesAutomaticV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
