...
use base ("Class::Accessor", "Class::Data::Inheritable", "EzmaxApi::Object::ActivesessionResponseCompound");
...
sub init
{
    ...
    # initialize parent object ActivesessionResponseCompound
    $self->EzmaxApi::Object::ActivesessionResponseCompound::init(%args);
}
...
sub to_hash {
    ...
    # call ActivesessionResponseCompound to_hash and then combine hash
    $_hash = { %$_hash, %$self->EzmaxApi::Object::ActivesessionResponseCompound::to_hash };
...
sub TO_JSON {
    ...
    # combine parent (ActivesessionResponseCompound) TO_JSON
    $_data = { %$_data, %$self->EzmaxApi::Object::ActivesessionResponseCompound::TO_JSON };
...
sub from_hash {
    ...
    # call parent (ActivesessionResponseCompound) from_hash
    $self->EzmaxApi::Object::ActivesessionResponseCompound::from_hash($hash);
