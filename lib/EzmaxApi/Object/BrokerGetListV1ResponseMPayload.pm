...
#
package EzmaxApi::Object::BrokerGetListV1ResponseMPayload;
...
__PACKAGE__->class_documentation({description => 'Payload for GET /1/object/broker/getList',
...
__PACKAGE__->method_documentation({
    ...
    'a_obj_broker' => {
        datatype => 'ARRAY[BrokerListElement]',
