...
#
package EzmaxApi::Object::AttachmentRenameV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for POST /1/object/attachment/{pkiAttachmentID}/rename',
                                  class => 'AttachmentRenameV1Response',
                                  required => [], # TODO
}                                 );
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'AttachmentRenameV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
