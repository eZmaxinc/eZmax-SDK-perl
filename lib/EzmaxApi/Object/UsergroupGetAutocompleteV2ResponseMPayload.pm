...
#
package EzmaxApi::Object::UsergroupGetAutocompleteV2ResponseMPayload;
...
__PACKAGE__->class_documentation({description => 'Payload for POST /2/object/usergroup/getAutocomplete',
...
__PACKAGE__->method_documentation({
    'a_obj_usergroup' => {
        datatype => 'ARRAY[UsergroupAutocompleteElementResponse]',
