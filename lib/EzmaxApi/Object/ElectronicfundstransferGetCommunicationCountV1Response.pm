...
#
package EzmaxApi::Object::ElectronicfundstransferGetCommunicationCountV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /1/object/electronicfundstransfer/{pkiElectronicfundstransferID}/getCommunicationCount',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'ElectronicfundstransferGetCommunicationCountV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
