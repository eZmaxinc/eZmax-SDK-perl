...
#
package EzmaxApi::Object::ApikeyCreateObjectV1Request;
...
__PACKAGE__->class_documentation({description => 'Request for the /1/object/apikey/createObject API Request',
