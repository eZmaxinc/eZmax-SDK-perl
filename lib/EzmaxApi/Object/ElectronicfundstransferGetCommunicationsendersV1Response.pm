...
#
package EzmaxApi::Object::ElectronicfundstransferGetCommunicationsendersV1Response;
...
__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'ElectronicfundstransferGetCommunicationsendersV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
