...
#
package EzmaxApi::Object::SupplierImportIntoEDMV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for POST /1/object/supplier/{pkiSupplierID}/importIntoEDM',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'SupplierImportIntoEDMV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
