...
#
package EzmaxApi::Object::ScimServiceProviderConfigFilter;
...
__PACKAGE__->class_documentation({description => 'A complex type that specifies FILTER options.',
