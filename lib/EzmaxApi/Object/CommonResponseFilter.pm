...
#
package EzmaxApi::Object::CommonResponseFilter;
...
__PACKAGE__->class_documentation({description => 'Definition of Filters for getList',
...
__PACKAGE__->method_documentation({
    ...
    'a_auto_type_having' => {
        datatype => 'HASH[string,string]',
        base_name => 'a_AutoTypeHaving',
        description => 'List of computed filters that can be used in *sFilter* (Automatic types)',
        format => '',
        read_only => '',
            },
    'a_enum' => {
