...
#
package EzmaxApi::Object::LanguageAutocompleteElementResponse;
...
__PACKAGE__->class_documentation({description => 'A Language AutocompleteElement Response',
