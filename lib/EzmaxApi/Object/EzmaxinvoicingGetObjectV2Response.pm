...
#
package EzmaxApi::Object::EzmaxinvoicingGetObjectV2Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /2/object/ezmaxinvoicing/{pkiEzmaxinvoicingID}',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'EzmaxinvoicingGetObjectV2ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
