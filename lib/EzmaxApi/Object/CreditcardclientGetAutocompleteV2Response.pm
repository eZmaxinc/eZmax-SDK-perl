...
#
package EzmaxApi::Object::CreditcardclientGetAutocompleteV2Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /2/object/creditcardclient/getAutocomplete',
...
__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'CreditcardclientGetAutocompleteV2ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
