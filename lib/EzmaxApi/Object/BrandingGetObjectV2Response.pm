...
#
package EzmaxApi::Object::BrandingGetObjectV2Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /2/object/branding/{pkiBrandingID}',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'BrandingGetObjectV2ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
