...
#
package EzmaxApi::Object::CommonResponseObjDebug;
...
__PACKAGE__->class_documentation({description => 'This is a generic debug object that is returned by all API requests',
...
__PACKAGE__->method_documentation({
    ...
    'a_obj_sql_query' => {
        datatype => 'ARRAY[CommonResponseObjSQLQuery]',
        base_name => 'a_objSQLQuery',
