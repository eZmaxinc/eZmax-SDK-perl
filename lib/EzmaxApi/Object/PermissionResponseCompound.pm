...
#
package EzmaxApi::Object::PermissionResponseCompound;
...
__PACKAGE__->class_documentation({description => 'A Permission Object and children to create a complete structure',
