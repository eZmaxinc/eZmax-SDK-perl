...
#
package EzmaxApi::Object::EzsigntemplatepublicGetListV1ResponseMPayload;
...
__PACKAGE__->class_documentation({description => 'Payload for GET /1/object/ezsigntemplatepublic/getList',
...
__PACKAGE__->method_documentation({
    'a_obj_ezsigntemplatepublic' => {
        datatype => 'ARRAY[EzsigntemplatepublicListElement]',
        base_name => 'a_objEzsigntemplatepublic',
        description => '',
        format => '',
        read_only => '',
            },
