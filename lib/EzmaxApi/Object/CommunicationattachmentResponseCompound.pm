...
#
package EzmaxApi::Object::CommunicationattachmentResponseCompound;
...
__PACKAGE__->class_documentation({description => 'A Communicationattachment Object',
...
__PACKAGE__->method_documentation({
    ...
    's_communicationattachment_name' => {
        datatype => 'string',
        base_name => 'sCommunicationattachmentName',
