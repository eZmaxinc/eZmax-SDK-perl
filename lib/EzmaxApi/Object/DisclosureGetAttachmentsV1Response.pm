...
#
package EzmaxApi::Object::DisclosureGetAttachmentsV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /1/object/disclosure/{pkiDisclosureID}/getAttachments',
                                  class => 'DisclosureGetAttachmentsV1Response',
                                  required => [], # TODO
}                                 );
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'DisclosureGetAttachmentsV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
