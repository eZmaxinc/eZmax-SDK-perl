...
#
package EzmaxApi::Object::ProvinceGetAutocompleteV2Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /2/object/province/getAutocomplete',
...
__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'ProvinceGetAutocompleteV2ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
