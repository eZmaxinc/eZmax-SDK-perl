...
#
package EzmaxApi::Object::UserEditPermissionsV1ResponseMPayload;
...
__PACKAGE__->class_documentation({description => 'Payload for PUT /1/object/user/{pkiUserID}/editPermissions',
