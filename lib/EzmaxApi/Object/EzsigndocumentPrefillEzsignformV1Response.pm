...
#
package EzmaxApi::Object::EzsigndocumentPrefillEzsignformV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for POST /1/object/ezsigndocument/{pkiEzsigndocumentID}/prefillEzsignform',
