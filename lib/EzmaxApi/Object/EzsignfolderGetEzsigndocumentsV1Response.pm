...
#
package EzmaxApi::Object::EzsignfolderGetEzsigndocumentsV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for the /1/object/ezsignfolder/{pkiEzsignfolder}/getEzsigndocuments API Request',
...
__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'EzsignfolderGetEzsigndocumentsV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
