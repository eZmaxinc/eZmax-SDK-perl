...
#
package EzmaxApi::Object::UNUSEDEzsignfolderEditObjectV1Request;
...
__PACKAGE__->class_documentation({description => 'Request for the /1/object/ezsignfolder/editObject API Request',
