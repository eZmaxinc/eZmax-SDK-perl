...
#
package EzmaxApi::Object::EzsigntemplateannotationEditObjectV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for PUT /1/object/ezsigntemplateannotation/{pkiEzsigntemplateannotationID}',
                                  class => 'EzsigntemplateannotationEditObjectV1Response',
                                  required => [], # TODO
}                                 );
