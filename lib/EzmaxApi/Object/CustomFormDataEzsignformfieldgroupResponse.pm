...
#
package EzmaxApi::Object::CustomFormDataEzsignformfieldgroupResponse;
...
__PACKAGE__->class_documentation({description => 'An FormDataSigner-&gt;Ezsignformfieldgroup Object and children to create a complete structure',
...
__PACKAGE__->method_documentation({
    ...
    'a_obj_ezsignformfield' => {
        datatype => 'ARRAY[CustomFormDataEzsignformfieldResponse]',
