...
#
package EzmaxApi::Object::NotificationsectionGetNotificationtestsV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /1/object/notificationsection/{pkiNotificationsectionID}/getNotificationtests',
...
__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'NotificationsectionGetNotificationtestsV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
