...
#
package EzmaxApi::Object::EzsigndocumentGetEzsignpagesV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for the /1/object/ezsigndocument/{pkiEzsigndocument}/getEzsignpages API Request',
...
__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'EzsigndocumentGetEzsignpagesV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
