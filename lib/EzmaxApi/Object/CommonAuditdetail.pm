...
#
package EzmaxApi::Object::CommonAuditdetail;
...
__PACKAGE__->class_documentation({description => 'Gives informations about the user that created the object or the last user to have modified it.  If the object was never modified after creation, both Created and Modified informations will be the same. ',
