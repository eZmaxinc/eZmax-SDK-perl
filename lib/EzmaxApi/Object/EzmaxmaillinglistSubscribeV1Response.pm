...
#
package EzmaxApi::Object::EzmaxmaillinglistSubscribeV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for POST /1/module/ezmaxmaillinglist/subscribe',
