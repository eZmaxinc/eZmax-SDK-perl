...
#
package EzmaxApi::Object::EzsignfoldersignerassociationForceDisconnectV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for POST /1/object/ezsignfoldersignerassociation/{pkiEzsignfoldersignerassociation}/forceDisconnect',
