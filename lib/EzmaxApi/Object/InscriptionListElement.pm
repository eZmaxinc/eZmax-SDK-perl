...
#
package EzmaxApi::Object::InscriptionListElement;
...
__PACKAGE__->class_documentation({description => 'A Inscription List Element',
...
__PACKAGE__->method_documentation({
    ...
    'i_inscriptionnotauthenticated_canceled' => {
        datatype => 'int',
        base_name => 'iInscriptionnotauthenticatedCanceled',
        description => 'The numbre of inscriptionnotauthenticated was canceled in this Inscription',
        format => '',
        read_only => '',
            },
    'i_inscription_unit' => {
    ...
    'b_allowed_copyintoinscriptionedm' => {
        datatype => 'boolean',
        base_name => 'bAllowedCopyintoinscriptionedm',
        description => 'Whether we are allowed to copy into the Inscription EDM',
        format => '',
        read_only => '',
            },
});
...
__PACKAGE__->openapi_types( {
    ...
    'i_inscriptionnotauthenticated_canceled' => 'int',
