...
#
package EzmaxApi::Object::BrandingGetObjectV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /1/object/branding/{pkiBrandingID}',
...
__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'BrandingGetObjectV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
...
__PACKAGE__->openapi_types( {
    'm_payload' => 'BrandingGetObjectV1ResponseMPayload',
