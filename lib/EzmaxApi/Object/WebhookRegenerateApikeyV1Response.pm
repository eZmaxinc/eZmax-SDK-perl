...
#
package EzmaxApi::Object::WebhookRegenerateApikeyV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for POST /1/object/webhook/{pkiWebhookID}/regenerateApikey',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'WebhookRegenerateApikeyV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
