...
#
package EzmaxApi::Object::SupplierGetListV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /1/object/supplier/getList',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'SupplierGetListV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
