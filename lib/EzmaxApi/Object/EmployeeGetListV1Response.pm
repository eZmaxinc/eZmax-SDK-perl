...
#
package EzmaxApi::Object::EmployeeGetListV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /1/object/employee/getList',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'EmployeeGetListV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
