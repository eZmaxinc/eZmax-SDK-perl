...
#
package EzmaxApi::Object::EzsigntemplateformfieldgroupCreateObjectV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for POST /1/object/ezsigntemplateformfieldgroup',
...
__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'EzsigntemplateformfieldgroupCreateObjectV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
