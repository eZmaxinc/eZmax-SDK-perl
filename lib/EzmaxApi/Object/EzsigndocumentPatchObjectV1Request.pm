...
#
package EzmaxApi::Object::EzsigndocumentPatchObjectV1Request;
...
__PACKAGE__->class_documentation({description => 'Request for the /1/object/ezsigndocument/pathObject API Request',
...
__PACKAGE__->method_documentation({
    'obj_ezsigndocument' => {
        datatype => 'EzsigndocumentRequestPatch',
