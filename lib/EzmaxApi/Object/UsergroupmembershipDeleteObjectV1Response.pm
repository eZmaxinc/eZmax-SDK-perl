...
#
package EzmaxApi::Object::UsergroupmembershipDeleteObjectV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for DELETE /1/object/usergroupmembership/{pkiUsergroupmembershipID}',
