...
#
package EzmaxApi::Object::ScimServiceProviderConfigChangePassword;
...
__PACKAGE__->class_documentation({description => 'A complex type that specifies configuration options related to changing a password.',
