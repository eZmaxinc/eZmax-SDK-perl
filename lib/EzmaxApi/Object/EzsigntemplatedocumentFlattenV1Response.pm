...
#
package EzmaxApi::Object::EzsigntemplatedocumentFlattenV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for POST /1/object/ezsigntemplatedocument/{pkiEzsigntemplatedocument}/flatten',
