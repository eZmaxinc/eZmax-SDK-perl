...
#
package EzmaxApi::Object::EzsignfoldertypeAutocompleteElementResponse;
...
__PACKAGE__->class_documentation({description => 'A Ezsignfoldertype AutocompleteElement Response',
