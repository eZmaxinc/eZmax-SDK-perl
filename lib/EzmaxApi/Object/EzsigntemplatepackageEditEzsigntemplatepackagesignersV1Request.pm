...
#
package EzmaxApi::Object::EzsigntemplatepackageEditEzsigntemplatepackagesignersV1Request;
...
__PACKAGE__->class_documentation({description => 'Request for PUT /1/object/ezsigntemplatepackage/{pkiEzsigntemplatepackageID}/editEzsigntemplatepackagesigners',
...
__PACKAGE__->method_documentation({
    'a_obj_ezsigntemplatepackagesigner' => {
        datatype => 'ARRAY[EzsigntemplatepackagesignerRequestCompound]',
