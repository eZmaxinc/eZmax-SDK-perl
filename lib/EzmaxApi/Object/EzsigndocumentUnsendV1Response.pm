...
#
package EzmaxApi::Object::EzsigndocumentUnsendV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for POST /1/object/ezsigndocument/{pkiEzsigndocumentID}/unsend',
