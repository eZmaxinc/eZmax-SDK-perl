...
#
package EzmaxApi::Object::EzsignbulksendDeleteObjectV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for DELETE /1/object/ezsignbulksend/{pkiEzsignbulksendID}',
