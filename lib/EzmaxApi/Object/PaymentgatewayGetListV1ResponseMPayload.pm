...
#
package EzmaxApi::Object::PaymentgatewayGetListV1ResponseMPayload;
...
__PACKAGE__->class_documentation({description => 'Payload for GET /1/object/paymentgateway/getList',
...
__PACKAGE__->method_documentation({
    ...
    'a_obj_paymentgateway' => {
        datatype => 'ARRAY[PaymentgatewayListElement]',
