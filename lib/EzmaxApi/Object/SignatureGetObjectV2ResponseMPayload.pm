...
#
package EzmaxApi::Object::SignatureGetObjectV2ResponseMPayload;
...
__PACKAGE__->class_documentation({description => 'Payload for GET /2/object/signature/{pkiSignatureID}',
