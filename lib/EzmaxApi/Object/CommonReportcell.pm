...
#
package EzmaxApi::Object::CommonReportcell;
...
__PACKAGE__->class_documentation({description => 'A cell in a Reportrow ',
...
__PACKAGE__->method_documentation({
    'i_reportcell_columnspan' => {
        datatype => 'int',
        base_name => 'iReportcellColumnspan',
