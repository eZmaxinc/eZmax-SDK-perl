...
#
package EzmaxApi::Object::BillingentityinternalDeleteObjectV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for DELETE /1/object/billingentityinternal/{pkiBillingentityinternalID}',
                                  class => 'BillingentityinternalDeleteObjectV1Response',
                                  required => [], # TODO
}                                 );
