...
#
package EzmaxApi::Object::CommonReportgroup;
...
__PACKAGE__->class_documentation({description => 'A group of reports  Each Reportgroup is for a specific recipient or for a specific context.',
...
__PACKAGE__->method_documentation({
    'a_obj_report' => {
        datatype => 'ARRAY[CommonReport]',
        base_name => 'a_objReport',
        description => '',
        format => '',
        read_only => '',
            },
    'a_obj_reportcellstyle_custom' => {
        datatype => 'ARRAY[CommonReportcellstyle]',
        base_name => 'a_objReportcellstyleCustom',
        description => '',
        format => '',
        read_only => '',
            },
