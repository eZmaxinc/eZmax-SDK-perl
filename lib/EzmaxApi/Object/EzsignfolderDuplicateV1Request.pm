...
#
package EzmaxApi::Object::EzsignfolderDuplicateV1Request;
...
__PACKAGE__->method_documentation({
    ...
    'a_obj_ezsigndocument' => {
        datatype => 'ARRAY[CustomEzsigndocumentDuplicateRequest]',
    ...
    'b_keepenteredvalues' => {
        datatype => 'boolean',
        base_name => 'bKeepenteredvalues',
        description => 'Whether we keep the entered values or not in the Ezsignform',
        format => '',
        read_only => '',
            },
});
