...
#
package EzmaxApi::Object::ActivesessionResponseCompoundApikey;
...
__PACKAGE__->class_documentation({description => 'An Activesession-&gt;Apikey object and children to create a complete structure',
