...
#
package EzmaxApi::Object::UsergroupCreateObjectV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for POST /1/object/usergroup',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'UsergroupCreateObjectV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
