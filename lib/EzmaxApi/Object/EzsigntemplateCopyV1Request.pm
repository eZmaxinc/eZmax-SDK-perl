...
#
package EzmaxApi::Object::EzsigntemplateCopyV1Request;
...
__PACKAGE__->class_documentation({description => 'Request for POST /1/object/ezsigntemplate/{pkiEzsigntemplateID}/copy',
...
__PACKAGE__->method_documentation({
    'a_fki_ezsignfoldertype_id' => {
        datatype => 'ARRAY[int]',
        base_name => 'a_fkiEzsignfoldertypeID',
        description => '',
        format => '',
        read_only => '',
            },
