...
#
package EzmaxApi::Object::ApikeyCreateObjectV2Response;
...
__PACKAGE__->class_documentation({description => 'Response for the /2/object/apikey/createObject API Request',
...
__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'ApikeyCreateObjectV2ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
