...
#
package EzmaxApi::Object::EzsigntemplatesignatureResponseCompoundV4;
...
__PACKAGE__->method_documentation({
    ...
    'b_ezsigntemplatesignature_creditcardcustomamount' => {
        datatype => 'boolean',
        base_name => 'bEzsigntemplatesignatureCreditcardcustomamount',
        description => 'Whether we can enter a custom amount while signing an Ezsigntemplatesignature &#39;Creditcard&#39; or not',
        format => '',
        read_only => '',
            },
    ...
    's_ezsigntemplatesignature_creditcardamountdescription' => {
        datatype => 'string',
        base_name => 'sEzsigntemplatesignatureCreditcardamountdescription',
        description => 'The description of the Creditcard signature',
        format => '',
        read_only => '',
            },
    'd_ezsigntemplatesignature_creditcardamount' => {
        datatype => 'string',
        base_name => 'dEzsigntemplatesignatureCreditcardamount',
    ...
    'a_obj_ezsigntemplatesignaturepaymentdetail' => {
        datatype => 'ARRAY[EzsigntemplatesignaturepaymentdetailResponseCompound]',
        base_name => 'a_objEzsigntemplatesignaturepaymentdetail',
        description => '',
        format => '',
        read_only => '',
            },
