...
#
package EzmaxApi::Object::CommunicationGetObjectV2Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /2/object/communication/{pkiCommunicationID}',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'CommunicationGetObjectV2ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
