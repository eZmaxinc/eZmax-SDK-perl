...
#
package EzmaxApi::Object::GlaccountAutocompleteElementResponse;
...
__PACKAGE__->class_documentation({description => 'A Glaccount AutocompleteElement Response',
...
__PACKAGE__->method_documentation({
    ...
    'i_glaccount_code' => {
        datatype => 'int',
        base_name => 'iGlaccountCode',
        description => 'The Code of the Glaccount',
        format => '',
        read_only => '',
            },
    ...
    'b_glaccount_isactive' => {
        datatype => 'boolean',
        base_name => 'bGlaccountIsactive',
        description => 'Whether the Glaccount is active or not',
        format => '',
        read_only => '',
            },
});
...
__PACKAGE__->openapi_types( {
    'pki_glaccount_id' => 'int',
    'i_glaccount_code' => 'int',
