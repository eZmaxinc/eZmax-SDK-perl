...
#
package EzmaxApi::Object::VersionhistoryGetObjectV2Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /2/object/versionhistory/{pkiVersionhistoryID}',
...
__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'VersionhistoryGetObjectV2ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
