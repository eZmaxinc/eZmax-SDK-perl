...
#
package EzmaxApi::Object::CreditcardmerchantEditObjectV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for PUT /1/object/creditcardmerchant/{pkiCreditcardmerchantID}',
