...
#
package EzmaxApi::Object::EzsigntemplateEditObjectV2Response;
...
__PACKAGE__->class_documentation({description => 'Response for PUT /2/object/ezsigntemplate/{pkiEzsigntemplateID}',
