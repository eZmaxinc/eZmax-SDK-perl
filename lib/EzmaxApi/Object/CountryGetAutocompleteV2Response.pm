...
#
package EzmaxApi::Object::CountryGetAutocompleteV2Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /2/object/country/getAutocomplete',
...
__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'CountryGetAutocompleteV2ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
