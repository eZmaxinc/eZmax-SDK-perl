...
#
package EzmaxApi::Object::UserstagedListElement;
...
__PACKAGE__->class_documentation({description => 'A Userstaged List Element',
...
__PACKAGE__->method_documentation({
    ...
    's_userstaged_firstname' => {
        datatype => 'string',
        base_name => 'sUserstagedFirstname',
    ...
    's_userstaged_externalid' => {
        datatype => 'string',
        base_name => 'sUserstagedExternalid',
