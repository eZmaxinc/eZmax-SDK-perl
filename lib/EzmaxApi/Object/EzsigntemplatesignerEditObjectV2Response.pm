...
#
package EzmaxApi::Object::EzsigntemplatesignerEditObjectV2Response;
...
__PACKAGE__->class_documentation({description => 'Response for PUT /2/object/ezsigntemplatesigner/{pkiEzsigntemplatesignerID}',
                                  class => 'EzsigntemplatesignerEditObjectV2Response',
                                  required => [], # TODO
}                                 );
