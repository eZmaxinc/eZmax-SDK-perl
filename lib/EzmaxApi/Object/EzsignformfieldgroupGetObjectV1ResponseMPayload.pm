...
#
package EzmaxApi::Object::EzsignformfieldgroupGetObjectV1ResponseMPayload;
...
__PACKAGE__->class_documentation({description => 'Payload for GET /1/object/ezsignformfieldgroup/{pkiEzsignformfieldgroupID}',
