...
#
package EzmaxApi::Object::CustomAttachmentdocumenttypeResponse;
...
__PACKAGE__->class_documentation({description => 'An Attachmentdocumenttype',
...
__PACKAGE__->method_documentation({
    ...
    'a_obj_attachment' => {
        datatype => 'ARRAY[CustomAttachmentResponse]',
