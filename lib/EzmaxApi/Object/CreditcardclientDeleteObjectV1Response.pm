...
#
package EzmaxApi::Object::CreditcardclientDeleteObjectV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for DELETE /1/object/creditcardclient/{pkiCreditcardclientID}',
