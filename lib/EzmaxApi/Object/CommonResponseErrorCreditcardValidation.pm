...
#
package EzmaxApi::Object::CommonResponseErrorCreditcardValidation;
...
__PACKAGE__->class_documentation({description => 'Generic Error Message',
...
__PACKAGE__->method_documentation({
    'obj_creditcardtransactionresponse' => {
        datatype => 'CustomCreditcardtransactionresponseResponse',
        base_name => 'objCreditcardtransactionresponse',
        description => '',
        format => '',
        read_only => '',
            },
