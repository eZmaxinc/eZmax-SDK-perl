...
#
package EzmaxApi::Object::BrandingEditObjectV1Request;
...
__PACKAGE__->class_documentation({description => 'Request for PUT /1/object/branding/{pkiBrandingID}',
...
__PACKAGE__->method_documentation({
    'obj_branding' => {
        datatype => 'BrandingRequestCompound',
