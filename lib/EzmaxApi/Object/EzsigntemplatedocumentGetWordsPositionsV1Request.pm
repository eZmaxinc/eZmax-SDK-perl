...
#
package EzmaxApi::Object::EzsigntemplatedocumentGetWordsPositionsV1Request;
...
__PACKAGE__->class_documentation({description => 'Request for POST /1/object/ezsigntemplatedocument/{pkiEzsigntemplatedocumentID}/getWordsPositions',
