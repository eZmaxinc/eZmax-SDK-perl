...
#
package EzmaxApi::Object::CommunicationGetCountV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /1/module/communication/getCommunicationCount',
...
__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'CommunicationGetCountV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
...
__PACKAGE__->openapi_types( {
    'm_payload' => 'CommunicationGetCountV1ResponseMPayload',
