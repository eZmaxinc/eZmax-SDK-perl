...
#
package EzmaxApi::Object::FontGetAutocompleteV2Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /2/object/font/getAutocomplete',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'FontGetAutocompleteV2ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
