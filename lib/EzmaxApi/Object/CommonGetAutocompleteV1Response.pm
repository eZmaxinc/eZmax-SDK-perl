...
#
package EzmaxApi::Object::CommonGetAutocompleteV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for the /1/object/xxx/getAutocomplete API Request',
