...
#
package EzmaxApi::Object::ApikeyGenerateDelegatedCredentialsV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for POST /1/object/apikey/generateDelegatedCredentials',
...
__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'ApikeyGenerateDelegatedCredentialsV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
