...
#
package EzmaxApi::Object::EzsignfolderGetObjectV2ResponseMPayload;
...
__PACKAGE__->class_documentation({description => 'Payload for GET /2/object/ezsignfolder/{pkiEzsignfolderID}',
