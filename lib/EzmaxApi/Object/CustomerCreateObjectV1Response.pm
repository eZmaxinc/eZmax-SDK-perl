...
#
package EzmaxApi::Object::CustomerCreateObjectV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for POST /1/object/customer',
...
__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'CustomerCreateObjectV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
