...
#
package EzmaxApi::Object::EzsigntemplatepackageEditObjectV1Request;
...
__PACKAGE__->class_documentation({description => 'Request for PUT /1/object/ezsigntemplatepackage/{pkiEzsigntemplatepackageID}',
...
__PACKAGE__->method_documentation({
    'obj_ezsigntemplatepackage' => {
        datatype => 'EzsigntemplatepackageRequestCompound',
