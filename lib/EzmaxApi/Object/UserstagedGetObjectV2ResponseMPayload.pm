...
#
package EzmaxApi::Object::UserstagedGetObjectV2ResponseMPayload;
...
__PACKAGE__->class_documentation({description => 'Payload for GET /2/object/userstaged/{pkiUserstagedID}',
