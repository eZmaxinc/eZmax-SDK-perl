...
#
package EzmaxApi::Object::EzsigntemplateListElement;
...
__PACKAGE__->class_documentation({description => 'A Ezsigntemplate List Element',
...
__PACKAGE__->method_documentation({
    ...
    'i_ezsigntemplate_signaturetotal' => {
        datatype => 'int',
        base_name => 'iEzsigntemplateSignaturetotal',
    ...
    'i_ezsigntemplate_formfieldtotal' => {
        datatype => 'int',
        base_name => 'iEzsigntemplateFormfieldtotal',
    ...
    'b_ezsigntemplate_incomplete' => {
        datatype => 'boolean',
        base_name => 'bEzsigntemplateIncomplete',
