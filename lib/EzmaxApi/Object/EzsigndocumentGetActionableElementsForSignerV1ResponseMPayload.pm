...
#
package EzmaxApi::Object::EzsigndocumentGetActionableElementsForSignerV1ResponseMPayload;
...
__PACKAGE__->class_documentation({description => 'Payload for GET /1/object/ezsigndocument/{pkiEzsigndocumentID}/getActionableElementsForSigner',
...
__PACKAGE__->method_documentation({
    'a_obj_ezsignsignature' => {
        datatype => 'ARRAY[EzsignsignatureResponseCompound]',
