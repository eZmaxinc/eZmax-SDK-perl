...
#
package EzmaxApi::Object::EzsigndocumentApplyEzsigntemplateV1Request;
...
__PACKAGE__->class_documentation({description => 'Request for the /1/object/ezsigndocument/{pkiEzsigndocumentID}/applyezsigntemplate API Request',
