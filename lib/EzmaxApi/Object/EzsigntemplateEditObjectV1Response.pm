...
#
package EzmaxApi::Object::EzsigntemplateEditObjectV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for PUT /1/object/ezsigntemplate/{pkiEzsigntemplateID}',
