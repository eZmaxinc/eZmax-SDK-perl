...
#
package EzmaxApi::Object::EzsigntemplateGetAutocompleteV2ResponseMPayload;
...
__PACKAGE__->class_documentation({description => 'Payload for POST /2/object/ezsigntemplate/getAutocomplete',
...
__PACKAGE__->method_documentation({
    'a_obj_ezsigntemplate' => {
        datatype => 'ARRAY[EzsigntemplateAutocompleteElementResponse]',
