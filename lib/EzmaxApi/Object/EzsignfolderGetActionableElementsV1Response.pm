...
#
package EzmaxApi::Object::EzsignfolderGetActionableElementsV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /1/object/ezsignfolder/{pkiEzsignfolderID}/getActionableElements',
...
__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'EzsignfolderGetActionableElementsV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
