...
#
package EzmaxApi::Object::InscriptiontempGetListV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /1/object/inscriptiontemp/getList',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'InscriptiontempGetListV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
