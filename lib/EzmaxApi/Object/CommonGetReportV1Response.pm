...
#
package EzmaxApi::Object::CommonGetReportV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for POST /1/report/xxx/xxx and /1/module/report/getReportFromCache',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'CommonGetReportV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
