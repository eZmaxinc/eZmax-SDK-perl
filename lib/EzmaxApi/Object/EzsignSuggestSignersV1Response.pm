...
#
package EzmaxApi::Object::EzsignSuggestSignersV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /1/module/ezsign/suggestSigners',
...
__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'EzsignSuggestSignersV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
