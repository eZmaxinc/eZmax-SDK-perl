...
#
package EzmaxApi::Object::EzsigntemplateCreateObjectV3Response;
...
__PACKAGE__->class_documentation({description => 'Response for POST /3/object/ezsigntemplate',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'EzsigntemplateCreateObjectV3ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
