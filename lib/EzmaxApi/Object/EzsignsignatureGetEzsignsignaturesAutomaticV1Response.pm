...
#
package EzmaxApi::Object::EzsignsignatureGetEzsignsignaturesAutomaticV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /1/object/ezsignsignature/getEzsignsignaturesAutomatic',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'EzsignsignatureGetEzsignsignaturesAutomaticV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
