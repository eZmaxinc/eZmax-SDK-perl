...
#
package EzmaxApi::Object::DomainGetListV1ResponseMPayload;
...
__PACKAGE__->class_documentation({description => 'Payload for GET /1/object/domain/getList',
...
__PACKAGE__->method_documentation({
    ...
    'a_obj_domain' => {
        datatype => 'ARRAY[DomainListElement]',
