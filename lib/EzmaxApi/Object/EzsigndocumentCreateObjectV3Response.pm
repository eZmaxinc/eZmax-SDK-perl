...
#
package EzmaxApi::Object::EzsigndocumentCreateObjectV3Response;
...
__PACKAGE__->class_documentation({description => 'Response for POST /3/object/ezsigndocument',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'EzsigndocumentCreateObjectV3ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
