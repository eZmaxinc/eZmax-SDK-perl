...
#
package EzmaxApi::Object::EzsigntemplatepackagemembershipGetObjectV1ResponseMPayload;
...
__PACKAGE__->class_documentation({description => 'Payload for GET /1/object/ezsigntemplatepackagemembership/{pkiEzsigntemplatepackagemembershipID}',
