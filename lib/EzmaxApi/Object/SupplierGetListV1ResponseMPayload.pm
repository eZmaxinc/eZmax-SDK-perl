...
#
package EzmaxApi::Object::SupplierGetListV1ResponseMPayload;
...
__PACKAGE__->class_documentation({description => 'Payload for GET /1/object/supplier/getList',
...
__PACKAGE__->method_documentation({
    ...
    'a_obj_supplier' => {
        datatype => 'ARRAY[SupplierListElement]',
        base_name => 'a_objSupplier',
        description => '',
        format => '',
        read_only => '',
            },
