...
#
package EzmaxApi::Object::EzsignbulksendsignermappingRequestCompoundV2;
...
__PACKAGE__->method_documentation({
    ...
    'e_ezsignbulksendsignermapping_role' => {
        datatype => 'FieldEEzsignbulksendsignermappingRole',
        base_name => 'eEzsignbulksendsignermappingRole',
        description => '',
        format => '',
        read_only => '',
            },
