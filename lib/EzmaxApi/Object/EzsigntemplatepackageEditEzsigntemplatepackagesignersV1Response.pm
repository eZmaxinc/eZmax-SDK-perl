...
#
package EzmaxApi::Object::EzsigntemplatepackageEditEzsigntemplatepackagesignersV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for PUT /1/object/ezsigntemplatepackage/{pkiEzsigntemplatepackageID}/editEzsigntemplatepackagesigners',
...
__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'EzsigntemplatepackageEditEzsigntemplatepackagesignersV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
