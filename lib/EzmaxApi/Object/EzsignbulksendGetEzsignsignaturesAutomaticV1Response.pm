...
#
package EzmaxApi::Object::EzsignbulksendGetEzsignsignaturesAutomaticV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /1/object/ezsignbulksend/{pkiEzsignbulksendID}/getEzsignsignaturesAutomatic',
...
__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'EzsignbulksendGetEzsignsignaturesAutomaticV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
