...
#
package EzmaxApi::Object::EzsigndocumentGetEzsignsignaturesV1ResponseMPayload;
...
__PACKAGE__->class_documentation({description => 'Payload for the /1/object/ezsigndocument/{pkiEzsigndocument}/getEzsignsignatures API Request',
