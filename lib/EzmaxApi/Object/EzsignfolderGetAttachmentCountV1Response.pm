...
#
package EzmaxApi::Object::EzsignfolderGetAttachmentCountV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /1/object/ezsignfolder/{pkiEzsignfolderID}/getAttachmentCount',
...
__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'EzsignfolderGetAttachmentCountV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
