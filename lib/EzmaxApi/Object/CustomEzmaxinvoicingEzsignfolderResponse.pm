...
#
package EzmaxApi::Object::CustomEzmaxinvoicingEzsignfolderResponse;
...
__PACKAGE__->class_documentation({description => 'An EzmaxinvoicingEzsignfolder object containing information about the Ezmaxinvoicing for an Ezsignfolder',
...
__PACKAGE__->method_documentation({
    ...
    'b_ezsigntsarequirement_billable' => {
        datatype => 'boolean',
        base_name => 'bEzsigntsarequirementBillable',
    ...
    'b_ezsignfolder_mfaused' => {
        datatype => 'boolean',
        base_name => 'bEzsignfolderMfaused',
    ...
    'b_ezsignfolder_paymentused' => {
        datatype => 'boolean',
        base_name => 'bEzsignfolderPaymentused',
