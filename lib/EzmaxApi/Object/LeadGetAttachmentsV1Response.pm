...
#
package EzmaxApi::Object::LeadGetAttachmentsV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /1/object/lead/{pkiLeadID}/getAttachments',
                                  class => 'LeadGetAttachmentsV1Response',
                                  required => [], # TODO
}                                 );
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'LeadGetAttachmentsV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
