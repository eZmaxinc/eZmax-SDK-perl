...
#
package EzmaxApi::Object::VariableexpenseGetObjectV2Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /2/object/variableexpense/{pkiVariableexpenseID}',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'VariableexpenseGetObjectV2ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
