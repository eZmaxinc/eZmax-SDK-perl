...
#
package EzmaxApi::Object::CustomEzsignsignaturestatusResponse;
...
__PACKAGE__->class_documentation({description => 'A Ezsignsignaturestatus Object and children to create a complete structure',
...
__PACKAGE__->method_documentation({
    'e_ezsignsignaturestatus_steptype' => {
        datatype => 'string',
        base_name => 'eEzsignsignaturestatusSteptype',
    ...
    'i_ezsignsignaturestatus_step' => {
        datatype => 'int',
        base_name => 'iEzsignsignaturestatusStep',
    ...
    'i_ezsignsignaturestatus_total' => {
        datatype => 'int',
        base_name => 'iEzsignsignaturestatusTotal',
    ...
    'i_ezsignsignaturestatus_signed' => {
        datatype => 'int',
        base_name => 'iEzsignsignaturestatusSigned',
