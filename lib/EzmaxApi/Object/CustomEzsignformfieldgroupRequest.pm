...
#
package EzmaxApi::Object::CustomEzsignformfieldgroupRequest;
...
__PACKAGE__->class_documentation({description => 'A Custom Ezsignformfieldgroup Object to fill an Ezsignform using submitForm',
...
__PACKAGE__->method_documentation({
    ...
    'a_obj_ezsignformfield' => {
        datatype => 'ARRAY[CustomEzsignformfieldRequest]',
