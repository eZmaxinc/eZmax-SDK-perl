...
#
package EzmaxApi::Object::ListSaveListpresentationV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for the POST /1/module/list/listpresentation/{sListName} API Request',
...
__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'ListSaveListpresentationV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
