...
#
package EzmaxApi::Object::BrandingGetObjectV3Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /3/object/branding/{pkiBrandingID}',
...
__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'BrandingGetObjectV3ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
