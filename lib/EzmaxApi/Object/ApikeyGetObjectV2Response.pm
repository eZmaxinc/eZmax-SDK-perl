...
#
package EzmaxApi::Object::ApikeyGetObjectV2Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /2/object/apikey/{pkiApikeyID}',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'ApikeyGetObjectV2ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
