...
#
package EzmaxApi::Object::ClonehistoryListElement;
...
__PACKAGE__->class_documentation({description => 'A Clonehistory List Element',
...
__PACKAGE__->method_documentation({
    ...
    'dt_clonehistory_firsthit' => {
        datatype => 'string',
        base_name => 'dtClonehistoryFirsthit',
    ...
    'dt_clonehistory_lasthit' => {
        datatype => 'string',
        base_name => 'dtClonehistoryLasthit',
    ...
    's_user_loginname_cloning' => {
        datatype => 'string',
        base_name => 'sUserLoginnameCloning',
    ...
    's_user_firstname_cloning' => {
        datatype => 'string',
        base_name => 'sUserFirstnameCloning',
    ...
    's_user_lastname_cloning' => {
        datatype => 'string',
        base_name => 'sUserLastnameCloning',
    ...
    's_user_loginname_cloned' => {
        datatype => 'string',
        base_name => 'sUserLoginnameCloned',
        description => 'The login name of the User.',
        format => '',
        read_only => '',
            },
    's_user_firstname_cloned' => {
        datatype => 'string',
        base_name => 'sUserFirstnameCloned',
        description => 'The first name of the user',
        format => '',
        read_only => '',
            },
...
__PACKAGE__->openapi_types( {
    'pki_clonehistory_id' => 'int',
    'fki_user_id_cloning' => 'int',
    'fki_user_id_cloned' => 'int',
