...
#
package EzmaxApi::Object::EzsignbulksendtransmissionGetFormsDataV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /1/object/ezsignbulksendtransmission/{pkiEzsignbulksendtransmissionID}/getFormsData',
...
__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'EzsignbulksendtransmissionGetFormsDataV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
