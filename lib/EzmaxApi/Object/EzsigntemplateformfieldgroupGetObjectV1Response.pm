...
#
package EzmaxApi::Object::EzsigntemplateformfieldgroupGetObjectV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /1/object/ezsigntemplateformfieldgroup/{pkiEzsigntemplateformfieldgroupID}',
                                  class => 'EzsigntemplateformfieldgroupGetObjectV1Response',
                                  required => [], # TODO
}                                 );

__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'EzsigntemplateformfieldgroupGetObjectV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
...
__PACKAGE__->openapi_types( {
    'm_payload' => 'EzsigntemplateformfieldgroupGetObjectV1ResponseMPayload',
