...
#
package EzmaxApi::Object::UserResponseCompound;
...
__PACKAGE__->class_documentation({description => 'A User Object and children to create a complete structure',
...
__PACKAGE__->method_documentation({
    ...
    'e_user_origin' => {
        datatype => 'FieldEUserOrigin',
        base_name => 'eUserOrigin',
        description => '',
        format => '',
        read_only => '',
            },
    ...
    'dt_user_passwordchanged' => {
        datatype => 'string',
        base_name => 'dtUserPasswordchanged',
