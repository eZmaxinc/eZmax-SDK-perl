...
#
package EzmaxApi::Object::UsergroupexternalGetObjectV2Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /2/object/usergroupexternal/{pkiUsergroupexternalID}',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'UsergroupexternalGetObjectV2ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
