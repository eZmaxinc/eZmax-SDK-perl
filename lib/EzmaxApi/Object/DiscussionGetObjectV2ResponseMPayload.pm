...
#
package EzmaxApi::Object::DiscussionGetObjectV2ResponseMPayload;
...
__PACKAGE__->class_documentation({description => 'Payload for GET /2/object/discussion/{pkiDiscussionID}',
