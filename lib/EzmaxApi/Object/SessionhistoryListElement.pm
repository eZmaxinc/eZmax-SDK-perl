...
#
package EzmaxApi::Object::SessionhistoryListElement;
...
__PACKAGE__->class_documentation({description => 'A Sessionhistory List Element',
...
__PACKAGE__->method_documentation({
    ...
    'dt_sessionhistory_firsthit' => {
        datatype => 'string',
        base_name => 'dtSessionhistoryFirsthit',
    ...
    'dt_sessionhistory_lasthit' => {
        datatype => 'string',
        base_name => 'dtSessionhistoryLasthit',
        description => 'The last hit of the Sessionhistory',
        format => '',
        read_only => '',
            },
    'e_sessionhistory_endby' => {
        datatype => 'FieldESessionhistoryEndby',
        base_name => 'eSessionhistoryEndby',
        description => '',
        format => '',
        read_only => '',
            },
    's_computer_description' => {
        datatype => 'string',
        base_name => 'sComputerDescription',
    ...
    's_sessionhistory_duration' => {
        datatype => 'string',
        base_name => 'sSessionhistoryDuration',
