...
#
package EzmaxApi::Object::UsergroupmembershipEditObjectV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for PUT /1/object/usergroupmembership/{pkiUsergroupmembershipID}',
