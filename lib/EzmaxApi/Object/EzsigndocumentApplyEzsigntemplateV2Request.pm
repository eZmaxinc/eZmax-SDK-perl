...
#
package EzmaxApi::Object::EzsigndocumentApplyEzsigntemplateV2Request;
...
__PACKAGE__->class_documentation({description => 'Request for the /2/object/ezsigndocument/{pkiEzsigndocumentID}/applyezsigntemplate API Request',
