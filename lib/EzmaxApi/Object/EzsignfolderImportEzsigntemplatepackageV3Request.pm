...
#
package EzmaxApi::Object::EzsignfolderImportEzsigntemplatepackageV3Request;
...
__PACKAGE__->class_documentation({description => 'Request for POST /3/object/ezsignfolder/{pkiEzsignfolderID}/importEzsigntemplatepackage',
...
__PACKAGE__->method_documentation({
    ...
    'a_obj_import_ezsigntemplatepackage_relation' => {
        datatype => 'ARRAY[CustomImportEzsigntemplatepackageRelationRequest]',
        base_name => 'a_objImportEzsigntemplatepackageRelation',
        description => '',
        format => '',
        read_only => '',
            },
    'a_s_ezsigntemplateannotation_description' => {
        ...
        base_name => 'a_sEzsigntemplateannotationDescription',
        description => '',
        format => '',
        read_only => '',
            },
    'a_s_ezsigntemplateannotation_defaulttext' => {
        datatype => 'ARRAY[string]',
        base_name => 'a_sEzsigntemplateannotationDefaulttext',
        description => '',
        format => '',
        read_only => '',
            },
