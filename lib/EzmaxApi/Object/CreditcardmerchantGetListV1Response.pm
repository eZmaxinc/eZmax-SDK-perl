...
#
package EzmaxApi::Object::CreditcardmerchantGetListV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /1/object/creditcardmerchant/getList',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'CreditcardmerchantGetListV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
