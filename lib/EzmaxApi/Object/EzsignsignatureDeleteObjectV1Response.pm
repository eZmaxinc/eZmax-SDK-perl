...
#
package EzmaxApi::Object::EzsignsignatureDeleteObjectV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for the /1/object/ezsignsignature/deleteObject API Request',
