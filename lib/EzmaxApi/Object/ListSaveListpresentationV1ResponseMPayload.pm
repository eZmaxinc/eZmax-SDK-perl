...
#
package EzmaxApi::Object::ListSaveListpresentationV1ResponseMPayload;
...
__PACKAGE__->class_documentation({description => 'Payload for the POST /1/module/list/listpresentation/{sListName} API Request',
