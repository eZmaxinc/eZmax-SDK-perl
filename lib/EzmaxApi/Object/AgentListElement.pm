...
#
package EzmaxApi::Object::AgentListElement;
...
__PACKAGE__->class_documentation({description => 'A Agent List Element',
...
__PACKAGE__->method_documentation({
    ...
    'fki_agenttype_id' => {
        datatype => 'int',
        base_name => 'fkiAgenttypeID',
        description => 'The unique ID of the Agenttype',
        format => '',
        read_only => '',
            },
    's_agenttype_name_x' => {
        datatype => 'string',
        base_name => 'sAgenttypeNameX',
        description => 'The name of the Agenttype in the language of the requester',
        format => '',
        read_only => '',
            },
    ...
    's_agentincorporation_name' => {
        datatype => 'string',
        base_name => 'sAgentincorporationName',
        description => 'The name of the Agentincorporation',
        format => '',
        read_only => '',
            },
    'fki_department_id' => {
    ...
    's_realestateboardnumber_number' => {
        datatype => 'string',
        base_name => 'sRealestateboardnumberNumber',
        description => 'The number of the Realestateboardnumber',
        format => '',
        read_only => '',
            },
    's_agent_code' => {
        datatype => 'string',
        base_name => 'sAgentCode',
    ...
    'i_agent_photocopiercode' => {
        datatype => 'int',
        base_name => 'iAgentPhotocopiercode',
        description => 'The photocopiercode of the Agent',
        format => '',
        read_only => '',
            },
    'i_agent_longdistancecode' => {
        datatype => 'int',
        base_name => 'iAgentLongdistancecode',
        description => 'The longdistancecode of the Agent',
        format => '',
        read_only => '',
            },
    'i_agent_bannernumber' => {
        datatype => 'int',
        base_name => 'iAgentBannernumber',
        description => 'The bannernumber of the Agent',
        format => '',
        read_only => '',
            },
    's_agent_realestateassociationlicense' => {
        datatype => 'string',
        base_name => 'sAgentRealestateassociationlicense',
        description => 'The realestateassociationlicense of the Agent',
        format => '',
        read_only => '',
            },
    'dt_agent_permitexpiration' => {
        datatype => 'string',
        base_name => 'dtAgentPermitexpiration',
        description => 'The expiration date of permit of the Agent',
        format => '',
        read_only => '',
            },
    'dt_agent_hiredate' => {
        datatype => 'string',
        base_name => 'dtAgentHiredate',
        description => 'The hire date of the Agent',
        format => '',
        read_only => '',
            },
    'dt_agent_leavedate' => {
        datatype => 'string',
        base_name => 'dtAgentLeavedate',
        description => 'The leave date of the Agent',
        format => '',
        read_only => '',
            },
    'dt_agent_contractdate' => {
        datatype => 'string',
        base_name => 'dtAgentContractdate',
        description => 'The contract date of the Agent',
        format => '',
        read_only => '',
            },
    'dt_agent_transferdate' => {
        datatype => 'string',
        base_name => 'dtAgentTransferdate',
        description => 'The transfer date of the Agent',
        format => '',
        read_only => '',
            },
    'dt_agent_senioritydate' => {
        datatype => 'string',
        base_name => 'dtAgentSenioritydate',
        description => 'The seniority date of the Agent',
        format => '',
        read_only => '',
            },
    'dt_agent_sickleavestart' => {
        datatype => 'string',
        base_name => 'dtAgentSickleavestart',
        description => 'The sick leave start date of the Agent',
        format => '',
        read_only => '',
            },
    'dt_agent_sickleaveend' => {
        datatype => 'string',
        base_name => 'dtAgentSickleaveend',
        description => 'The sick leave end date of the Agent',
        format => '',
        read_only => '',
            },
    'e_agent_schedule' => {
    ...
    'b_agent_tranquillit' => {
        ...
        description => 'Whether if it&#39;s an tranquillit',
        format => '',
        read_only => '',
            },
    'b_agent_residentiallicense' => {
        datatype => 'boolean',
        base_name => 'bAgentResidentiallicense',
        description => 'Whether if it&#39;s an residentiallicense',
        format => '',
        read_only => '',
            },
    'b_agent_commerciallicense' => {
        datatype => 'boolean',
        base_name => 'bAgentCommerciallicense',
        description => 'Whether if it&#39;s an commerciallicense',
        format => '',
        read_only => '',
            },
    'b_agent_mortgagelicense' => {
        datatype => 'boolean',
        base_name => 'bAgentMortgagelicense',
        description => 'Whether if it&#39;s an mortgagelicense',
        format => '',
        read_only => '',
            },
    'b_agent_paidbyofficetranquillit' => {
        datatype => 'boolean',
        base_name => 'bAgentPaidbyofficetranquillit',
        description => 'Whether if it&#39;s an paidbyofficetranquillit',
        format => '',
        read_only => '',
            },
    'dt_agent_fintraccertification' => {
        datatype => 'string',
        base_name => 'dtAgentFintraccertification',
        description => 'The fintraccertification of the Agent',
        format => '',
        read_only => '',
            },
    'b_agent_isactive' => {
        datatype => 'boolean',
        base_name => 'bAgentIsactive',
...
__PACKAGE__->openapi_types( {
    ...
    's_agent_code' => 'string',
    'i_agent_photocopiercode' => 'int',
    'i_agent_longdistancecode' => 'int',
    'i_agent_bannernumber' => 'int',
