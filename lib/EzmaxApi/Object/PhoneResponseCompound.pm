...
#
package EzmaxApi::Object::PhoneResponseCompound;
...
__PACKAGE__->class_documentation({description => 'A Phone Object and children to create a complete structure',
