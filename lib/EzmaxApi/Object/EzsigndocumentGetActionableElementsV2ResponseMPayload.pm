...
#
package EzmaxApi::Object::EzsigndocumentGetActionableElementsV2ResponseMPayload;
...
__PACKAGE__->class_documentation({description => 'Payload for GET /2/object/ezsigndocument/{pkiEzsigndocumentID}/getActionableElements',
