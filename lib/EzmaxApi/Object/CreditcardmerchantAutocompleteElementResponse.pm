...
#
package EzmaxApi::Object::CreditcardmerchantAutocompleteElementResponse;
...
__PACKAGE__->class_documentation({description => 'A Creditcardmerchant AutocompleteElement Response',
