...
#
package EzmaxApi::Object::BillingentityinternalGetAutocompleteV2ResponseMPayload;
...
__PACKAGE__->class_documentation({description => 'Payload for POST /2/object/billingentityinternal/getAutocomplete',
...
__PACKAGE__->method_documentation({
    'a_obj_billingentityinternal' => {
        datatype => 'ARRAY[BillingentityinternalAutocompleteElementResponse]',
