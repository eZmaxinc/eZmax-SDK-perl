...
#
package EzmaxApi::Object::EzsignfoldersignerassociationReassignV1Request;
...
__PACKAGE__->class_documentation({description => 'Request for POST /1/object/ezsignfoldersignerassociation/{pkiEzsignfoldersignerassociationID}/reassign',
