...
#
package EzmaxApi::Object::EzsignfolderSendV2Response;
...
__PACKAGE__->class_documentation({description => 'Response for POST /2/object/ezsignfolder/{pkiEzsignfolderID}/send',
