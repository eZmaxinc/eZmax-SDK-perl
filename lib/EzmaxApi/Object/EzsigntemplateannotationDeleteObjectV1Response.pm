...
#
package EzmaxApi::Object::EzsigntemplateannotationDeleteObjectV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for DELETE /1/object/ezsigntemplateannotation/{pkiEzsigntemplateannotationID}',
                                  class => 'EzsigntemplateannotationDeleteObjectV1Response',
                                  required => [], # TODO
}                                 );
