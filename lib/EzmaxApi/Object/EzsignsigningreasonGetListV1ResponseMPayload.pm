...
#
package EzmaxApi::Object::EzsignsigningreasonGetListV1ResponseMPayload;
...
__PACKAGE__->class_documentation({description => 'Payload for GET /1/object/ezsignsigningreason/getList',
...
__PACKAGE__->method_documentation({
    ...
    'a_obj_ezsignsigningreason' => {
        datatype => 'ARRAY[EzsignsigningreasonListElement]',
