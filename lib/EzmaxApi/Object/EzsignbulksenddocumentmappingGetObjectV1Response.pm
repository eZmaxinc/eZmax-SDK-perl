...
#
package EzmaxApi::Object::EzsignbulksenddocumentmappingGetObjectV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /1/object/ezsignbulksenddocumentmapping/{pkiEzsignbulksenddocumentmappingID}',
                                  class => 'EzsignbulksenddocumentmappingGetObjectV1Response',
                                  required => [], # TODO
}                                 );

__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'EzsignbulksenddocumentmappingGetObjectV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
...
__PACKAGE__->openapi_types( {
    'm_payload' => 'EzsignbulksenddocumentmappingGetObjectV1ResponseMPayload',
