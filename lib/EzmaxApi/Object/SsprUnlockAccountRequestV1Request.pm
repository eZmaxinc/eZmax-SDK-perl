...
#
package EzmaxApi::Object::SsprUnlockAccountRequestV1Request;
...
__PACKAGE__->class_documentation({description => 'Request for the /1/module/sspr/unlockAccountRequest API Request',
