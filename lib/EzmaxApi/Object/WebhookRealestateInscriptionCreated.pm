...
#
package EzmaxApi::Object::WebhookRealestateInscriptionCreated;
...
__PACKAGE__->class_documentation({description => 'This is a webhook for a RealestateInscriptionCreated event',
                                  class => 'WebhookRealestateInscriptionCreated',
                                  required => [], # TODO
}                                 );
