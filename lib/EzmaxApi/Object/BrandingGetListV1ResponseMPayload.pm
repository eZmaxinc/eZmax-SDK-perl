...
#
package EzmaxApi::Object::BrandingGetListV1ResponseMPayload;
...
__PACKAGE__->class_documentation({description => 'Payload for GET /1/object/branding/getList',
...
__PACKAGE__->method_documentation({
    'a_obj_branding' => {
        datatype => 'ARRAY[BrandingListElement]',
