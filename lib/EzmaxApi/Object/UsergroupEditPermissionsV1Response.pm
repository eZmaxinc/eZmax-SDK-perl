...
#
package EzmaxApi::Object::UsergroupEditPermissionsV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for PUT /1/object/usergroup/{pkiUsergroupID}/editPermissions',
...
__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'UsergroupEditPermissionsV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
