...
#
package EzmaxApi::Object::EzsignfoldersignerassociationGetInPersonLoginUrlV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for the /1/object/ezsignfoldersignerassociation/getInPersonLoginUrl API Request',
...
__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'EzsignfoldersignerassociationGetInPersonLoginUrlV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
