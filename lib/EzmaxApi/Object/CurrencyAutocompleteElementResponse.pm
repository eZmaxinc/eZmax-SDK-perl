...
#
package EzmaxApi::Object::CurrencyAutocompleteElementResponse;
...
__PACKAGE__->class_documentation({description => 'A Currency AutocompleteElement Response',
