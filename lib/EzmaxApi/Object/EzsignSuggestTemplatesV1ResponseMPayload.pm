...
#
package EzmaxApi::Object::EzsignSuggestTemplatesV1ResponseMPayload;
...
__PACKAGE__->class_documentation({description => 'Payload for GET /1/module/ezsign/suggestTemplates',
...
__PACKAGE__->method_documentation({
    'a_obj_ezsigntemplate' => {
        datatype => 'ARRAY[EzsigntemplateResponseCompound]',
    ...
    'a_obj_ezsigntemplatepackage' => {
        datatype => 'ARRAY[EzsigntemplatepackageResponseCompound]',
        base_name => 'a_objEzsigntemplatepackage',
        description => '',
        format => '',
        read_only => '',
            },
