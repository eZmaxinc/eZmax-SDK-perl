...
#
package EzmaxApi::Object::DepositGetAttachmentsV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /1/object/deposit/{pkiDepositID}/getAttachments',
                                  class => 'DepositGetAttachmentsV1Response',
                                  required => [], # TODO
}                                 );
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'DepositGetAttachmentsV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
