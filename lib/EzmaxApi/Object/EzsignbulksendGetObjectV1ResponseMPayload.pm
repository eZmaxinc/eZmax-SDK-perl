...
#
package EzmaxApi::Object::EzsignbulksendGetObjectV1ResponseMPayload;
...
__PACKAGE__->class_documentation({description => 'Payload for the /1/object/ezsignbulksend/{pkiEzsignbulksendID}/getObject API Request',
