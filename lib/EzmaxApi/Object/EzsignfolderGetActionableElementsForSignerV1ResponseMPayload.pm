...
#
package EzmaxApi::Object::EzsignfolderGetActionableElementsForSignerV1ResponseMPayload;
...
__PACKAGE__->class_documentation({description => 'Payload for GET /1/object/ezsignfolder/{pkiEzsignfolderID}/getActionableElementsForSigner',
