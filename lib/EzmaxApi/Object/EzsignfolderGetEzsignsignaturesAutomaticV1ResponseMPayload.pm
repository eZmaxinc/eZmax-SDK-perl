...
#
package EzmaxApi::Object::EzsignfolderGetEzsignsignaturesAutomaticV1ResponseMPayload;
...
__PACKAGE__->class_documentation({description => 'Payload for GET /1/object/ezsignfolder/{pkiEzsignfolderID}/getEzsignsignaturesAutomatic',
