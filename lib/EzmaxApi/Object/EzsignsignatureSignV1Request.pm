...
#
package EzmaxApi::Object::EzsignsignatureSignV1Request;
...
__PACKAGE__->class_documentation({description => 'Request for POST /1/object/ezsignsignature/{pkiEzsignsignatureID}/sign',
...
__PACKAGE__->method_documentation({
    ...
    's_value' => {
        datatype => 'string',
        base_name => 'sValue',
        description => 'The value required for the Ezsignsignature.  This can only be set if eEzsignsignatureType is **City**, **FieldText** or **FieldTextarea**',
        format => '',
        read_only => '',
            },
    'e_attachments_confirmation_decision' => {
        datatype => 'string',
        base_name => 'eAttachmentsConfirmationDecision',
        description => 'Whether the attachment are accepted or refused.  This can only be set if eEzsignsignatureType is **AttachmentsConfirmation**',
        format => '',
        read_only => '',
            },
    's_attachments_refusal_reason' => {
        datatype => 'string',
        base_name => 'sAttachmentsRefusalReason',
        description => 'The reason of refused.  This can only be set if eEzsignsignatureType is **AttachmentsConfirmation**',
        format => '',
        read_only => '',
            },
    's_svg' => {
