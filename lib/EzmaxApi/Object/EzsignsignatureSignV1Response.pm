...
#
package EzmaxApi::Object::EzsignsignatureSignV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for POST /1/object/ezsignsignature/{pkiEzsignsignatureID}/sign',
...
__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'object',
        base_name => 'mPayload',
        description => 'Payload for POST /1/object/ezsignsignature/{pkiEzsignsignatureID}/sign',
        format => '',
        read_only => '',
            },
    'obj_debug_payload' => {
