...
#
package EzmaxApi::Object::EzsigntemplatepublicCreateEzsignfolderV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for POST /1/object/ezsigntemplatepublic/createEzsignfolder',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'EzsigntemplatepublicCreateEzsignfolderV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
