...
#
package EzmaxApi::Object::EzsigntemplatepackagemembershipCreateObjectV1ResponseMPayload;
...
__PACKAGE__->class_documentation({description => 'Payload for POST /1/object/ezsigntemplatepackagemembership',
...
__PACKAGE__->method_documentation({
    'a_pki_ezsigntemplatepackagemembership_id' => {
        datatype => 'ARRAY[int]',
        base_name => 'a_pkiEzsigntemplatepackagemembershipID',
...
__PACKAGE__->openapi_types( {
    'a_pki_ezsigntemplatepackagemembership_id' => 'ARRAY[int]',
