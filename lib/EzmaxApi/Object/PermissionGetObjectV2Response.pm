...
#
package EzmaxApi::Object::PermissionGetObjectV2Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /2/object/permission/{pkiPermissionID}',
...
__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'PermissionGetObjectV2ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
