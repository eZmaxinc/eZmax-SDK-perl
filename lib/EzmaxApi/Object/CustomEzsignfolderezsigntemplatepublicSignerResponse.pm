...
#
package EzmaxApi::Object::CustomEzsignfolderezsigntemplatepublicSignerResponse;
...
__PACKAGE__->class_documentation({description => 'A form Signer Object in the context of an Ezsignfoldertransmissions',
