...
#
package EzmaxApi::Object::EzmaxmaillinglistGetListV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /1/object/ezmaxmaillinglist/getList',
                                  class => 'EzmaxmaillinglistGetListV1Response',
                                  required => [], # TODO
}                                 );
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'EzmaxmaillinglistGetListV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
