...
#
package EzmaxApi::Object::AuthenticationexternalResetAuthorizationV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for POST /1/object/authenticationexternal/{pkiAuthenticationexternalID}/resetAuthorization',
