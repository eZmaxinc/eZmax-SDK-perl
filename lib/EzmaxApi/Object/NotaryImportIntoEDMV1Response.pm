...
#
package EzmaxApi::Object::NotaryImportIntoEDMV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for POST /1/object/notary/{pkiNotaryID}/importIntoEDM',
                                  class => 'NotaryImportIntoEDMV1Response',
                                  required => [], # TODO
}                                 );
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'NotaryImportIntoEDMV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
