...
#
package EzmaxApi::Object::CustomEzsignsignatureEzsignsignaturesAutomaticResponse;
...
__PACKAGE__->class_documentation({description => 'An Ezsignsignature Object in the context of an EzsignsignaturesAutomatic path',
