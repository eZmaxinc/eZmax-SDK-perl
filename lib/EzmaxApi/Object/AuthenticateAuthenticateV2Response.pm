...
#
package EzmaxApi::Object::AuthenticateAuthenticateV2Response;
...
__PACKAGE__->class_documentation({description => 'Response for the /2/module/authenticate/authenticate API Request',
...
__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'AuthenticateAuthenticateV2ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
