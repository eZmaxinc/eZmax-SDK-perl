...
#
package EzmaxApi::Object::EzsigntemplatedocumentGetObjectV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /1/object/ezsigntemplatedocument/{pkiEzsigntemplatedocumentID}',
...
__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'EzsigntemplatedocumentGetObjectV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
...
__PACKAGE__->openapi_types( {
    'm_payload' => 'EzsigntemplatedocumentGetObjectV1ResponseMPayload',
