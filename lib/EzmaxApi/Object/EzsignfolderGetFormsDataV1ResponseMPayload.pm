...
#
package EzmaxApi::Object::EzsignfolderGetFormsDataV1ResponseMPayload;
...
__PACKAGE__->class_documentation({description => 'Payload for the /1/object/ezsignfolder/{pkiEzsigndocument}/getFormsData API Request',
...
__PACKAGE__->method_documentation({
    ...
    'a_obj_form_data_document' => {
        datatype => 'ARRAY[CustomFormDataDocumentResponse]',
        base_name => 'a_objFormDataDocument',
        description => '',
        format => '',
        read_only => '',
            },
