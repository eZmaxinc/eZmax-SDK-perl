...
#
package EzmaxApi::Object::EzsigntemplatepackageGetListV1ResponseMPayload;
...
__PACKAGE__->class_documentation({description => 'Payload for the /1/object/ezsigntemplatepackage/getList API Request',
...
__PACKAGE__->method_documentation({
    'a_obj_ezsigntemplatepackage' => {
        datatype => 'ARRAY[EzsigntemplatepackageListElement]',
