...
#
package EzmaxApi::Object::DomainGetObjectV2Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /2/object/domain/{pkiDomainID}',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'DomainGetObjectV2ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
