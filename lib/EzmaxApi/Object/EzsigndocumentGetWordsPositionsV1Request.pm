...
#
package EzmaxApi::Object::EzsigndocumentGetWordsPositionsV1Request;
...
__PACKAGE__->class_documentation({description => 'Request for the /1/object/ezsigndocument/{pkiEzsigndocumentID}/getWordsPositions API Request',
