...
#
package EzmaxApi::Object::CustomEzsignfoldersignerassociationstatusResponseV3;
...
__PACKAGE__->class_documentation({description => 'A Ezsignfoldersignerassociationstatus Object and children to create a complete structure',
...
__PACKAGE__->method_documentation({
    ...
    's_ezsignfoldersignerassociationstatus_lastname' => {
        datatype => 'string',
        base_name => 'sEzsignfoldersignerassociationstatusLastname',
    ...
    's_ezsignfoldersignerassociationstatus_firstname' => {
        datatype => 'string',
        base_name => 'sEzsignfoldersignerassociationstatusFirstname',
