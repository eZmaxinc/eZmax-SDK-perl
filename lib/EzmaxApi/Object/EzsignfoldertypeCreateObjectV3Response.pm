...
#
package EzmaxApi::Object::EzsignfoldertypeCreateObjectV3Response;
...
__PACKAGE__->class_documentation({description => 'Response for POST /3/object/ezsignfoldertype',
...
__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'EzsignfoldertypeCreateObjectV3ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
