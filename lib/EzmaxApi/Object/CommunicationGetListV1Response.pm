...
#
package EzmaxApi::Object::CommunicationGetListV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /1/object/communication/getList',
...
__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'CommunicationGetListV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
...
__PACKAGE__->openapi_types( {
    'm_payload' => 'CommunicationGetListV1ResponseMPayload',
