...
#
package EzmaxApi::Object::EzsigndocumentApplyEzsigntemplateV3Response;
...
__PACKAGE__->class_documentation({description => 'Response for POST /3/object/ezsigndocument/{pkiEzsigndocument}/applyEzsigntemplate',
                                  class => 'EzsigndocumentApplyEzsigntemplateV3Response',
                                  required => [], # TODO
}                                 );
