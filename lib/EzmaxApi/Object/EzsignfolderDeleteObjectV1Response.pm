...
#
package EzmaxApi::Object::EzsignfolderDeleteObjectV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for the /1/object/ezsignfolder/deleteObject API Request',
