...
#
package EzmaxApi::Object::AuthenticationexternalGetObjectV2Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /2/object/authenticationexternal/{pkiAuthenticationexternalID}',
...
__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'AuthenticationexternalGetObjectV2ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
