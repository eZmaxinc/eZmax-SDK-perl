...
#
package EzmaxApi::Object::EzsignfoldertypeEditObjectV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for PUT /1/object/ezsignfoldertype/{pkiEzsignfoldertypeID}',
