...
#
package EzmaxApi::Object::CreditcardclientGetListV1ResponseMPayload;
...
__PACKAGE__->class_documentation({description => 'Payload for GET /1/object/creditcardclient/getList',
...
__PACKAGE__->method_documentation({
    ...
    'a_obj_creditcardclient' => {
        datatype => 'ARRAY[CreditcardclientListElement]',
