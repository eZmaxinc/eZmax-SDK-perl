...
#
package EzmaxApi::Object::EzsigntemplatepackagemembershipResponseCompoundV3;
...
__PACKAGE__->class_documentation({description => 'A Ezsigntemplatepackagemembership Object',
...
__PACKAGE__->method_documentation({
    ...
    'obj_ezsigntemplate' => {
        datatype => 'EzsigntemplateResponseCompoundV4',
    ...
    'a_obj_ezsigntemplatepackagesignermembership' => {
        datatype => 'ARRAY[EzsigntemplatepackagesignermembershipResponseCompound]',
        base_name => 'a_objEzsigntemplatepackagesignermembership',
        description => '',
        format => '',
        read_only => '',
            },
