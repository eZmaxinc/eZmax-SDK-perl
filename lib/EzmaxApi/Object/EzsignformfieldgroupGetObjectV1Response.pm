...
#
package EzmaxApi::Object::EzsignformfieldgroupGetObjectV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /1/object/ezsignformfieldgroup/{pkiEzsignformfieldgroupID}',
...
__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'EzsignformfieldgroupGetObjectV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
...
__PACKAGE__->openapi_types( {
    'm_payload' => 'EzsignformfieldgroupGetObjectV1ResponseMPayload',
