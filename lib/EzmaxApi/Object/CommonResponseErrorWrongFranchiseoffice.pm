...
#
package EzmaxApi::Object::CommonResponseErrorWrongFranchiseoffice;
...
__PACKAGE__->class_documentation({description => 'Error Message when a Franchisebroker is not in this Franchiseoffice.',
...
__PACKAGE__->method_documentation({
    ...
    's_franchiseagence_name' => {
        datatype => 'string',
        base_name => 'sFranchiseagenceName',
        description => 'The name of the Franchiseagence',
        format => '',
        read_only => '',
            },
    ...
    'i_franchiseoffice_code' => {
        datatype => 'string',
        base_name => 'iFranchiseofficeCode',
        description => 'The code of the Franchiseoffice',
        format => '',
        read_only => '',
            },
});
