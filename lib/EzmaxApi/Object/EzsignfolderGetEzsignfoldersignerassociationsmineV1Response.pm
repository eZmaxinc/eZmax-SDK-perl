...
#
package EzmaxApi::Object::EzsignfolderGetEzsignfoldersignerassociationsmineV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /1/object/ezsignfolder/{pkiEzsignfolder}/getEzsignfoldersignerassociationsmine',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'EzsignfolderGetEzsignfoldersignerassociationsmineV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
