...
#
package EzmaxApi::Object::CreditcardmerchantGetListV1ResponseMPayload;
...
__PACKAGE__->class_documentation({description => 'Payload for GET /1/object/creditcardmerchant/getList',
...
__PACKAGE__->method_documentation({
    ...
    'a_obj_creditcardmerchant' => {
        datatype => 'ARRAY[CreditcardmerchantListElement]',
