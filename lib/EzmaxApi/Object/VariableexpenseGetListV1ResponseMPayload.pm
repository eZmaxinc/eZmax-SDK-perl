...
#
package EzmaxApi::Object::VariableexpenseGetListV1ResponseMPayload;
...
__PACKAGE__->class_documentation({description => 'Payload for GET /1/object/variableexpense/getList',
...
__PACKAGE__->method_documentation({
    ...
    'a_obj_variableexpense' => {
        datatype => 'ARRAY[VariableexpenseListElement]',
