...
#
package EzmaxApi::Object::EzsigntemplatepublicListElement;
...
__PACKAGE__->class_documentation({description => 'A Ezsigntemplatepublic List Element',
...
__PACKAGE__->method_documentation({
    ...
    'i_ezsignfolder' => {
        datatype => 'int',
        base_name => 'iEzsignfolder',
        description => 'The total number of Ezsignfolders using the Ezsigntemplatepublic',
        format => '',
        read_only => '',
            },
    'i_ezsigndocument' => {
        ...
        description => 'The total number of Ezsigndocuments using the Ezsigntemplatepublic',
        format => '',
        read_only => '',
            },
