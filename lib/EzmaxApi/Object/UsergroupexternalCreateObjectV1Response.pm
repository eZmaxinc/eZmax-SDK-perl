...
#
package EzmaxApi::Object::UsergroupexternalCreateObjectV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for POST /1/object/usergroupexternal',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'UsergroupexternalCreateObjectV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
