...
#
package EzmaxApi::Object::EzdoctemplatedocumentAutocompleteElementResponse;
...
__PACKAGE__->class_documentation({description => 'A Ezdoctemplatedocument AutocompleteElement Response',
