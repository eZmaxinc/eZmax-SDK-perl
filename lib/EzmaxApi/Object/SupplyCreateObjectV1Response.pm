...
#
package EzmaxApi::Object::SupplyCreateObjectV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for POST /1/object/supply',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'SupplyCreateObjectV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
