...
#
package EzmaxApi::Object::EzsignfoldertypeCreateObjectV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for POST /1/object/ezsignfoldertype',
...
__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'EzsignfoldertypeCreateObjectV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
