...
#
package EzmaxApi::Object::EzsigndocumentGetObjectV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for the /1/object/ezsigndocument/getDownloadUrl API Request',
