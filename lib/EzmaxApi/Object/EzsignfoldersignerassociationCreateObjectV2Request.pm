...
#
package EzmaxApi::Object::EzsignfoldersignerassociationCreateObjectV2Request;
...
__PACKAGE__->class_documentation({description => 'Request for the /2/object/ezsignfoldersignerassociation/createObject API Request',
...
__PACKAGE__->method_documentation({
    'a_obj_ezsignfoldersignerassociation' => {
        datatype => 'ARRAY[EzsignfoldersignerassociationRequestCompound]',
