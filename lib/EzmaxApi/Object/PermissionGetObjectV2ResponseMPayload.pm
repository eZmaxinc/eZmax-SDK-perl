...
#
package EzmaxApi::Object::PermissionGetObjectV2ResponseMPayload;
...
__PACKAGE__->class_documentation({description => 'Payload for GET /2/object/permission/{pkiPermissionID}',
