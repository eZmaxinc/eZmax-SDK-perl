...
#
package EzmaxApi::Object::BillingentityexternalAutocompleteElementResponse;
...
__PACKAGE__->class_documentation({description => 'A Billingentityexternal AutocompleteElement Response',
...
__PACKAGE__->method_documentation({
    'pki_billingentityexternal_id' => {
        datatype => 'int',
        base_name => 'pkiBillingentityexternalID',
    ...
    'b_billingentityexternal_isactive' => {
        datatype => 'boolean',
        base_name => 'bBillingentityexternalIsactive',
