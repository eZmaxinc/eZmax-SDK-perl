...
#
package EzmaxApi::Object::SystemconfigurationtypeAutocompleteElementResponse;
...
__PACKAGE__->class_documentation({description => 'A Systemconfigurationtype AutocompleteElement Response',
...
__PACKAGE__->method_documentation({
    'pki_systemconfigurationtype_id' => {
        datatype => 'int',
        base_name => 'pkiSystemconfigurationtypeID',
    ...
    'b_systemconfigurationtype_isactive' => {
        datatype => 'boolean',
        base_name => 'bSystemconfigurationtypeIsactive',
        description => 'Whether Systemconfigurationtype is active or not',
        format => '',
        read_only => '',
            },
});
...
__PACKAGE__->openapi_types( {
    'pki_systemconfigurationtype_id' => 'int',
