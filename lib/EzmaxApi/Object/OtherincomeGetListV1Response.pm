...
#
package EzmaxApi::Object::OtherincomeGetListV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /1/object/otherincome/getList',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'OtherincomeGetListV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
