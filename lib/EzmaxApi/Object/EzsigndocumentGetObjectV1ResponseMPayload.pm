...
__PACKAGE__->class_documentation({description => 'Payload for the /1/object/ezsigndocument/getObject API Request',
...
__PACKAGE__->method_documentation({
    ...
    's_ezsigndocument_filename' => {
        datatype => 'string',
        base_name => 'sEzsigndocumentFilename',
