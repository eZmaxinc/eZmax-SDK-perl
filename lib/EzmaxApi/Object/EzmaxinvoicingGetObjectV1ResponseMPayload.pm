...
#
package EzmaxApi::Object::EzmaxinvoicingGetObjectV1ResponseMPayload;
...
__PACKAGE__->class_documentation({description => 'Payload for GET /1/object/ezmaxinvoicing/{pkiEzmaxinvoicingID}',
