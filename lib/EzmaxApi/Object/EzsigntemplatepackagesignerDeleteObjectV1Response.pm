...
#
package EzmaxApi::Object::EzsigntemplatepackagesignerDeleteObjectV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for DELETE /1/object/ezsigntemplatepackagesigner/{pkiEzsigntemplatepackagesignerID}',
...
__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'EzsigntemplatepackagesignerDeleteObjectV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
