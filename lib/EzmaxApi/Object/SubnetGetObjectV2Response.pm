...
#
package EzmaxApi::Object::SubnetGetObjectV2Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /2/object/subnet/{pkiSubnetID}',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'SubnetGetObjectV2ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
