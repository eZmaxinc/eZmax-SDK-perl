...
#
package EzmaxApi::Object::EzsigntemplatepackagesignerRequestCompoundV2;
...
__PACKAGE__->class_documentation({description => 'A Ezsigntemplatepackagesigner Object and children',
...
__PACKAGE__->method_documentation({
    ...
    'e_ezsigntemplatepackagesigner_role' => {
        datatype => 'FieldEEzsigntemplatepackagesignerRole',
        base_name => 'eEzsigntemplatepackagesignerRole',
        description => '',
        format => '',
        read_only => '',
            },
