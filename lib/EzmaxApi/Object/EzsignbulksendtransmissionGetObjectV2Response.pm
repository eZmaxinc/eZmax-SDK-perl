...
#
package EzmaxApi::Object::EzsignbulksendtransmissionGetObjectV2Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /2/object/ezsignbulksendtransmission/{pkiEzsignbulksendtransmissionID}',
...
__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'EzsignbulksendtransmissionGetObjectV2ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
