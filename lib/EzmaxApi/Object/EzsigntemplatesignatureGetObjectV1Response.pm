...
#
package EzmaxApi::Object::EzsigntemplatesignatureGetObjectV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /1/object/ezsigntemplatesignature/{pkiEzsigntemplatesignatureID}',
...
__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'EzsigntemplatesignatureGetObjectV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
...
__PACKAGE__->openapi_types( {
    'm_payload' => 'EzsigntemplatesignatureGetObjectV1ResponseMPayload',
