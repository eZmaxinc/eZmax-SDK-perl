...
#
package EzmaxApi::Object::EzsignsignatureCreateObjectV3Response;
...
__PACKAGE__->class_documentation({description => 'Response for POST /3/object/ezsignsignature',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'EzsignsignatureCreateObjectV3ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
