...
#
package EzmaxApi::Object::CreditcardclientAutocompleteElementResponse;
...
__PACKAGE__->class_documentation({description => 'A Creditcardclient AutocompleteElement Response',
