...
#
package EzmaxApi::Object::EzsignfolderSendV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for the /1/object/ezsignfolder/{pkiEzsignfolderID}/send API Request',
