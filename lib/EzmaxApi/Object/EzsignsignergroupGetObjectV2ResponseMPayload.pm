...
#
package EzmaxApi::Object::EzsignsignergroupGetObjectV2ResponseMPayload;
...
__PACKAGE__->class_documentation({description => 'Payload for GET /2/object/ezsignsignergroup/{pkiEzsignsignergroupID}',
