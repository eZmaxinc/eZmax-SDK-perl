...
#
package EzmaxApi::Object::RejectedoffertopurchaseGetCommunicationrecipientsV1Response;
...
__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'RejectedoffertopurchaseGetCommunicationrecipientsV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
