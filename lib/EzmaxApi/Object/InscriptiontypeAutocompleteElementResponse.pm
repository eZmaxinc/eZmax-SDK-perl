...
#
package EzmaxApi::Object::InscriptiontypeAutocompleteElementResponse;
...
__PACKAGE__->class_documentation({description => 'A Inscriptiontype AutocompleteElement Response',
...
__PACKAGE__->method_documentation({
    'pki_inscriptiontype_id' => {
        datatype => 'int',
        base_name => 'pkiInscriptiontypeID',
