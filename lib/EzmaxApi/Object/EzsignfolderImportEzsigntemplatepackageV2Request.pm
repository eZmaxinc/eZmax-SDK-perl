...
#
package EzmaxApi::Object::EzsignfolderImportEzsigntemplatepackageV2Request;
...
__PACKAGE__->class_documentation({description => 'Request for POST /2/object/ezsignfolder/{pkiEzsignfolderID}/importEzsigntemplatepackage',
