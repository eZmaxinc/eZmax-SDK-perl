...
#
package EzmaxApi::Object::VariableexpenseGetAutocompleteV2Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /2/object/variableexpense/getAutocomplete',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'VariableexpenseGetAutocompleteV2ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
