...
#
package EzmaxApi::Object::EzsignfolderSendV3Request;
...
__PACKAGE__->class_documentation({description => 'Request for POST /3/object/ezsignfolder/{pkiEzsignfolderID}/send',
