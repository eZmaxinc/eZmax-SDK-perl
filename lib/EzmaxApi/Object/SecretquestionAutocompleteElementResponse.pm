...
#
package EzmaxApi::Object::SecretquestionAutocompleteElementResponse;
...
__PACKAGE__->class_documentation({description => 'A Secretquestion AutocompleteElement Response',
...
__PACKAGE__->method_documentation({
    's_secretquestion_text_x' => {
        datatype => 'string',
        base_name => 'sSecretquestionTextX',
    ...
    'b_secretquestion_isactive' => {
        datatype => 'boolean',
        base_name => 'bSecretquestionIsactive',
