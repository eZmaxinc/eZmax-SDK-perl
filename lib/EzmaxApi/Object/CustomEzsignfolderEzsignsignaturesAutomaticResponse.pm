...
#
package EzmaxApi::Object::CustomEzsignfolderEzsignsignaturesAutomaticResponse;
...
__PACKAGE__->class_documentation({description => 'An Ezsignfolder Object in the context of an EzsignsignaturesAutomatic path',
...
__PACKAGE__->method_documentation({
    ...
    'a_obj_ezsigndocument' => {
        datatype => 'ARRAY[CustomEzsigndocumentEzsignsignaturesAutomaticResponse]',
