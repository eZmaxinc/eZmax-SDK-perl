...
#
package EzmaxApi::Object::EzmaxpartnerGetObjectV2Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /1/object/ezmaxpartner/{pkiEzmaxpartnerID}',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'EzmaxpartnerGetObjectV2ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
