...
#
package EzmaxApi::Object::UsergroupEditPermissionsV1ResponseMPayload;
...
__PACKAGE__->class_documentation({description => 'Payload for PUT /1/object/usergroup/{pkiUsergroupID}/editPermissions',
