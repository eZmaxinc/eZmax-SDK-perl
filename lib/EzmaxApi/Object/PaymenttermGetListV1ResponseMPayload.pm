...
#
package EzmaxApi::Object::PaymenttermGetListV1ResponseMPayload;
...
__PACKAGE__->class_documentation({description => 'Payload for GET /1/object/paymentterm/getList',
...
__PACKAGE__->method_documentation({
    'a_obj_paymentterm' => {
        datatype => 'ARRAY[PaymenttermListElement]',
