...
#
package EzmaxApi::Object::SignatureDeleteObjectV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for DELETE /1/object/signature/{pkiSignatureID}',
