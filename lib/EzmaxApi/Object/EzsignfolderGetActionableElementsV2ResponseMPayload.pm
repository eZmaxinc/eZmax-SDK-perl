...
#
package EzmaxApi::Object::EzsignfolderGetActionableElementsV2ResponseMPayload;
...
__PACKAGE__->class_documentation({description => 'Payload for GET /2/object/ezsignfolder/{pkiEzsignfolderID}/getActionableElements',
