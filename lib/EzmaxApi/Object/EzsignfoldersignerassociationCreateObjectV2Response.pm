...
#
package EzmaxApi::Object::EzsignfoldersignerassociationCreateObjectV2Response;
...
__PACKAGE__->class_documentation({description => 'Response for the /2/object/ezsignfoldersignerassociation/createObject API Request',
...
__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'EzsignfoldersignerassociationCreateObjectV2ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
