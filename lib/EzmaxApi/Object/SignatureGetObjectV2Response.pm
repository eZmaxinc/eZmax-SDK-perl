...
#
package EzmaxApi::Object::SignatureGetObjectV2Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /2/object/signature/{pkiSignatureID}',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'SignatureGetObjectV2ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
