...
#
package EzmaxApi::Object::EzsigntemplatepublicGetEzsigntemplatepublicDetailsV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for POST /1/object/ezsigntemplatepublic/getEzsigntemplatepublicDetails',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'EzsigntemplatepublicGetEzsigntemplatepublicDetailsV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
