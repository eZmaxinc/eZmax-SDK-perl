...
#
package EzmaxApi::Object::EzsigndocumentSubmitEzsignformV1Request;
...
__PACKAGE__->class_documentation({description => 'Request for POST /1/object/ezsigndocument/{pkiEzsigndocumentID}/submitEzsignform',
