...
#
package EzmaxApi::Object::ListGetListpresentationV1ResponseMPayload;
...
__PACKAGE__->class_documentation({description => 'Payload for the GET /1/module/list/listpresentation/{sListName} API Request',
