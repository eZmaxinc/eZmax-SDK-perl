...
#
package EzmaxApi::Object::DiscussionDeleteObjectV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for DELETE /1/object/discussion/{pkiDiscussionID}',
