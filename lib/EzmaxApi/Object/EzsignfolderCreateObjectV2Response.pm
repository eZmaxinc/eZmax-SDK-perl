...
#
package EzmaxApi::Object::EzsignfolderCreateObjectV2Response;
...
__PACKAGE__->class_documentation({description => 'Response for the /2/object/ezsignfolder/createObject API Request',
...
__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'EzsignfolderCreateObjectV2ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
