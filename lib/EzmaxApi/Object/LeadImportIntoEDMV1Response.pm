...
#
package EzmaxApi::Object::LeadImportIntoEDMV1Response;
...
__PACKAGE__->class_documentation({description => 'Request for POST /1/object/lead/{pkiLeadID}/importIntoEDM',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'LeadImportIntoEDMV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
