...
#
package EzmaxApi::Object::EzsigntemplatepackageDeleteObjectV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for DELETE /1/object/ezsigntemplatepackage/{pkiEzsigntemplatepackageID}',
