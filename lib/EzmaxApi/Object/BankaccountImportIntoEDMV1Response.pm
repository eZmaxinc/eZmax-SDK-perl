...
#
package EzmaxApi::Object::BankaccountImportIntoEDMV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for POST /1/object/bankaccount/{pkiBankaccountID}/importIntoEDM',
                                  class => 'BankaccountImportIntoEDMV1Response',
                                  required => [], # TODO
}                                 );
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'BankaccountImportIntoEDMV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
