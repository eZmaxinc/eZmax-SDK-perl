...
#
package EzmaxApi::Object::WebhookGetListV1ResponseMPayload;
...
__PACKAGE__->class_documentation({description => 'Payload for GET /1/object/webhook/getList',
...
__PACKAGE__->method_documentation({
    'a_obj_webhook' => {
        datatype => 'ARRAY[WebhookListElement]',
