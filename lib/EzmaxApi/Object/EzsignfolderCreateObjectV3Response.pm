...
#
package EzmaxApi::Object::EzsignfolderCreateObjectV3Response;
...
__PACKAGE__->class_documentation({description => 'Response for POST /3/object/ezsignfolder',
...
__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'EzsignfolderCreateObjectV3ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
