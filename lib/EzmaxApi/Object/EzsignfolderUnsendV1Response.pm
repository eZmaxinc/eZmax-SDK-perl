...
#
package EzmaxApi::Object::EzsignfolderUnsendV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for the /1/object/ezsignfolder/{pkiEzsignfolderID}/unsend API Request',
