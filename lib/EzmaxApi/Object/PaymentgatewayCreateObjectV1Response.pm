...
#
package EzmaxApi::Object::PaymentgatewayCreateObjectV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for POST /1/object/paymentgateway',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'PaymentgatewayCreateObjectV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
