...
#
package EzmaxApi::Object::UserstagedGetListV1ResponseMPayload;
...
__PACKAGE__->class_documentation({description => 'Payload for GET /1/object/userstaged/getList',
...
__PACKAGE__->method_documentation({
    ...
    'a_obj_userstaged' => {
        datatype => 'ARRAY[UserstagedListElement]',
        base_name => 'a_objUserstaged',
        description => '',
        format => '',
        read_only => '',
            },
