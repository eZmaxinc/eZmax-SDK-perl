...
#
package EzmaxApi::Object::UsergroupexternalGetUsergroupexternalmembershipsV1Response;
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'UsergroupexternalGetUsergroupexternalmembershipsV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
