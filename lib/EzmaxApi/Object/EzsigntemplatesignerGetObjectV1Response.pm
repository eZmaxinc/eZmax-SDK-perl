...
#
package EzmaxApi::Object::EzsigntemplatesignerGetObjectV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /1/object/ezsigntemplatesigner/{pkiEzsigntemplatesignerID}',
...
__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'EzsigntemplatesignerGetObjectV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
...
__PACKAGE__->openapi_types( {
    'm_payload' => 'EzsigntemplatesignerGetObjectV1ResponseMPayload',
