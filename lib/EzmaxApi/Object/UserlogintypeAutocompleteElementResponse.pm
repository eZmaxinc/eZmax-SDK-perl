...
#
package EzmaxApi::Object::UserlogintypeAutocompleteElementResponse;
...
__PACKAGE__->class_documentation({description => 'A Userlogintype AutocompleteElement Response',
...
__PACKAGE__->method_documentation({
    ...
    'b_userlogintype_isactive' => {
        datatype => 'boolean',
        base_name => 'bUserlogintypeIsactive',
