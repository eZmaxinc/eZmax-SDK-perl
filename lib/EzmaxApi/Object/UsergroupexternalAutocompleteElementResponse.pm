...
#
package EzmaxApi::Object::UsergroupexternalAutocompleteElementResponse;
...
__PACKAGE__->class_documentation({description => 'A Usergroupexternal AutocompleteElement Response',
...
__PACKAGE__->method_documentation({
    'pki_usergroupexternal_id' => {
        datatype => 'int',
        base_name => 'pkiUsergroupexternalID',
    ...
    'b_usergroupexternal_isactive' => {
        datatype => 'boolean',
        base_name => 'bUsergroupexternalIsactive',
        description => 'Whether the Usergroupexternal is active or not',
        format => '',
        read_only => '',
            },
});
