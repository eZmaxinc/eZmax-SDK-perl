...
#
package EzmaxApi::Object::UserCreateEzsignuserV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for the /1/module/user/createEzsignuser API Request',
...
__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'UserCreateEzsignuserV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
