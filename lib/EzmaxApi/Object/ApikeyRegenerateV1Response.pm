...
#
package EzmaxApi::Object::ApikeyRegenerateV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /1/object/apikey/{pkiApikeyID}/regenerate',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'ApikeyRegenerateV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
