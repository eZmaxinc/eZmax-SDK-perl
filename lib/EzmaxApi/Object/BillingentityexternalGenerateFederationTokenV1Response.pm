...
#
package EzmaxApi::Object::BillingentityexternalGenerateFederationTokenV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for POST /1/object/billingentityexternal/{pkiBillingentityexternalID}/generateFederationToken',
...
__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'BillingentityexternalGenerateFederationTokenV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
