...
#
package EzmaxApi::Object::EzsignfoldertypeEditObjectV2Response;
...
__PACKAGE__->class_documentation({description => 'Response for PUT /2/object/ezsignfoldertype/{pkiEzsignfoldertypeID}',
