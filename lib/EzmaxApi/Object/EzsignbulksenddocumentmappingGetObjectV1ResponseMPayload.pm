...
#
package EzmaxApi::Object::EzsignbulksenddocumentmappingGetObjectV1ResponseMPayload;
...
__PACKAGE__->class_documentation({description => 'Payload for GET /1/object/ezsignbulksenddocumentmapping/{pkiEzsignbulksenddocumentmappingID}',
...
__PACKAGE__->method_documentation({
    ...
    'obj_ezsigntemplatepackage' => {
        datatype => 'EzsigntemplatepackageResponseCompound',
