...
#
package EzmaxApi::Object::BrokerGetListV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /1/object/broker/getList',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'BrokerGetListV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
