...
#
package EzmaxApi::Object::WebhookRealestateBuyercontractCreated;
...
__PACKAGE__->class_documentation({description => 'This is the base Webhook object',
                                  class => 'WebhookRealestateBuyercontractCreated',
                                  required => [], # TODO
}                                 );
...
__PACKAGE__->method_documentation({
    ...
    'obj_buyercontract' => {
        datatype => 'BuyercontractResponse',
        base_name => 'objBuyercontract',
        description => '',
        format => '',
        read_only => '',
            },
