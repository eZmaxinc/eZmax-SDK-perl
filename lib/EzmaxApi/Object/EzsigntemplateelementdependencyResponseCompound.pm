...
#
package EzmaxApi::Object::EzsigntemplateelementdependencyResponseCompound;
...
__PACKAGE__->method_documentation({
    ...
    'fki_ezsigntemplateformfield_id' => {
        datatype => 'int',
        base_name => 'fkiEzsigntemplateformfieldID',
    ...
    'fki_ezsigntemplatesignature_id' => {
        datatype => 'int',
        base_name => 'fkiEzsigntemplatesignatureID',
...
__PACKAGE__->openapi_types( {
    ...
    'fki_ezsigntemplateformfield_id' => 'int',
    'fki_ezsigntemplatesignature_id' => 'int',
