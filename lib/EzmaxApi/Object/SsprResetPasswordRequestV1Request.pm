...
#
package EzmaxApi::Object::SsprResetPasswordRequestV1Request;
...
__PACKAGE__->class_documentation({description => 'Request for the /1/module/sspr/resetPasswordRequest API Request',
