...
#
package EzmaxApi::Object::EzmaxinvoicingGetObjectV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /1/object/ezmaxinvoicing/{pkiEzmaxinvoicingID}',
...
__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'EzmaxinvoicingGetObjectV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
...
__PACKAGE__->openapi_types( {
    'm_payload' => 'EzmaxinvoicingGetObjectV1ResponseMPayload',
