...
#
package EzmaxApi::Object::CustomEzsigndocumentGetEzsignannotationsResponse;
...
__PACKAGE__->class_documentation({description => 'An Ezsigndocument Object in the context of a getEzsignannotations path',
