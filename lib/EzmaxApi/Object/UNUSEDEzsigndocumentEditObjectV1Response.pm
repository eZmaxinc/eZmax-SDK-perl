...
#
package EzmaxApi::Object::UNUSEDEzsigndocumentEditObjectV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for the /1/object/ezsigndocument/editObject API Request',
