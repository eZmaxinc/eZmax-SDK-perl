...
#
package EzmaxApi::Object::CreditcardmerchantGetObjectV2Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /2/object/creditcardmerchant/{pkiCreditcardmerchantID}',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'CreditcardmerchantGetObjectV2ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
