...
#
package EzmaxApi::Object::CommunicationResponseCompound;
...
__PACKAGE__->class_documentation({description => 'A Communication Object',
...
__PACKAGE__->method_documentation({
    ...
    'a_obj_communicationattachment' => {
        datatype => 'ARRAY[CommunicationattachmentResponseCompound]',
    ...
    'a_obj_communicationrecipient' => {
        datatype => 'ARRAY[CommunicationrecipientResponseCompound]',
    ...
    'a_obj_communicationexternalrecipient' => {
        datatype => 'ARRAY[CommunicationexternalrecipientResponseCompound]',
