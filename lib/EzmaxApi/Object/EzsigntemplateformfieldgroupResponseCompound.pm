...
#
package EzmaxApi::Object::EzsigntemplateformfieldgroupResponseCompound;
...
use base ("Class::Accessor", "Class::Data::Inheritable", "EzmaxApi::Object::EzsigntemplateformfieldgroupResponse");
...
sub init
{
    ...
    # initialize parent object EzsigntemplateformfieldgroupResponse
    $self->EzmaxApi::Object::EzsigntemplateformfieldgroupResponse::init(%args);
}
...
sub to_hash {
    ...
    # call EzsigntemplateformfieldgroupResponse to_hash and then combine hash
    $_hash = { %$_hash, %$self->EzmaxApi::Object::EzsigntemplateformfieldgroupResponse::to_hash };
...
sub TO_JSON {
    ...
    # combine parent (EzsigntemplateformfieldgroupResponse) TO_JSON
    $_data = { %$_data, %$self->EzmaxApi::Object::EzsigntemplateformfieldgroupResponse::TO_JSON };
...
sub from_hash {
    ...
    # call parent (EzsigntemplateformfieldgroupResponse) from_hash
    $self->EzmaxApi::Object::EzsigntemplateformfieldgroupResponse::from_hash($hash);
...
__PACKAGE__->method_documentation({
    'a_obj_ezsigntemplateformfieldgroupsigner' => {
        datatype => 'ARRAY[EzsigntemplateformfieldgroupsignerResponseCompound]',
    ...
    'a_obj_ezsigntemplateformfield' => {
        datatype => 'ARRAY[EzsigntemplateformfieldResponseCompound]',
