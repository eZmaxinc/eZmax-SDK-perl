...
#
package EzmaxApi::Object::DepartmentGetMembersV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /1/object/department/{pkiDepartmentID}/getMembers',
...
__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'DepartmentGetMembersV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
...
__PACKAGE__->openapi_types( {
    'm_payload' => 'DepartmentGetMembersV1ResponseMPayload',
