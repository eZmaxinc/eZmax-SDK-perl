...
#
package EzmaxApi::Object::DiscussionResponseCompound;
...
__PACKAGE__->class_documentation({description => 'A Discussion Object',
...
__PACKAGE__->method_documentation({
    ...
    'a_obj_discussionmessage' => {
        datatype => 'ARRAY[DiscussionmessageResponseCompound]',
