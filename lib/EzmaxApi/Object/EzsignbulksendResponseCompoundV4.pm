...
#
package EzmaxApi::Object::EzsignbulksendResponseCompoundV4;
...
__PACKAGE__->method_documentation({
    ...
    'e_ezsignbulksend_ezsignformfieldorder' => {
        datatype => 'FieldEEzsignbulksendEzsignformfieldorder',
        base_name => 'eEzsignbulksendEzsignformfieldorder',
        description => '',
        format => '',
        read_only => '',
            },
    ...
    'a_obj_ezsignbulksenddocumentmapping' => {
        datatype => 'ARRAY[EzsignbulksenddocumentmappingResponseCompoundV3]',
    ...
    'a_obj_ezsignbulksendsignermapping' => {
        datatype => 'ARRAY[EzsignbulksendsignermappingResponseV3]',
