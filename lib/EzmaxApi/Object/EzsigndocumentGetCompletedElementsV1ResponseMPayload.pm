...
#
package EzmaxApi::Object::EzsigndocumentGetCompletedElementsV1ResponseMPayload;
...
__PACKAGE__->class_documentation({description => 'Payload for GET /1/object/ezsigndocument/{pkiEzsigndocumentID}/getCompletedElements',
