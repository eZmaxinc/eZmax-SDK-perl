...
#
package EzmaxApi::Object::BrandingCreateObjectV2Response;
...
__PACKAGE__->class_documentation({description => 'Response for POST /2/object/branding',
...
__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'BrandingCreateObjectV2ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
