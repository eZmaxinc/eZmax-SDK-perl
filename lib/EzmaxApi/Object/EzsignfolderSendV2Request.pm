...
#
package EzmaxApi::Object::EzsignfolderSendV2Request;
...
__PACKAGE__->class_documentation({description => 'Request for POST /2/object/ezsignfolder/{pkiEzsignfolderID}/send',
...
__PACKAGE__->method_documentation({
    ...
    'a_obj_ezsignfoldersignerassociationmessage' => {
        datatype => 'ARRAY[CustomEzsignfoldersignerassociationmessageRequest]',
        base_name => 'a_objEzsignfoldersignerassociationmessage',
        description => '',
        format => '',
        read_only => '',
            },
