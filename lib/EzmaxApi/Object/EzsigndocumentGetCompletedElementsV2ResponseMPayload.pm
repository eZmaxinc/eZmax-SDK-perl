...
#
package EzmaxApi::Object::EzsigndocumentGetCompletedElementsV2ResponseMPayload;
...
__PACKAGE__->class_documentation({description => 'Payload for GET /2/object/ezsigndocument/{pkiEzsigndocumentID}/getCompletedElements',
