...
#
package EzmaxApi::Object::EzsignfoldertypeEditObjectV1Request;
...
__PACKAGE__->class_documentation({description => 'Request for PUT /1/object/ezsignfoldertype/{pkiEzsignfoldertypeID}',
...
__PACKAGE__->method_documentation({
    'obj_ezsignfoldertype' => {
        datatype => 'EzsignfoldertypeRequestCompound',
