...
#
package EzmaxApi::Object::CustomEzsignfolderezsigntemplatepublicResponse;
...
__PACKAGE__->class_documentation({description => 'An Ezsignfolder Object in the context of an Ezsigntemplatepublic',
...
__PACKAGE__->method_documentation({
    ...
    'i_ezsignfolder_signaturetotal' => {
        datatype => 'int',
        base_name => 'iEzsignfolderSignaturetotal',
    ...
    'a_obj_ezsignfolderezsigntemplatepublic_signer' => {
        datatype => 'ARRAY[CustomEzsignfolderezsigntemplatepublicSignerResponse]',
        base_name => 'a_objEzsignfolderezsigntemplatepublicSigner',
        description => '',
        format => '',
        read_only => '',
            },
