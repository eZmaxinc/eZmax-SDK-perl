...
#
package EzmaxApi::Object::ActivesessionGenerateFederationTokenV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for POST /1/object/activesession/generateFederationToken',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'ActivesessionGenerateFederationTokenV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
