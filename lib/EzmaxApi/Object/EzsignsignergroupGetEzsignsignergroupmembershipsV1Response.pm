...
#
package EzmaxApi::Object::EzsignsignergroupGetEzsignsignergroupmembershipsV1Response;
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'EzsignsignergroupGetEzsignsignergroupmembershipsV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
