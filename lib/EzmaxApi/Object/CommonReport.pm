...
#
package EzmaxApi::Object::CommonReport;
...
__PACKAGE__->class_documentation({description => 'A Report containing Reportsections ',
                                  class => 'CommonReport',
                                  required => [], # TODO
}                                 );
...
__PACKAGE__->method_documentation({
    'a_obj_reportsection' => {
        datatype => 'ARRAY[CommonReportsection]',
        base_name => 'a_objReportsection',
        description => '',
        format => '',
        read_only => '',
            },
