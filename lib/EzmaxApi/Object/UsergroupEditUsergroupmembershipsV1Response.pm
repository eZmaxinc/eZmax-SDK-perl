...
#
package EzmaxApi::Object::UsergroupEditUsergroupmembershipsV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for PUT /1/object/usergroup/{pkiUsergroupID}/editUsergroupmemberships',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'UsergroupEditUsergroupmembershipsV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
