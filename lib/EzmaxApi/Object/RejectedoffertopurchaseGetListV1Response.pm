...
#
package EzmaxApi::Object::RejectedoffertopurchaseGetListV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /1/object/rejectedoffertopurchase/getList',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'RejectedoffertopurchaseGetListV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
