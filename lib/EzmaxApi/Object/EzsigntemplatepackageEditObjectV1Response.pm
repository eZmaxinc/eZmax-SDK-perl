...
#
package EzmaxApi::Object::EzsigntemplatepackageEditObjectV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for PUT /1/object/ezsigntemplatepackage/{pkiEzsigntemplatepackageID}',
