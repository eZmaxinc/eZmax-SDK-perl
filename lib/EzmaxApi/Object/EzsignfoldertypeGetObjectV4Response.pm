...
#
package EzmaxApi::Object::EzsignfoldertypeGetObjectV4Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /4/object/ezsignfoldertype/{pkiEzsignfoldertypeID}',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'EzsignfoldertypeGetObjectV4ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
