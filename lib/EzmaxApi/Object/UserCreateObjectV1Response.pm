...
#
package EzmaxApi::Object::UserCreateObjectV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for POST /1/object/user',
...
__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'UserCreateObjectV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
