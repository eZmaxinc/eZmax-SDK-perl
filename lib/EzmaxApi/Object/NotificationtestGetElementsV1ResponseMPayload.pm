...
#
package EzmaxApi::Object::NotificationtestGetElementsV1ResponseMPayload;
...
__PACKAGE__->class_documentation({description => 'Payload for GET /1/object/notificationtest/{pkiNotificationtestID}/getElements',
