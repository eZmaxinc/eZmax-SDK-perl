...
#
package EzmaxApi::Object::BillingentityinternalCreateObjectV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for POST /1/object/billingentityinternal',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'BillingentityinternalCreateObjectV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
