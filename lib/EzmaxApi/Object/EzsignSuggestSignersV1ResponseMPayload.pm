...
#
package EzmaxApi::Object::EzsignSuggestSignersV1ResponseMPayload;
...
__PACKAGE__->class_documentation({description => 'Payload for GET /1/module/ezsign/suggestSigners',
...
__PACKAGE__->method_documentation({
    ...
    'a_obj_user_team' => {
        datatype => 'ARRAY[CustomUserResponse]',
        base_name => 'a_objUserTeam',
        description => '',
        format => '',
        read_only => '',
            },
