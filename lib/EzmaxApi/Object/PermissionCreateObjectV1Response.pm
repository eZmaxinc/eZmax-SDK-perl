...
#
package EzmaxApi::Object::PermissionCreateObjectV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for POST /1/object/permission',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'PermissionCreateObjectV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
