...
#
package EzmaxApi::Object::PaymentgatewayGetObjectV2Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /2/object/paymentgateway/{pkiPaymentgatewayID}',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'PaymentgatewayGetObjectV2ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
