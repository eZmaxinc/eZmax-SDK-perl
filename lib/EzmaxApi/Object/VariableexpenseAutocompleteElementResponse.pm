...
#
package EzmaxApi::Object::VariableexpenseAutocompleteElementResponse;
...
__PACKAGE__->class_documentation({description => 'A Variableexpense AutocompleteElement Response',
