...
#
package EzmaxApi::Object::TaxassignmentGetAutocompleteV2Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /2/object/taxassignment/getAutocomplete',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'TaxassignmentGetAutocompleteV2ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
