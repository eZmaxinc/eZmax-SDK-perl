...
#
package EzmaxApi::Object::SignatureCreateObjectV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for POST /1/object/signature',
...
__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'SignatureCreateObjectV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
