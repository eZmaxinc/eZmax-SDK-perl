...
#
package EzmaxApi::Object::EzsignfoldersignerassociationResponseCompoundUser;
...
__PACKAGE__->class_documentation({description => 'A Ezsignfoldersignerassociation-&gt;User Object and children to create a complete structure',
