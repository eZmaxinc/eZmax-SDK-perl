...
#
package EzmaxApi::Object::EzsignsignergroupGetObjectV2Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /2/object/ezsignsignergroup/{pkiEzsignsignergroupID}',
...
__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'EzsignsignergroupGetObjectV2ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
