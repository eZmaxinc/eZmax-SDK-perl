...
#
package EzmaxApi::Object::PhonestaticResponseCompound;
...
__PACKAGE__->class_documentation({description => 'A Phonestatic Object and children to create a complete structure',
...
__PACKAGE__->method_documentation({
    ...
    's_phonestatic_e164' => {
        datatype => 'string',
        base_name => 'sPhonestaticE164',
        description => 'A phone number in E.164 Format',
        format => '',
        read_only => '',
            },
    's_phonestatic_extension' => {
        datatype => 'string',
        base_name => 'sPhonestaticExtension',
