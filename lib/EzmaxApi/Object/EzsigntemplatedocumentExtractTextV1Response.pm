...
#
package EzmaxApi::Object::EzsigntemplatedocumentExtractTextV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for POST /1/object/ezsigntemplatedocument/{pkiEzsigntemplatedocumentID}/extractText',
...
__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'EzsigntemplatedocumentExtractTextV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
