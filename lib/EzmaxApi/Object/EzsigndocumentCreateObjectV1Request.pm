...
#
package EzmaxApi::Object::EzsigndocumentCreateObjectV1Request;
...
__PACKAGE__->class_documentation({description => 'Request for the /1/object/ezsigndocument/createObject API Request',
