...
#
package EzmaxApi::Object::AgentGetListV1ResponseMPayload;
...
__PACKAGE__->class_documentation({description => 'Payload for GET /1/object/agent/getList',
...
__PACKAGE__->method_documentation({
    ...
    'a_obj_agent' => {
        datatype => 'ARRAY[AgentListElement]',
