...
#
package EzmaxApi::Object::EzsigntemplatepackagesignermembershipGetObjectV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /1/object/ezsigntemplatepackagesignermembership/{pkiEzsigntemplatepackagesignermembershipID}',
                                  class => 'EzsigntemplatepackagesignermembershipGetObjectV1Response',
                                  required => [], # TODO
}                                 );

__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'EzsigntemplatepackagesignermembershipGetObjectV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
...
__PACKAGE__->openapi_types( {
    'm_payload' => 'EzsigntemplatepackagesignermembershipGetObjectV1ResponseMPayload',
