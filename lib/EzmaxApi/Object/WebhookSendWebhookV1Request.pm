...
#
package EzmaxApi::Object::WebhookSendWebhookV1Request;
...
__PACKAGE__->class_documentation({description => 'Request for POST /1/object/webhook/sendWebhook',
...
__PACKAGE__->method_documentation({
    ...
    'e_webhook_ezsignevent' => {
        datatype => 'CustomEWebhookEzsignevent',
