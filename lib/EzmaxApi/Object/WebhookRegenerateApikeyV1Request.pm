...
#
package EzmaxApi::Object::WebhookRegenerateApikeyV1Request;
...
__PACKAGE__->class_documentation({description => 'Request for POST /1/object/webhook/{pkiWebhookID}/regenerateApikey',
