...
#
package EzmaxApi::Object::WebsocketResponseGetWebsocketIDV1;
...
__PACKAGE__->class_documentation({description => 'Response for Websocket GetWebsocketID V1',
...
__PACKAGE__->method_documentation({
    'e_websocket_messagetype' => {
        datatype => 'string',
        base_name => 'eWebsocketMessagetype',
        description => 'The Type of message',
        format => '',
        read_only => '',
            },
    'm_payload' => {
        datatype => 'WebsocketResponseGetWebsocketIDV1MPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
