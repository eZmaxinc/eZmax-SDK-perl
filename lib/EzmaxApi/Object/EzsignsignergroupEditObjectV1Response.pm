...
#
package EzmaxApi::Object::EzsignsignergroupEditObjectV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for PUT /1/object/ezsignsignergroup/{pkiEzsignsignergroupID}',
