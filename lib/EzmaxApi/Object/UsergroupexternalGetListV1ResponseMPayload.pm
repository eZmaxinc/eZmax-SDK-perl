...
#
package EzmaxApi::Object::UsergroupexternalGetListV1ResponseMPayload;
...
__PACKAGE__->class_documentation({description => 'Payload for GET /1/object/usergroupexternal/getList',
...
__PACKAGE__->method_documentation({
    'a_obj_usergroupexternal' => {
        datatype => 'ARRAY[UsergroupexternalListElement]',
