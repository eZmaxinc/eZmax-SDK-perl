...
#
package EzmaxApi::Object::ScimServiceProviderConfig;
...
__PACKAGE__->method_documentation({
    'authentication_schemes' => {
        datatype => 'ARRAY[ScimAuthenticationScheme]',
        base_name => 'authenticationSchemes',
        description => 'A multi-valued complex type that specifies supported authentication scheme properties.',
        format => '',
        read_only => '',
            },
    'bulk' => {
        datatype => 'ScimServiceProviderConfigBulk',
        base_name => 'bulk',
        description => '',
        format => '',
        read_only => '',
    ...
    'filter' => {
        datatype => 'ScimServiceProviderConfigFilter',
        base_name => 'filter',
        description => '',
        format => '',
        read_only => '',
