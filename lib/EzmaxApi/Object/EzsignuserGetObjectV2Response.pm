...
#
package EzmaxApi::Object::EzsignuserGetObjectV2Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /2/object/ezsignuser/{pkiEzsignuserID}',
...
__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'EzsignuserGetObjectV2ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
