...
#
package EzmaxApi::Object::EzsignfoldertypeEditObjectV4Response;
...
__PACKAGE__->class_documentation({description => 'Response for PUT /4/object/ezsignfoldertype/{pkiEzsignfoldertypeID}',
                                  class => 'EzsignfoldertypeEditObjectV4Response',
                                  required => [], # TODO
}                                 );
