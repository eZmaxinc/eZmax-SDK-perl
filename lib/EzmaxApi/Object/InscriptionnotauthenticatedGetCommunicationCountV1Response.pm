...
#
package EzmaxApi::Object::InscriptionnotauthenticatedGetCommunicationCountV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /1/object/inscriptionnotauthenticated/{pkiInscriptionnotauthenticatedID}/getCommunicationCount',
...
__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'InscriptionnotauthenticatedGetCommunicationCountV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
