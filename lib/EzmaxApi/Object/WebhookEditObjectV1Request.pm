...
#
package EzmaxApi::Object::WebhookEditObjectV1Request;
...
__PACKAGE__->class_documentation({description => 'Request for PUT /1/object/webhook/{pkiWebhookID}',
...
__PACKAGE__->method_documentation({
    'obj_webhook' => {
        datatype => 'WebhookRequestCompound',
