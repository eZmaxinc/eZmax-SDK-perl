...
#
package EzmaxApi::Object::VariableexpenseDeleteObjectV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for DELETE /1/object/variableexpense/{pkiVariableexpenseID}',
                                  class => 'VariableexpenseDeleteObjectV1Response',
                                  required => [], # TODO
}                                 );
