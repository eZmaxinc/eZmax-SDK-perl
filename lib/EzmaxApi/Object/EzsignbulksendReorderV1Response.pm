...
#
package EzmaxApi::Object::EzsignbulksendReorderV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for POST /1/object/ezsignbulksend/{pkiEzsignbulksendID}/reorder',
