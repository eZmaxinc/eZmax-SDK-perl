...
#
package EzmaxApi::Object::MultilingualEzdoctemplatedocumentName;
...
__PACKAGE__->class_documentation({description => 'The name1 of the Ezdoctemplatedocument',
...
__PACKAGE__->method_documentation({
    's_ezdoctemplatedocument_name1' => {
        datatype => 'string',
        base_name => 'sEzdoctemplatedocumentName1',
        description => 'The name1 of the Ezdoctemplatedocument',
        format => '',
        read_only => '',
            },
    's_ezdoctemplatedocument_name2' => {
        datatype => 'string',
        base_name => 'sEzdoctemplatedocumentName2',
        description => 'The name2 of the Ezdoctemplatedocument',
        format => '',
        read_only => '',
            },
});
