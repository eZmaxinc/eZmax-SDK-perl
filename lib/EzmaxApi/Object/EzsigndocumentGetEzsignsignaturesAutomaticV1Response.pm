...
#
package EzmaxApi::Object::EzsigndocumentGetEzsignsignaturesAutomaticV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /1/object/ezsigndocument/{pkiEzsigndocumentID}/getEzsignsignaturesAutomatic',
...
__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'EzsigndocumentGetEzsignsignaturesAutomaticV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
