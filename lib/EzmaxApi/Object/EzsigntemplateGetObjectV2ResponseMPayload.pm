...
#
package EzmaxApi::Object::EzsigntemplateGetObjectV2ResponseMPayload;
...
__PACKAGE__->class_documentation({description => 'Payload for GET /2/object/ezsigntemplate/{pkiEzsigntemplateID}',
