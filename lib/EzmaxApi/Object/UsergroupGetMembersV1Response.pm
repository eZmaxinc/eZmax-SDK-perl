...
#
package EzmaxApi::Object::UsergroupGetMembersV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /1/object/usergroup/{pkiUsergroupID}/getMembers',
                                  class => 'UsergroupGetMembersV1Response',
                                  required => [], # TODO
}                                 );

__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'UsergroupGetMembersV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
...
__PACKAGE__->openapi_types( {
    'm_payload' => 'UsergroupGetMembersV1ResponseMPayload',
