...
#
package EzmaxApi::Object::EzsigndocumentApplyEzsigntemplateglobalV1Request;
...
__PACKAGE__->class_documentation({description => 'Request for POST /1/object/ezsigndocument/{pkiEzsigndocumentID}/applyEzsigntemplateglobal',
