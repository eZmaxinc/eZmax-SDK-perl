...
#
package EzmaxApi::Object::WebhookRealestateInscriptionnotauthenticatedCreated;
...
__PACKAGE__->class_documentation({description => 'This is a webhook for a RealestateInscriptionnotauthenticatedCreated event',
                                  class => 'WebhookRealestateInscriptionnotauthenticatedCreated',
                                  required => [], # TODO
}                                 );
