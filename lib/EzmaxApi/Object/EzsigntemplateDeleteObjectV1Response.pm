...
#
package EzmaxApi::Object::EzsigntemplateDeleteObjectV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for DELETE /1/object/ezsigntemplate/{pkiEzsigntemplateID}',
