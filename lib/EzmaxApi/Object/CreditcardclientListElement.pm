...
#
package EzmaxApi::Object::CreditcardclientListElement;
...
__PACKAGE__->class_documentation({description => 'A Creditcardclient List Element',
...
__PACKAGE__->method_documentation({
    ...
    'b_creditcardclient_legacy' => {
        datatype => 'boolean',
        base_name => 'bCreditcardclientLegacy',
        description => 'Whether the Creditcardclient is legacy or not',
        format => '',
        read_only => '',
            },
