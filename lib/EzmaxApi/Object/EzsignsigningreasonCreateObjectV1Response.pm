...
#
package EzmaxApi::Object::EzsignsigningreasonCreateObjectV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for POST /1/object/ezsignsigningreason',
...
__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'EzsignsigningreasonCreateObjectV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
