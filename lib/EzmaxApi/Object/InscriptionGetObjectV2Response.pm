...
#
package EzmaxApi::Object::InscriptionGetObjectV2Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /2/object/inscription/{pkiInscriptionID}',
                                  class => 'InscriptionGetObjectV2Response',
                                  required => [], # TODO
}                                 );
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'InscriptionGetObjectV2ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
