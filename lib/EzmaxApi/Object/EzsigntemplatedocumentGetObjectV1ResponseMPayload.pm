...
#
package EzmaxApi::Object::EzsigntemplatedocumentGetObjectV1ResponseMPayload;
...
__PACKAGE__->class_documentation({description => 'Payload for GET /1/object/ezsigntemplatedocument/{pkiEzsigntemplatedocumentID}',
