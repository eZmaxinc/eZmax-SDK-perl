...
#
package EzmaxApi::Object::SsprResetPasswordV1Request;
...
__PACKAGE__->class_documentation({description => 'Request for the /1/module/sspr/resetPassword API Request',
...
__PACKAGE__->method_documentation({
    ...
    'e_user_type_sspr' => {
        datatype => 'FieldEUserTypeSSPR',
        base_name => 'eUserTypeSSPR',
        description => '',
        format => '',
        read_only => '',
            },
