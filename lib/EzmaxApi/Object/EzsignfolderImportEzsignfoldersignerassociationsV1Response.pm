...
#
package EzmaxApi::Object::EzsignfolderImportEzsignfoldersignerassociationsV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for POST /1/object/ezsignfolder/{pkiEzsignfolder}/importEzsignfoldersignerassociations',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'EzsignfolderImportEzsignfoldersignerassociationsV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
