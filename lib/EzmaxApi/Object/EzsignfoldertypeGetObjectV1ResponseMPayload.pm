...
#
package EzmaxApi::Object::EzsignfoldertypeGetObjectV1ResponseMPayload;
...
__PACKAGE__->class_documentation({description => 'Payload for GET /1/object/ezsignfoldertype/{pkiEzsignfoldertypeID}',
