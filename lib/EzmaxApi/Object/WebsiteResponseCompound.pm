...
#
package EzmaxApi::Object::WebsiteResponseCompound;
...
__PACKAGE__->class_documentation({description => 'A Website Object and children to create a complete structure',
...
__PACKAGE__->method_documentation({
    ...
    'fki_websitetype_id' => {
        ...
        description => 'The unique ID of the Websitetype.  Valid values:  |Value|Description| |-|-| |1|Website| |2|Twitter| |3|Facebook| |4|Survey|',
        format => '',
        read_only => '',
            },
    's_website_address' => {
        datatype => 'string',
        base_name => 'sWebsiteAddress',
