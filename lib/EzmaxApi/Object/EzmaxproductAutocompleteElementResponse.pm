...
#
package EzmaxApi::Object::EzmaxproductAutocompleteElementResponse;
...
__PACKAGE__->class_documentation({description => 'A Ezmaxproduct AutocompleteElement Response',
...
__PACKAGE__->method_documentation({
    ...
    'b_ezmaxproduct_isactive' => {
        datatype => 'boolean',
        base_name => 'bEzmaxproductIsactive',
