...
#
package EzmaxApi::Object::CustomEzsignformfielderrorResponse;
...
__PACKAGE__->class_documentation({description => 'A Custom Ezsignformfield Object to contain an error list',
...
__PACKAGE__->method_documentation({
    ...
    'a_obj_ezsignformfielderrortest' => {
        datatype => 'ARRAY[CustomEzsignformfielderrortestResponse]',
        base_name => 'a_objEzsignformfielderrortest',
        description => '',
        format => '',
        read_only => '',
            },
