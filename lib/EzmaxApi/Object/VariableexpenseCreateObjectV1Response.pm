...
#
package EzmaxApi::Object::VariableexpenseCreateObjectV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for POST /1/object/variableexpense',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'VariableexpenseCreateObjectV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
