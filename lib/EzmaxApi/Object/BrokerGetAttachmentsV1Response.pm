...
#
package EzmaxApi::Object::BrokerGetAttachmentsV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /1/object/broker/{pkiBrokerID}/getAttachments',
                                  class => 'BrokerGetAttachmentsV1Response',
                                  required => [], # TODO
}                                 );
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'BrokerGetAttachmentsV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
