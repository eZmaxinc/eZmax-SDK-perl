...
#
package EzmaxApi::Object::CustomAttachmentImportIntoEDMRequest;
...
__PACKAGE__->class_documentation({description => 'A AttachmentImportIntoEDM object',
...
__PACKAGE__->method_documentation({
    ...
    's_attachment_base64' => {
        datatype => 'string',
        base_name => 'sAttachmentBase64',
        description => 'The Base64 encoded binary content of the attachment.',
        format => '',
        read_only => '',
            },
    's_attachment_name' => {
    ...
    'b_attachment_forceoverwrite' => {
        datatype => 'boolean',
        base_name => 'bAttachmentForceoverwrite',
        description => 'Whether we force an overwrite of an existing file',
        format => '',
        read_only => '',
            },
    'b_attachment_forcerestore' => {
        datatype => 'boolean',
        base_name => 'bAttachmentForcerestore',
        description => 'Whether we force a restore of a deleted file',
        format => '',
        read_only => '',
            },
});
