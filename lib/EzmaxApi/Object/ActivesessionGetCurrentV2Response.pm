...
#
package EzmaxApi::Object::ActivesessionGetCurrentV2Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /2/object/activesession/getCurrent',
...
__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'ActivesessionGetCurrentV2ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
