...
#
package EzmaxApi::Object::DiscussionmessageCreateObjectV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for POST /1/object/discussionmessage',
...
__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'DiscussionmessageCreateObjectV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
