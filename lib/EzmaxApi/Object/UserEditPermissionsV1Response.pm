...
#
package EzmaxApi::Object::UserEditPermissionsV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for PUT /1/object/user/{pkiUserID}/editPermissions',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'UserEditPermissionsV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
