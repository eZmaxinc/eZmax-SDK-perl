...
#
package EzmaxApi::Object::CustomerGetObjectV2Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /2/object/customer/{pkiCustomerID}',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'CustomerGetObjectV2ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
