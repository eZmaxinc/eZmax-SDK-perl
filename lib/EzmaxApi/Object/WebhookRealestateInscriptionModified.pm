...
#
package EzmaxApi::Object::WebhookRealestateInscriptionModified;
...
__PACKAGE__->class_documentation({description => 'This is a webhook for a RealestateInscriptionModified event',
