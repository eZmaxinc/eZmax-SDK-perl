...
#
package EzmaxApi::Object::EzsigndocumentDeleteObjectV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for the /1/object/ezsigndocument/deleteObject API Request',
