...
#
package EzmaxApi::Object::RejectedoffertopurchaseGetCommunicationsendersV1Response;
...
__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'RejectedoffertopurchaseGetCommunicationsendersV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
