...
#
package EzmaxApi::Object::EzsigndocumentGetActionableElementsV3ResponseMPayload;
...
__PACKAGE__->class_documentation({description => 'Payload for GET /3/object/ezsigndocument/{pkiEzsigndocumentID}/getActionableElements',
