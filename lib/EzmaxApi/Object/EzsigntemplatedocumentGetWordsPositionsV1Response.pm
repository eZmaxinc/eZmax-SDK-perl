...
#
package EzmaxApi::Object::EzsigntemplatedocumentGetWordsPositionsV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for POST /1/object/ezsigntemplatedocument/{pkiEzsigntemplatedocumentID}/getWordsPositions',
