...
#
package EzmaxApi::Object::BrokerImportIntoEDMV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for POST /1/object/broker/{pkiBrokerID}/importIntoEDM',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'BrokerImportIntoEDMV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
