...
#
package EzmaxApi::Object::EzsignsignaturepaymentdetailResponseCompound;
...
__PACKAGE__->class_documentation({description => 'An Ezsignsignaturepaymentdetail Object and children to create a complete structure',
...
__PACKAGE__->method_documentation({
    'pki_ezsignsignaturepaymentdetail_id' => {
        datatype => 'int',
        base_name => 'pkiEzsignsignaturepaymentdetailID',
    ...
    't_ezsignsignaturepaymentdetail_description' => {
        datatype => 'string',
        base_name => 'tEzsignsignaturepaymentdetailDescription',
    ...
    'd_ezsignsignaturepaymentdetail_amount' => {
        datatype => 'string',
        base_name => 'dEzsignsignaturepaymentdetailAmount',
        description => 'The amount of the for the Ezsignsignaturepaymentdetail',
        format => '',
        read_only => '',
            },
    'e_ezsignsignaturepaymentdetail_taxable' => {
        datatype => 'FieldEEzsignsignaturepaymentdetailTaxable',
        base_name => 'eEzsignsignaturepaymentdetailTaxable',
        description => '',
        format => '',
        read_only => '',
            },
...
__PACKAGE__->openapi_types( {
    'pki_ezsignsignaturepaymentdetail_id' => 'int',
