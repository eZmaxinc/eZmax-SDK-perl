...
#
package EzmaxApi::Object::EzsigndocumentApplyEzsigntemplateV2Response;
...
__PACKAGE__->class_documentation({description => 'Response for the /2/object/ezsigndocument/{pkiEzsigndocument}/applyEzsigntemplate API Request',
