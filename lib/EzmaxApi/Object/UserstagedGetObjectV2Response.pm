...
#
package EzmaxApi::Object::UserstagedGetObjectV2Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /2/object/userstaged/{pkiUserstagedID}',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'UserstagedGetObjectV2ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
