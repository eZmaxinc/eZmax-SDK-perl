...
#
package EzmaxApi::Object::EzsignfoldersignerassociationCreateEmbeddedUrlV1Request;
...
__PACKAGE__->class_documentation({description => 'Request for POST /1/object/ezsignfoldersignerassociation/createEmbeddedUrl',
...
__PACKAGE__->method_documentation({
    ...
    's_iframedomain' => {
        datatype => 'string',
        base_name => 'sIframedomain',
        description => 'Domain protection for the iFrame',
        format => '',
        read_only => '',
            },
    'b_is_iframe' => {
