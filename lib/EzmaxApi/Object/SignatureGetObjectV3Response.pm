...
#
package EzmaxApi::Object::SignatureGetObjectV3Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /3/object/signature/{pkiSignatureID}',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'SignatureGetObjectV3ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
