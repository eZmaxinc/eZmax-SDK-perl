...
#
package EzmaxApi::Object::InscriptionnotauthenticatedFillInscriptionnotauthenticatedconditionV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for POST /1/object/inscriptionnotauthenticated/{pkiInscriptionnotauthenticatedID}/fillInscriptionnotauthenticatedcondition',
                                  class => 'InscriptionnotauthenticatedFillInscriptionnotauthenticatedconditionV1Response',
                                  required => [], # TODO
}                                 );
