...
#
package EzmaxApi::Object::EzsignsignergroupDeleteObjectV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for DELETE /1/object/ezsignsignergroup/{pkiEzsignsignergroupID}',
