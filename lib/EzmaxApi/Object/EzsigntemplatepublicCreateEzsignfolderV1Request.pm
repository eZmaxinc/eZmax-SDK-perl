...
#
package EzmaxApi::Object::EzsigntemplatepublicCreateEzsignfolderV1Request;
...
__PACKAGE__->class_documentation({description => 'Request for POST /1/object/ezsigntemplatepublic/createEzsignfolder',
...
__PACKAGE__->method_documentation({
    ...
    'a_s_ezsigntemplatesigner_description' => {
        ...
        base_name => 'a_sEzsigntemplatesignerDescription',
        description => '',
        format => '',
        read_only => '',
            },
    'a_obj_ezsignsigner' => {
        datatype => 'ARRAY[EzsignsignerRequestCompound]',
        base_name => 'a_objEzsignsigner',
        description => '',
        format => '',
        read_only => '',
            },
