...
#
package EzmaxApi::Object::GlobalEzmaxclientVersionV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /1/ezmaxclient/{pksEzmaxclientOs}/version',
