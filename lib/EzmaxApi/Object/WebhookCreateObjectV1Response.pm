...
#
package EzmaxApi::Object::WebhookCreateObjectV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for POST /1/object/webhook',
...
__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'WebhookCreateObjectV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
