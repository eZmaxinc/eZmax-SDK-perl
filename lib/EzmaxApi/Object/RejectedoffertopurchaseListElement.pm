...
#
package EzmaxApi::Object::RejectedoffertopurchaseListElement;
...
__PACKAGE__->class_documentation({description => 'A Rejectedoffertopurchase List Element',
...
__PACKAGE__->method_documentation({
    'pki_rejectedoffertopurchase_id' => {
        datatype => 'int',
        base_name => 'pkiRejectedoffertopurchaseID',
    ...
    's_rejectedoffertopurchase_number' => {
        datatype => 'string',
        base_name => 'sRejectedoffertopurchaseNumber',
        description => 'The number of the Rejectedoffertopurchase',
        format => '',
        read_only => '',
            },
    'dt_rejectedoffertopurchase_date' => {
        datatype => 'string',
        base_name => 'dtRejectedoffertopurchaseDate',
        description => 'The date of the Rejectedoffertopurchase',
        format => '',
        read_only => '',
            },
    'b_rejectedoffertopurchase_isactive' => {
        datatype => 'boolean',
        base_name => 'bRejectedoffertopurchaseIsactive',
        description => 'Whether the rejectedoffertopurchase is active or not',
        format => '',
        read_only => '',
            },
    'dt_created_date' => {
    ...
    'b_rejectedoffertopurchase_linkedtoinscription' => {
        datatype => 'boolean',
        base_name => 'bRejectedoffertopurchaseLinkedtoinscription',
        description => 'Indicate if the Rejectedoffertopurchase is linked to an inscription',
        format => '',
        read_only => '',
            },
});
