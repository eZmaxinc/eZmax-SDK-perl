...
use base ("Class::Accessor", "Class::Data::Inheritable", "EzmaxApi::Object::EzsignfoldertypeRequestV3");
...
sub init
{
    ...
    # initialize parent object EzsignfoldertypeRequestV3
    $self->EzmaxApi::Object::EzsignfoldertypeRequestV3::init(%args);
}
...
sub to_hash {
    ...
    # call EzsignfoldertypeRequestV3 to_hash and then combine hash
    $_hash = { %$_hash, %$self->EzmaxApi::Object::EzsignfoldertypeRequestV3::to_hash };
...
sub TO_JSON {
    ...
    # combine parent (EzsignfoldertypeRequestV3) TO_JSON
    $_data = { %$_data, %$self->EzmaxApi::Object::EzsignfoldertypeRequestV3::TO_JSON };
...
sub from_hash {
    ...
    # call parent (EzsignfoldertypeRequestV3) from_hash
    $self->EzmaxApi::Object::EzsignfoldertypeRequestV3::from_hash($hash);
