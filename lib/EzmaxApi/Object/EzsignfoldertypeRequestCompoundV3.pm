...
#
package EzmaxApi::Object::EzsignfoldertypeRequestCompoundV3;
...
__PACKAGE__->class_documentation({description => 'A Ezsignfoldertype Object and children',
...
__PACKAGE__->method_documentation({
    ...
    'fki_pdfalevel_id_convert' => {
        datatype => 'int',
        base_name => 'fkiPdfalevelIDConvert',
        description => 'The unique ID of the Pdfalevel',
        format => '',
        read_only => '',
            },
    'a_fki_pdfalevel_id' => {
        datatype => 'ARRAY[int]',
        base_name => 'a_fkiPdfalevelID',
        description => '',
        format => '',
        read_only => '',
            },
    'a_fki_userlogintype_id' => {
        datatype => 'ARRAY[int]',
        base_name => 'a_fkiUserlogintypeID',
        description => '',
        format => '',
        read_only => '',
            },
    ...
    'a_fki_usergroup_id_restricted' => {
        datatype => 'ARRAY[int]',
        base_name => 'a_fkiUsergroupIDRestricted',
        description => '',
        format => '',
        read_only => '',
            },
    'a_fki_usergroup_id_template' => {
        datatype => 'ARRAY[int]',
        base_name => 'a_fkiUsergroupIDTemplate',
        description => '',
        format => '',
        read_only => '',
            },
    ...
    'e_ezsignfoldertype_documentmerge' => {
        datatype => 'FieldEEzsignfoldertypeDocumentmerge',
        base_name => 'eEzsignfoldertypeDocumentmerge',
        description => '',
        format => '',
        read_only => '',
            },
    ...
    'e_ezsignfoldertype_pdfarequirement' => {
        datatype => 'FieldEEzsignfoldertypePdfarequirement',
        base_name => 'eEzsignfoldertypePdfarequirement',
        description => '',
        format => '',
        read_only => '',
            },
    'e_ezsignfoldertype_pdfanoncompliantaction' => {
        datatype => 'FieldEEzsignfoldertypePdfanoncompliantaction',
        base_name => 'eEzsignfoldertypePdfanoncompliantaction',
        description => '',
        format => '',
        read_only => '',
            },
    ...
    'i_ezsignfoldertype_sendreminderotherdays' => {
        datatype => 'int',
        base_name => 'iEzsignfoldertypeSendreminderotherdays',
    ...
    'b_ezsignfoldertype_prematurelyendautomatically' => {
        datatype => 'boolean',
        base_name => 'bEzsignfoldertypePrematurelyendautomatically',
        description => 'Wheter if document will be ended prematurely after Ezsignfolder expires.',
        format => '',
        read_only => '',
            },
    'i_ezsignfoldertype_prematurelyendautomaticallydays' => {
        datatype => 'int',
        base_name => 'iEzsignfoldertypePrematurelyendautomaticallydays',
        description => 'Number of days between Ezsignfolder expiration and automatic prematurely end of Ezsigndocuments.',
        format => '',
        read_only => '',
            },
    ...
    'b_ezsignfoldertype_logrecipientinproof' => {
        datatype => 'boolean',
        base_name => 'bEzsignfoldertypeLogrecipientinproof',
        description => 'Whether we log recipient of signed document in proof',
        format => '',
        read_only => '',
            },
    ...
    'b_ezsignfoldertype_sendsignatureattachmentezsignsigner' => {
        datatype => 'boolean',
        base_name => 'bEzsignfoldertypeSendsignatureattachmentezsignsigner',
        description => 'Whether we send the attachments contained in the Ezsignsignatures in the email to Ezsignsigner',
        format => '',
        read_only => '',
            },
    'b_ezsignfoldertype_sendsignatureattachment' => {
        datatype => 'boolean',
        base_name => 'bEzsignfoldertypeSendsignatureattachment',
        description => 'Whether we send the attachments contained in the Ezsignsignatures in the email to external recipient',
        format => '',
        read_only => '',
            },
    ...
    'b_ezsignfoldertype_sendsignatureattachmentuser' => {
        datatype => 'boolean',
        base_name => 'bEzsignfoldertypeSendsignatureattachmentuser',
        description => 'Whether we send the attachments contained in the Ezsignsignatures in the email to User',
        format => '',
        read_only => '',
            },
    ...
    'b_ezsignfoldertype_allowdownloadsignatureattachmentezsignsigner' => {
        datatype => 'boolean',
        base_name => 'bEzsignfoldertypeAllowdownloadsignatureattachmentezsignsigner',
        description => 'Whether we allow the attachments in the Ezsignsignatures to be downloaded by an Ezsignsigner',
        format => '',
        read_only => '',
            },
    ...
    'b_ezsignfoldertype_sendsignatureattachmentreceivealldocument' => {
        datatype => 'boolean',
        base_name => 'bEzsignfoldertypeSendsignatureattachmentreceivealldocument',
        description => 'Whether we send the attachments contained in the Ezsignsignatures to user and Ezsignsigner who receive all documents.',
        format => '',
        read_only => '',
            },
    ...
    'e_ezsignfoldertype_signeraccess' => {
        datatype => 'FieldEEzsignfoldertypeSigneraccess',
        base_name => 'eEzsignfoldertypeSigneraccess',
        description => '',
        format => '',
        read_only => '',
            },
...
__PACKAGE__->openapi_types( {
    ...
    'a_fki_pdfalevel_id' => 'ARRAY[int]',
    'a_fki_userlogintype_id' => 'ARRAY[int]',
    'a_fki_usergroup_id_all' => 'ARRAY[int]',
    'a_fki_usergroup_id_restricted' => 'ARRAY[int]',
    'a_fki_usergroup_id_template' => 'ARRAY[int]',
    ...
    'i_ezsignfoldertype_sendreminderfirstdays' => 'int',
    'i_ezsignfoldertype_sendreminderotherdays' => 'int',
    ...
    'i_ezsignfoldertype_prematurelyendautomaticallydays' => 'int',
