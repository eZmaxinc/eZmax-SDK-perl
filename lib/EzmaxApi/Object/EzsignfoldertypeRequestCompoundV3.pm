...
__PACKAGE__->method_documentation({
    ...
    'b_ezsignfoldertype_sendattachmentreceivecopy' => {
        datatype => 'boolean',
        base_name => 'bEzsignfoldertypeSendattachmentreceivecopy',
        description => 'Whether we send the Ezsigndocument in the email to Ezsignsigner or User when bEzsignfoldersignerassociationReceivecopy &#x3D; 1',
        format => '',
        read_only => '',
            },
