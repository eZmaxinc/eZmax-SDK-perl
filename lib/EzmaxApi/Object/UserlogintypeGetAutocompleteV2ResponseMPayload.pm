...
#
package EzmaxApi::Object::UserlogintypeGetAutocompleteV2ResponseMPayload;
...
__PACKAGE__->class_documentation({description => 'Payload for POST /2/object/userlogintype/getAutocomplete',
...
__PACKAGE__->method_documentation({
    'a_obj_userlogintype' => {
        datatype => 'ARRAY[UserlogintypeAutocompleteElementResponse]',
