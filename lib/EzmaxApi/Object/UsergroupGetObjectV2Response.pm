...
#
package EzmaxApi::Object::UsergroupGetObjectV2Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /2/object/usergroup/{pkiUsergroupID}',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'UsergroupGetObjectV2ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
