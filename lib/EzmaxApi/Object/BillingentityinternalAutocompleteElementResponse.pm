...
#
package EzmaxApi::Object::BillingentityinternalAutocompleteElementResponse;
...
__PACKAGE__->class_documentation({description => 'A Billingentityinternal AutocompleteElement Response',
...
__PACKAGE__->method_documentation({
    ...
    'b_billingentityinternal_isactive' => {
        datatype => 'boolean',
        base_name => 'bBillingentityinternalIsactive',
