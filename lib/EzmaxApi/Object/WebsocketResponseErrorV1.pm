...
#
package EzmaxApi::Object::WebsocketResponseErrorV1;
...
__PACKAGE__->class_documentation({description => 'Response for Websocket Error V1',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'WebsocketResponseErrorV1MPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
