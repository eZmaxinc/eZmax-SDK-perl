...
#
package EzmaxApi::Object::CustomAutocompleteElementDisabledResponse;
...
__PACKAGE__->class_documentation({description => 'Generic AutocompleteElement Response with a bDisabled Flag',
