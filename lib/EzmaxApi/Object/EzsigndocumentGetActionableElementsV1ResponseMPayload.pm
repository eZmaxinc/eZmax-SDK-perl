...
#
package EzmaxApi::Object::EzsigndocumentGetActionableElementsV1ResponseMPayload;
...
__PACKAGE__->class_documentation({description => 'Payload for GET /1/object/ezsigndocument/{pkiEzsigndocumentID}/getActionableElements',
