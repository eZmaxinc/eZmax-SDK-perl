...
#
package EzmaxApi::Object::EzsignfoldertypeGetObjectV2Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /2/object/ezsignfoldertype/{pkiEzsignfoldertypeID}',
...
__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'EzsignfoldertypeGetObjectV2ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
