...
#
package EzmaxApi::Object::EzsignfolderGetActionableElementsV3ResponseMPayload;
...
__PACKAGE__->class_documentation({description => 'Payload for GET /3/object/ezsignfolder/{pkiEzsignfolderID}/getActionableElements',
