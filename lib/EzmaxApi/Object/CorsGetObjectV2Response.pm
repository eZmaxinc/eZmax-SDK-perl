...
#
package EzmaxApi::Object::CorsGetObjectV2Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /2/object/cors/{pkiCorsID}',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'CorsGetObjectV2ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
