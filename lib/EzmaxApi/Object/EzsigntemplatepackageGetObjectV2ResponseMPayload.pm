...
#
package EzmaxApi::Object::EzsigntemplatepackageGetObjectV2ResponseMPayload;
...
__PACKAGE__->class_documentation({description => 'Payload for GET /2/object/ezsigntemplatepackage/{pkiEzsigntemplatepackageID}',
