...
#
package EzmaxApi::Object::UserImpersonateV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for POST /1/object/user/{pkiUserID}/impersonate',
                                  class => 'UserImpersonateV1Response',
                                  required => [], # TODO
}                                 );
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'UserImpersonateV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
