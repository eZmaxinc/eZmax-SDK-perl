...
#
package EzmaxApi::Object::EzsigntemplateGetObjectV2Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /2/object/ezsigntemplate/{pkiEzsigntemplateID}',
...
__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'EzsigntemplateGetObjectV2ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
