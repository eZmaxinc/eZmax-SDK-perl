...
#
package EzmaxApi::Object::EzsigntemplatedocumentEditObjectV1Request;
...
__PACKAGE__->class_documentation({description => 'Request for PUT /1/object/ezsigntemplatedocument/{pkiEzsigntemplatedocumentID}',
...
__PACKAGE__->method_documentation({
    'obj_ezsigntemplatedocument' => {
        datatype => 'EzsigntemplatedocumentRequestCompound',
