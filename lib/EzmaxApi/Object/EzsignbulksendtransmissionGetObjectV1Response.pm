...
#
package EzmaxApi::Object::EzsignbulksendtransmissionGetObjectV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /1/object/ezsignbulksendtransmission/{pkiEzsignbulksendtransmissionID}',
...
__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'EzsignbulksendtransmissionGetObjectV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
...
__PACKAGE__->openapi_types( {
    'm_payload' => 'EzsignbulksendtransmissionGetObjectV1ResponseMPayload',
