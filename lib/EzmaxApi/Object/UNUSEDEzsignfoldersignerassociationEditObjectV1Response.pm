...
#
package EzmaxApi::Object::UNUSEDEzsignfoldersignerassociationEditObjectV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for the /1/object/ezsignfoldersignerassociation/editObject API Request',
