...
#
package EzmaxApi::Object::SessionhistoryGetListV1ResponseMPayload;
...
__PACKAGE__->class_documentation({description => 'Payload for GET /1/object/sessionhistory/getList',
...
__PACKAGE__->method_documentation({
    ...
    'a_obj_sessionhistory' => {
        datatype => 'ARRAY[SessionhistoryListElement]',
        base_name => 'a_objSessionhistory',
        description => '',
        format => '',
        read_only => '',
            },
