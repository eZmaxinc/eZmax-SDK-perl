...
#
package EzmaxApi::Object::EzsigndocumentGetEzsignformfieldgroupsV1ResponseMPayload;
...
__PACKAGE__->class_documentation({description => 'Payload for the /1/object/ezsigndocument/{pkiEzsigndocument}/getEzsignformfieldgroups API Request',
