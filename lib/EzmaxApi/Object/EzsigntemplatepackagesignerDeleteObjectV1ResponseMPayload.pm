...
#
package EzmaxApi::Object::EzsigntemplatepackagesignerDeleteObjectV1ResponseMPayload;
...
__PACKAGE__->class_documentation({description => 'Payload for DELETE /1/object/ezsigntemplatepackagesigner/{pkiEzsigntemplatepackagesignerID}',
