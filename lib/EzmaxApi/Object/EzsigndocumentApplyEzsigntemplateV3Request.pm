...
#
package EzmaxApi::Object::EzsigndocumentApplyEzsigntemplateV3Request;
...
__PACKAGE__->class_documentation({description => 'Request for POST /3/object/ezsigndocument/{pkiEzsigndocumentID}/applyezsigntemplate',
...
__PACKAGE__->method_documentation({
    ...
    'a_s_ezsigntemplatesigner' => {
        ...
        base_name => 'a_sEzsigntemplatesigner',
        description => '',
        format => '',
        read_only => '',
            },
