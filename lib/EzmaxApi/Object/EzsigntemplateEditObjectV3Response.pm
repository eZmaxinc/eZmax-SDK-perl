...
#
package EzmaxApi::Object::EzsigntemplateEditObjectV3Response;
...
__PACKAGE__->class_documentation({description => 'Response for PUT /3/object/ezsigntemplate/{pkiEzsigntemplateID}',
