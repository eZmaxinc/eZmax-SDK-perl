...
#
package EzmaxApi::Object::BrandingCreateObjectV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for POST /1/object/branding',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'BrandingCreateObjectV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
