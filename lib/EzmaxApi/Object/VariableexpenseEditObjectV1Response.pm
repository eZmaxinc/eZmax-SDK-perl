...
#
package EzmaxApi::Object::VariableexpenseEditObjectV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for PUT /1/object/variableexpense/{pkiVariableexpenseID}',
