...
#
package EzmaxApi::Object::FolderImportIntoEDMV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for POST /1/object/folder/{pkiFolderID}/importIntoEDM',
                                  class => 'FolderImportIntoEDMV1Response',
                                  required => [], # TODO
}                                 );
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'FolderImportIntoEDMV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
