...
#
package EzmaxApi::Object::UsergroupexternalGetUsergroupsV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /1/object/usergroupexternal/{pkiUsergroupexternalID}/getUsergroups',
...
__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'UsergroupexternalGetUsergroupsV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
