...
#
package EzmaxApi::Object::SystemconfigurationResponseCompound;
...
__PACKAGE__->method_documentation({
    ...
    'b_systemconfiguration_allowcomplexcreditcardsignature' => {
        datatype => 'boolean',
        base_name => 'bSystemconfigurationAllowcomplexcreditcardsignature',
        description => 'Whether is the system allows to have a complex creditcard signature',
        format => '',
        read_only => '',
            },
