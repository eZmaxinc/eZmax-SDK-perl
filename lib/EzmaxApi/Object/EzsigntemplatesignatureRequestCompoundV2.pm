...
#
package EzmaxApi::Object::EzsigntemplatesignatureRequestCompoundV2;
...
__PACKAGE__->method_documentation({
    ...
    'a_obj_ezsigntemplatesignaturecustomdate' => {
        datatype => 'ARRAY[EzsigntemplatesignaturecustomdateRequestCompoundV2]',
    ...
    'a_obj_ezsigntemplatesignaturepaymentdetail' => {
        datatype => 'ARRAY[EzsigntemplatesignaturepaymentdetailRequestCompound]',
