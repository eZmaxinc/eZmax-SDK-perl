...
#
package EzmaxApi::Object::EzsignpageConsultV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for POST /1/object/ezsignpage/{pkiEzsignpageID}/consult',
