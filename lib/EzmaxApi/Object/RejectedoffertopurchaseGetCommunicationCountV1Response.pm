...
#
package EzmaxApi::Object::RejectedoffertopurchaseGetCommunicationCountV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /1/object/rejectedoffertopurchase/{pkiRejectedoffertopurchaseID}/getCommunicationCount',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'RejectedoffertopurchaseGetCommunicationCountV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
