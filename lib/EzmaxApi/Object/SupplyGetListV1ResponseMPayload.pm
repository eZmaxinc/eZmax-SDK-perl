...
#
package EzmaxApi::Object::SupplyGetListV1ResponseMPayload;
...
__PACKAGE__->class_documentation({description => 'Payload for GET /1/object/supply/getList',
...
__PACKAGE__->method_documentation({
    ...
    'a_obj_supply' => {
        datatype => 'ARRAY[SupplyListElement]',
