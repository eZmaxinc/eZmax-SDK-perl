...
#
package EzmaxApi::Object::EmailtypeGetAutocompleteV2Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /2/object/emailtype/getAutocomplete',
...
__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'EmailtypeGetAutocompleteV2ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
