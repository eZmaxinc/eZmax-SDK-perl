...
#
package EzmaxApi::Object::EzsigntemplatesignerGetObjectV1ResponseMPayload;
...
__PACKAGE__->class_documentation({description => 'Payload for GET /1/object/ezsigntemplatesigner/{pkiEzsigntemplatesignerID}',
