...
#
package EzmaxApi::Object::CommonGetAutocompleteDisabledV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /1/object/xxx/getAutocomplete with a bDisabled Flag',
...
__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'ARRAY[CustomAutocompleteElementDisabledResponse]',
        base_name => 'mPayload',
        description => 'Generic Autocomplete Response with a bDisabled Flag',
        format => '',
        read_only => '',
            },
    'obj_debug_payload' => {
...
__PACKAGE__->openapi_types( {
    'm_payload' => 'ARRAY[CustomAutocompleteElementDisabledResponse]',
