...
#
package EzmaxApi::Object::CountryAutocompleteElementResponse;
...
__PACKAGE__->class_documentation({description => 'A Country AutocompleteElement Response',
...
__PACKAGE__->method_documentation({
    ...
    's_country_shortname' => {
        datatype => 'string',
        base_name => 'sCountryShortname',
        description => 'The shortname of the Country',
        format => '',
        read_only => '',
            },
    'b_country_isactive' => {
        datatype => 'boolean',
        base_name => 'bCountryIsactive',
