...
#
package EzmaxApi::Object::EzsigntemplatedocumentEditEzsigntemplateformfieldgroupsV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for PUT /1/object/ezsigntemplatedocument/{pkiEzsigntemplatedocumentID}/editEzsigntemplateformfieldgroups',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'EzsigntemplatedocumentEditEzsigntemplateformfieldgroupsV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
