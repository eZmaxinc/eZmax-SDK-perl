...
#
package EzmaxApi::Object::EzsigntemplateGetObjectV3Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /3/object/ezsigntemplate/{pkiEzsigntemplateID}',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'EzsigntemplateGetObjectV3ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
