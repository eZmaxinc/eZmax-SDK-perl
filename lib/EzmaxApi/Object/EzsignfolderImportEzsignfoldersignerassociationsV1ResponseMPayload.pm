...
#
package EzmaxApi::Object::EzsignfolderImportEzsignfoldersignerassociationsV1ResponseMPayload;
...
__PACKAGE__->class_documentation({description => 'Payload for POST /1/object/ezsignfolder/{pkiEzsignfolder}/importEzsignfoldersignerassociations',
