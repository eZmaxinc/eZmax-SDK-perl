...
#
package EzmaxApi::Object::EzsigntemplatepackagemembershipCreateObjectV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for POST /1/object/ezsigntemplatepackagemembership',
...
__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'EzsigntemplatepackagemembershipCreateObjectV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
