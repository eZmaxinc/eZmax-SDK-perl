...
#
package EzmaxApi::Object::EzsignfoldertypeGetObjectV3Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /3/object/ezsignfoldertype/{pkiEzsignfoldertypeID}',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'EzsignfoldertypeGetObjectV3ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
