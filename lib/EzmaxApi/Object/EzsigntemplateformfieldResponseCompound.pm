...
#
package EzmaxApi::Object::EzsigntemplateformfieldResponseCompound;
...
use base ("Class::Accessor", "Class::Data::Inheritable", "EzmaxApi::Object::EzsigntemplateformfieldResponse");
...
sub init
{
    ...
    # initialize parent object EzsigntemplateformfieldResponse
    $self->EzmaxApi::Object::EzsigntemplateformfieldResponse::init(%args);
}
...
sub to_hash {
    ...
    # call EzsigntemplateformfieldResponse to_hash and then combine hash
    $_hash = { %$_hash, %$self->EzmaxApi::Object::EzsigntemplateformfieldResponse::to_hash };
...
sub TO_JSON {
    ...
    # combine parent (EzsigntemplateformfieldResponse) TO_JSON
    $_data = { %$_data, %$self->EzmaxApi::Object::EzsigntemplateformfieldResponse::TO_JSON };
...
sub from_hash {
    ...
    # call parent (EzsigntemplateformfieldResponse) from_hash
    $self->EzmaxApi::Object::EzsigntemplateformfieldResponse::from_hash($hash);
...
__PACKAGE__->class_documentation({description => 'An Ezsigntemplateformfield Object and children',
