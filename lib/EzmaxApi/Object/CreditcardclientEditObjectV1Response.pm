...
#
package EzmaxApi::Object::CreditcardclientEditObjectV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for PUT /1/object/creditcardclient/{pkiCreditcardclientID}',
