...
#
package EzmaxApi::Object::EzsigntemplateEditObjectV1Request;
...
__PACKAGE__->class_documentation({description => 'Request for PUT /1/object/ezsigntemplate/{pkiEzsigntemplateID}',
...
__PACKAGE__->method_documentation({
    'obj_ezsigntemplate' => {
        datatype => 'EzsigntemplateRequestCompound',
