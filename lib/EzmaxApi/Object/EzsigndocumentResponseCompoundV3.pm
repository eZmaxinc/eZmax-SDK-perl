...
#
package EzmaxApi::Object::EzsigndocumentResponseCompoundV3;
...
__PACKAGE__->method_documentation({
    ...
    'b_ezsigndocument_sendtoged' => {
        datatype => 'boolean',
        base_name => 'bEzsigndocumentSendtoged',
        description => 'Whether the Ezsigndocument was copied to EDM',
        format => '',
        read_only => '',
            },
    'obj_audit' => {
    ...
    'i_ezsigndocument_steptotal' => {
        datatype => 'int',
        base_name => 'iEzsigndocumentSteptotal',
        description => 'The total number of steps',
        format => '',
        read_only => '',
            },
    'i_ezsigndocument_stepcurrent' => {
        datatype => 'int',
        base_name => 'iEzsigndocumentStepcurrent',
        description => 'The current step',
        format => '',
        read_only => '',
            },
    'a_obj_ezsignfoldersignerassociationstatus' => {
        datatype => 'ARRAY[CustomEzsignfoldersignerassociationstatusResponseV3]',
...
__PACKAGE__->openapi_types( {
    ...
    'i_ezsigndocument_steptotal' => 'int',
    'i_ezsigndocument_stepcurrent' => 'int',
