...
#
package EzmaxApi::Object::EzsignfolderReorderV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for POST /1/object/ezsignfolder/{pkiEzsignfolderID}/reorder',
