...
#
package EzmaxApi::Object::EzsignbulksendsignermappingCreateObjectV1Request;
...
__PACKAGE__->class_documentation({description => 'Request for POST /1/object/ezsignbulksendsignermapping',
...
__PACKAGE__->method_documentation({
    'a_obj_ezsignbulksendsignermapping' => {
        datatype => 'ARRAY[EzsignbulksendsignermappingRequestCompound]',
