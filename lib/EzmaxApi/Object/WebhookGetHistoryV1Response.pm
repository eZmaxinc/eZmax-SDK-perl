...
#
package EzmaxApi::Object::WebhookGetHistoryV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /1/object/webhook/{pkiWebhookID}/getHistory',
...
__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'WebhookGetHistoryV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
