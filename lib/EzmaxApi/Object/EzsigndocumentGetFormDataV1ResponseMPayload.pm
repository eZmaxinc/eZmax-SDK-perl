...
#
package EzmaxApi::Object::EzsigndocumentGetFormDataV1ResponseMPayload;
...
__PACKAGE__->class_documentation({description => 'Payload for the /1/object/ezsigndocument/{pkiEzsigndocument}/getFormData API Request',
...
__PACKAGE__->method_documentation({
    ...
    'a_obj_form_data_signer' => {
        datatype => 'ARRAY[CustomFormDataSignerResponse]',
        base_name => 'a_objFormDataSigner',
        description => '',
        format => '',
        read_only => '',
            },
