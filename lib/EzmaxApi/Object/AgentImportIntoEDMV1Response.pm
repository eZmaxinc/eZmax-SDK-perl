...
#
package EzmaxApi::Object::AgentImportIntoEDMV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for POST /1/object/agent/{pkiAgentID}/importIntoEDM',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'AgentImportIntoEDMV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
