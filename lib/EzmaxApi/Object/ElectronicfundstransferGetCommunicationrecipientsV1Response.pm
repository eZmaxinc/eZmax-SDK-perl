...
#
package EzmaxApi::Object::ElectronicfundstransferGetCommunicationrecipientsV1Response;
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'ElectronicfundstransferGetCommunicationrecipientsV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
