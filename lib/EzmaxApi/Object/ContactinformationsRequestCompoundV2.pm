...
#
package EzmaxApi::Object::ContactinformationsRequestCompoundV2;
...
__PACKAGE__->class_documentation({description => 'A Contactinformations Object and children to create a complete structure',
