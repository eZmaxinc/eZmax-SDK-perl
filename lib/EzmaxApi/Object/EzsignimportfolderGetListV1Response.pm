...
#
package EzmaxApi::Object::EzsignimportfolderGetListV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /1/object/ezsignimportfolder/getList',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'EzsignimportfolderGetListV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
