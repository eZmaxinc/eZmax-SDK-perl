...
#
package EzmaxApi::Object::EzsigntemplatesignaturecustomdateResponseCompound;
...
__PACKAGE__->class_documentation({description => 'An Ezsigntemplatesignaturecustomdate Object and children to create a complete structure',
...
__PACKAGE__->method_documentation({
    'pki_ezsigntemplatesignaturecustomdate_id' => {
        datatype => 'int',
        base_name => 'pkiEzsigntemplatesignaturecustomdateID',
    ...
    'i_ezsigntemplatesignaturecustomdate_x' => {
        datatype => 'int',
        base_name => 'iEzsigntemplatesignaturecustomdateX',
    ...
    'i_ezsigntemplatesignaturecustomdate_y' => {
        datatype => 'int',
        base_name => 'iEzsigntemplatesignaturecustomdateY',
        description => 'The Y coordinate (Vertical) where to put the Ezsigntemplatesignaturecustomdate on the page.  Coordinate is calculated at 100dpi (dot per inch). So for example, if you want to put the Ezsigntemplatesignaturecustomdate 3 inches from the top border of the page, you would use \&quot;300\&quot; for the Y coordinate.',
        format => '',
        read_only => '',
            },
