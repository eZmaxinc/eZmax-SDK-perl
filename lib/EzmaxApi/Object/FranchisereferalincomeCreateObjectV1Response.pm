...
#
package EzmaxApi::Object::FranchisereferalincomeCreateObjectV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for the /1/object/franchisereferalincome/createObject API Request',
...
__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'FranchisereferalincomeCreateObjectV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
