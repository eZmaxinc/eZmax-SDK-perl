...
#
package EzmaxApi::Object::EzsigntemplatepackagesignerGetObjectV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /1/object/ezsigntemplatepackagesigner/{pkiEzsigntemplatepackagesignerID}',
                                  class => 'EzsigntemplatepackagesignerGetObjectV1Response',
                                  required => [], # TODO
}                                 );

__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'EzsigntemplatepackagesignerGetObjectV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
...
__PACKAGE__->openapi_types( {
    'm_payload' => 'EzsigntemplatepackagesignerGetObjectV1ResponseMPayload',
