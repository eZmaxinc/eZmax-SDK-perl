...
#
package EzmaxApi::Object::EzsigntemplateelementdependencyRequestCompound;
...
__PACKAGE__->class_documentation({description => 'An Ezsigntemplateelementdependency Object and children to create a complete structure',
...
__PACKAGE__->method_documentation({
    'pki_ezsigntemplateelementdependency_id' => {
        datatype => 'int',
        base_name => 'pkiEzsigntemplateelementdependencyID',
        description => 'The unique ID of the Ezsigntemplateelementdependency',
        format => '',
        read_only => '',
            },
    'fki_ezsigntemplateformfield_id_validation' => {
        datatype => 'int',
        base_name => 'fkiEzsigntemplateformfieldIDValidation',
    ...
    'fki_ezsigntemplateformfieldgroup_id_validation' => {
        datatype => 'int',
        base_name => 'fkiEzsigntemplateformfieldgroupIDValidation',
    ...
    's_ezsigntemplateelementdependency_ezsigntemplateformfieldgrouplabel' => {
        datatype => 'string',
        base_name => 'sEzsigntemplateelementdependencyEzsigntemplateformfieldgrouplabel',
    ...
    's_ezsigntemplateelementdependency_ezsigntemplateformfieldlabel' => {
        datatype => 'string',
        base_name => 'sEzsigntemplateelementdependencyEzsigntemplateformfieldlabel',
        description => 'The Label for the Ezsigntemplateformfield',
        format => '',
        read_only => '',
            },
    'e_ezsigntemplateelementdependency_validation' => {
        datatype => 'FieldEEzsigntemplateelementdependencyValidation',
        base_name => 'eEzsigntemplateelementdependencyValidation',
        description => '',
        format => '',
        read_only => '',
            },
    'b_ezsigntemplateelementdependency_selected' => {
        datatype => 'boolean',
        base_name => 'bEzsigntemplateelementdependencySelected',
        description => 'Whether if it&#39;s selected or not when using eEzsigntemplateelementdependencyValidation &#x3D; Selected',
        format => '',
        read_only => '',
            },
    'e_ezsigntemplateelementdependency_operator' => {
        datatype => 'FieldEEzsigntemplateelementdependencyOperator',
        base_name => 'eEzsigntemplateelementdependencyOperator',
        description => '',
        format => '',
        read_only => '',
            },
    's_ezsigntemplateelementdependency_value' => {
        datatype => 'string',
        base_name => 'sEzsigntemplateelementdependencyValue',
        description => 'The value of the Ezsignelementdependency',
        format => '',
        read_only => '',
            },
});
...
__PACKAGE__->openapi_types( {
    'pki_ezsigntemplateelementdependency_id' => 'int',
    'fki_ezsigntemplateformfield_id_validation' => 'int',
    'fki_ezsigntemplateformfieldgroup_id_validation' => 'int',
