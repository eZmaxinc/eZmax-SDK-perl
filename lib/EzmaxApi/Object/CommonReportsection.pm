...
#
package EzmaxApi::Object::CommonReportsection;
...
__PACKAGE__->class_documentation({description => 'A section in a Report. Each Reportsection shares Reportcolumns disposition with all its Reportsubsection ',
...
__PACKAGE__->method_documentation({
    'a_obj_reportsubsection' => {
        datatype => 'ARRAY[CommonReportsubsection]',
        base_name => 'a_objReportsubsection',
        description => '',
        format => '',
        read_only => '',
            },
    ...
    'e_reportsection_horizontalalignment' => {
        ...
        base_name => 'eReportsectionHorizontalalignment',
        description => '',
        format => '',
        read_only => '',
            },
    'i_reportsection_columncount' => {
        datatype => 'int',
        base_name => 'iReportsectionColumncount',
