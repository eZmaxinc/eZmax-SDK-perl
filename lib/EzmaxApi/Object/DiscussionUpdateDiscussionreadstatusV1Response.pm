...
#
package EzmaxApi::Object::DiscussionUpdateDiscussionreadstatusV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /1/object/discussion/{pkiDiscussionID}/updateDiscussionreadstatus',
