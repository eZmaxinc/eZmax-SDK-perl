...
#
package EzmaxApi::Object::EzsignbulksendListElement;
...
__PACKAGE__->class_documentation({description => 'An Ezsignbulksend List Element',
...
__PACKAGE__->method_documentation({
    ...
    'i_ezsignbulksendtransmission' => {
        datatype => 'int',
        base_name => 'iEzsignbulksendtransmission',
