...
#
package EzmaxApi::Object::InscriptionnotauthenticatedGetCommunicationrecipientsV1Response;
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'InscriptionnotauthenticatedGetCommunicationrecipientsV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
