...
#
package EzmaxApi::Object::LeadGetListV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /1/object/lead/getList',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'LeadGetListV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
