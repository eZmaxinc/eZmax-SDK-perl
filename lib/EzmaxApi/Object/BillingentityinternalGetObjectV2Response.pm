...
#
package EzmaxApi::Object::BillingentityinternalGetObjectV2Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /2/object/billingentityinternal/{pkiBillingentityinternalID}',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'BillingentityinternalGetObjectV2ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
