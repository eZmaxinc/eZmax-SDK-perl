...
#
package EzmaxApi::Object::EzsignfolderDuplicateV1ResponseMPayload;
...
__PACKAGE__->class_documentation({description => 'Payload for POST /1/object/ezsignfolder/{pkiEzsignfolderID}/duplicate',
