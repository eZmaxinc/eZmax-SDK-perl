...
#
package EzmaxApi::Object::ProvinceAutocompleteElementResponse;
...
__PACKAGE__->class_documentation({description => 'A Province AutocompleteElement Response',
...
__PACKAGE__->method_documentation({
    ...
    's_province_shortname' => {
        datatype => 'string',
        base_name => 'sProvinceShortname',
        description => 'The shortname of the Province',
        format => '',
        read_only => '',
            },
    'b_province_isactive' => {
        datatype => 'boolean',
        base_name => 'bProvinceIsactive',
        description => 'Whether the Province is active or not',
        format => '',
        read_only => '',
            },
});
