...
#
package EzmaxApi::Object::BuyercontractGetListV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /1/object/buyercontract/getList',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'BuyercontractGetListV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
