...
use base ("Class::Accessor", "Class::Data::Inheritable", "EzmaxApi::Object::EzsigntemplateResponse");
...
sub init
{
    ...
    # initialize parent object EzsigntemplateResponse
    $self->EzmaxApi::Object::EzsigntemplateResponse::init(%args);
}
...
sub to_hash {
    ...
    # call EzsigntemplateResponse to_hash and then combine hash
    $_hash = { %$_hash, %$self->EzmaxApi::Object::EzsigntemplateResponse::to_hash };
...
sub TO_JSON {
    ...
    # combine parent (EzsigntemplateResponse) TO_JSON
    $_data = { %$_data, %$self->EzmaxApi::Object::EzsigntemplateResponse::TO_JSON };
...
sub from_hash {
    ...
    # call parent (EzsigntemplateResponse) from_hash
    $self->EzmaxApi::Object::EzsigntemplateResponse::from_hash($hash);
