...
#
package EzmaxApi::Object::UsergroupmembershipCreateObjectV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for POST /1/object/usergroupmembership',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'UsergroupmembershipCreateObjectV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
