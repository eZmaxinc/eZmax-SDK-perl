...
#
package EzmaxApi::Object::WebhookGetObjectV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /1/object/webhook/{pkiWebhookID}',
...
__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'WebhookGetObjectV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
...
__PACKAGE__->openapi_types( {
    'm_payload' => 'WebhookGetObjectV1ResponseMPayload',
