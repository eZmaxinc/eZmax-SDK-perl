...
#
package EzmaxApi::Object::EzsigndocumentEditEzsignannotationsV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for PUT /1/object/ezsigndocument/{pkiEzsigndocumentID}/editEzsignannotations',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'EzsigndocumentEditEzsignannotationsV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
