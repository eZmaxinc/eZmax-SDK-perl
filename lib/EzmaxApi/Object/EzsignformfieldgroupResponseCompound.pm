...
#
package EzmaxApi::Object::EzsignformfieldgroupResponseCompound;
...
use base ("Class::Accessor", "Class::Data::Inheritable", "EzmaxApi::Object::EzsignformfieldgroupResponse");
...
sub init
{
    ...
    # initialize parent object EzsignformfieldgroupResponse
    $self->EzmaxApi::Object::EzsignformfieldgroupResponse::init(%args);
}
...
sub to_hash {
    ...
    # call EzsignformfieldgroupResponse to_hash and then combine hash
    $_hash = { %$_hash, %$self->EzmaxApi::Object::EzsignformfieldgroupResponse::to_hash };
...
sub TO_JSON {
    ...
    # combine parent (EzsignformfieldgroupResponse) TO_JSON
    $_data = { %$_data, %$self->EzmaxApi::Object::EzsignformfieldgroupResponse::TO_JSON };
...
sub from_hash {
    ...
    # call parent (EzsignformfieldgroupResponse) from_hash
    $self->EzmaxApi::Object::EzsignformfieldgroupResponse::from_hash($hash);
