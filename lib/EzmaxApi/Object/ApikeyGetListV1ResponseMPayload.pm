...
#
package EzmaxApi::Object::ApikeyGetListV1ResponseMPayload;
...
__PACKAGE__->class_documentation({description => 'Payload for GET /1/object/apikey/getList',
...
__PACKAGE__->method_documentation({
    ...
    'a_obj_apikey' => {
        datatype => 'ARRAY[ApikeyListElement]',
