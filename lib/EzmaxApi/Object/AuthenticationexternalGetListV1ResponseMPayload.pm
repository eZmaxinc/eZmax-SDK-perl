...
#
package EzmaxApi::Object::AuthenticationexternalGetListV1ResponseMPayload;
...
__PACKAGE__->class_documentation({description => 'Payload for GET /1/object/authenticationexternal/getList',
...
__PACKAGE__->method_documentation({
    'a_obj_authenticationexternal' => {
        datatype => 'ARRAY[AuthenticationexternalListElement]',
