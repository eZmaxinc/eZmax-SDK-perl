...
#
package EzmaxApi::Object::WebhookGetObjectV2Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /2/object/webhook/{pkiWebhookID}',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'WebhookGetObjectV2ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
