...
#
package EzmaxApi::Object::EzsignsignatureEditObjectV2Response;
...
__PACKAGE__->class_documentation({description => 'Response for PUT /2/object/ezsignsignature/{pkiEzsignsignatureID}',
