...
#
package EzmaxApi::Object::AddressResponseCompound;
...
__PACKAGE__->class_documentation({description => 'An Address Object and children to create a complete structure',
