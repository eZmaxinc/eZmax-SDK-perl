...
#
package EzmaxApi::Object::EzmaxinvoicingAutocompleteElementResponse;
...
__PACKAGE__->class_documentation({description => 'A Ezmaxinvoicing AutocompleteElement Response',
...
__PACKAGE__->method_documentation({
    ...
    'b_ezmaxinvoicing_isactive' => {
        datatype => 'boolean',
        base_name => 'bEzmaxinvoicingIsactive',
