...
#
package EzmaxApi::Object::EzmaxinvoicingGetAutocompleteV2Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /2/object/ezmaxinvoicing/getAutocomplete',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'EzmaxinvoicingGetAutocompleteV2ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
