...
#
package EzmaxApi::Object::EzsigntemplatedocumentPatchObjectV1Request;
...
__PACKAGE__->class_documentation({description => 'Request for PATCH /1/object/ezsigntemplatedocument/{pkiEzsigntemplatedocumentID}',
...
__PACKAGE__->method_documentation({
    'obj_ezsigntemplatedocument' => {
        datatype => 'EzsigntemplatedocumentRequestPatch',
