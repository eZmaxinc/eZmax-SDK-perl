...
#
package EzmaxApi::Object::ApikeyEditPermissionsV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for PUT /1/object/apikey/{pkiApikeyID}/editPermissions',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'ApikeyEditPermissionsV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
