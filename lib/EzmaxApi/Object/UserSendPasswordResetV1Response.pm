...
#
package EzmaxApi::Object::UserSendPasswordResetV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for POST /1/object/user/{pkiUserID}/sendPasswordReset',
