...
#
package EzmaxApi::Object::AttemptResponseCompound;
...
__PACKAGE__->class_documentation({description => 'An Attempt object and children to create a complete structure',
