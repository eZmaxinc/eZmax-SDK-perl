...
#
package EzmaxApi::Object::EzsigndocumentGetEzsigndiscussionsV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /1/object/ezsigndocument/{pkiEzsigndocument}/getEzsigndiscussions',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'EzsigndocumentGetEzsigndiscussionsV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
