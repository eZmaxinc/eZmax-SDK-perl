...
#
package EzmaxApi::Object::AuthenticationexternalAutocompleteElementResponse;
...
__PACKAGE__->class_documentation({description => 'A Authenticationexternal AutocompleteElement Response',
...
__PACKAGE__->method_documentation({
    ...
    'b_authenticationexternal_isactive' => {
        datatype => 'boolean',
        base_name => 'bAuthenticationexternalIsactive',
        description => 'Whether the Authenticationexternal is active or not',
        format => '',
        read_only => '',
            },
});
