...
#
package EzmaxApi::Object::EzsigntemplatesignatureCreateObjectV2Response;
...
__PACKAGE__->class_documentation({description => 'Response for POST /2/object/ezsigntemplatesignature',
...
__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'EzsigntemplatesignatureCreateObjectV2ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
