...
#
package EzmaxApi::Object::DiscussionPatchObjectV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for PATCH /1/object/discussion/{pkiDiscussionID}',
