...
#
package EzmaxApi::Object::CustomEzsignfoldertransmissionResponse;
...
__PACKAGE__->class_documentation({description => 'An Ezsignfolder Object in the context of an Ezsignbulksendtransmission',
...
__PACKAGE__->method_documentation({
    ...
    'a_obj_ezsignfoldertransmission_signer' => {
        datatype => 'ARRAY[CustomEzsignfoldertransmissionSignerResponse]',
        base_name => 'a_objEzsignfoldertransmissionSigner',
        description => '',
        format => '',
        read_only => '',
            },
