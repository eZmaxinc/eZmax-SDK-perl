...
#
package EzmaxApi::Object::UsergroupDeleteObjectV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for DELETE /1/object/usergroup/{pkiUsergroupID}',
