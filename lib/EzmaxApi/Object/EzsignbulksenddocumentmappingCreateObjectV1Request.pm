...
#
package EzmaxApi::Object::EzsignbulksenddocumentmappingCreateObjectV1Request;
...
__PACKAGE__->class_documentation({description => 'Request for POST /1/object/ezsignbulksenddocumentmapping',
...
__PACKAGE__->method_documentation({
    'a_obj_ezsignbulksenddocumentmapping' => {
        datatype => 'ARRAY[EzsignbulksenddocumentmappingRequestCompound]',
