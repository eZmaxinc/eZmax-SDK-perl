...
#
package EzmaxApi::Object::EzsignbulksendsignermappingGetObjectV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /1/object/ezsignbulksendsignermapping/{pkiEzsignbulksendsignermappingID}',
                                  class => 'EzsignbulksendsignermappingGetObjectV1Response',
                                  required => [], # TODO
}                                 );

__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'EzsignbulksendsignermappingGetObjectV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
...
__PACKAGE__->openapi_types( {
    'm_payload' => 'EzsignbulksendsignermappingGetObjectV1ResponseMPayload',
