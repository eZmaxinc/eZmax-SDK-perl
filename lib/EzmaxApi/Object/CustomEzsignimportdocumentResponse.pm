...
#
package EzmaxApi::Object::CustomEzsignimportdocumentResponse;
...
__PACKAGE__->class_documentation({description => 'An Ezsignimportdocument',
...
__PACKAGE__->method_documentation({
    'pki_ezsignimportdocument_id' => {
        datatype => 'int',
        base_name => 'pkiEzsignimportdocumentID',
    ...
    's_ezsignimportdocument_name' => {
        datatype => 'string',
        base_name => 'sEzsignimportdocumentName',
        description => 'The name of the Ezsignimportdocument',
        format => '',
        read_only => '',
            },
