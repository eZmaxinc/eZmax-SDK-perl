...
#
package EzmaxApi::Object::PermissionDeleteObjectV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for DELETE /1/object/permission/{pkiPermissionID}',
