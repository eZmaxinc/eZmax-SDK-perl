...
#
package EzmaxApi::Object::CustomEzsignfoldersignerassociationActionableElementResponseV2;
...
__PACKAGE__->method_documentation({
    ...
    'e_ezsignfoldersignerassociation_role' => {
        datatype => 'FieldEEzsignfoldersignerassociationRole',
        base_name => 'eEzsignfoldersignerassociationRole',
        description => '',
        format => '',
        read_only => '',
            },
