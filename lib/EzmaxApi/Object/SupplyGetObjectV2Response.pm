...
#
package EzmaxApi::Object::SupplyGetObjectV2Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /2/object/supply/{pkiSupplyID}',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'SupplyGetObjectV2ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
