...
#
package EzmaxApi::Object::DisclosureImportIntoEDMV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for POST /1/object/disclosure/{pkiDisclosureID}/importIntoEDM',
                                  class => 'DisclosureImportIntoEDMV1Response',
                                  required => [], # TODO
}                                 );
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'DisclosureImportIntoEDMV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
