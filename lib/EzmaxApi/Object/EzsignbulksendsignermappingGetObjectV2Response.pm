...
#
package EzmaxApi::Object::EzsignbulksendsignermappingGetObjectV2Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /2/object/ezsignbulksendsignermapping/{pkiEzsignbulksendsignermappingID}',
...
__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'EzsignbulksendsignermappingGetObjectV2ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
