...
#
package EzmaxApi::Object::TranqcontractGetCommunicationrecipientsV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /1/object/tranqcontract/{pkiTranqcontractID}/getCommunicationrecipients',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'TranqcontractGetCommunicationrecipientsV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
