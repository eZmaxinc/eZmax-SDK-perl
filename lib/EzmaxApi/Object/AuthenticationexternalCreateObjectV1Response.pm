...
#
package EzmaxApi::Object::AuthenticationexternalCreateObjectV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for POST /1/object/authenticationexternal',
...
__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'AuthenticationexternalCreateObjectV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
