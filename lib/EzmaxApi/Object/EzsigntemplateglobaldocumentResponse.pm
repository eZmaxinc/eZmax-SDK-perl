...
#
package EzmaxApi::Object::EzsigntemplateglobaldocumentResponse;
...
__PACKAGE__->class_documentation({description => 'A Ezsigntemplateglobaldocument Object',
...
__PACKAGE__->method_documentation({
    'pki_ezsigntemplateglobaldocument_id' => {
        datatype => 'int',
        base_name => 'pkiEzsigntemplateglobaldocumentID',
    ...
    's_ezsigntemplateglobaldocument_name' => {
        datatype => 'string',
        base_name => 'sEzsigntemplateglobaldocumentName',
        description => 'The name of the Ezsigntemplateglobaldocument.',
        format => '',
        read_only => '',
            },
    'i_ezsigntemplateglobaldocument_pagetotal' => {
        ...
        description => 'The number of pages in the Ezsigntemplateglobaldocument.',
        format => '',
        read_only => '',
            },
    'i_ezsigntemplateglobaldocument_signaturetotal' => {
        datatype => 'int',
        base_name => 'iEzsigntemplateglobaldocumentSignaturetotal',
        description => 'The number of total signatures in the Ezsigntemplateglobal.',
        format => '',
        read_only => '',
            },
});
