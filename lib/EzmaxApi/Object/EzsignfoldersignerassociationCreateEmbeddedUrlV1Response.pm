...
#
package EzmaxApi::Object::EzsignfoldersignerassociationCreateEmbeddedUrlV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for POST /1/object/ezsignfoldersignerassociation/createEmbeddedUrl',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'EzsignfoldersignerassociationCreateEmbeddedUrlV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
