...
#
package EzmaxApi::Object::UserstagedCreateUserV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for POST /1/object/userstaged/{pkiUserstagedID}/createUser',
...
__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'UserstagedCreateUserV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
