...
#
package EzmaxApi::Object::ModuleAutocompleteElementResponse;
...
__PACKAGE__->class_documentation({description => 'A Module AutocompleteElement Response',
