...
#
package EzmaxApi::Object::EzsignbulksendGetObjectV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for the /1/object/ezsignbulksend/getObject API Request',
...
__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'EzsignbulksendGetObjectV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
