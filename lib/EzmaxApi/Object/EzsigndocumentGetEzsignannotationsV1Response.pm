...
#
package EzmaxApi::Object::EzsigndocumentGetEzsignannotationsV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /1/object/ezsigndocument/{pkiEzsigndocument}/getEzsignannotations',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'EzsigndocumentGetEzsignannotationsV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
