...
#
package EzmaxApi::Object::EzsigntemplatepackagesignermembershipDeleteObjectV1ResponseMPayload;
...
__PACKAGE__->class_documentation({description => 'Payload for DELETE /1/object/ezsigntemplatepackagesignermembership/{pkiEzsigntemplatepackagesignermembershipID}',
