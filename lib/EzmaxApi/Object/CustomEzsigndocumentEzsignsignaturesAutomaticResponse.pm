...
#
package EzmaxApi::Object::CustomEzsigndocumentEzsignsignaturesAutomaticResponse;
...
__PACKAGE__->class_documentation({description => 'An Ezsigndocument Object in the context of an EzsignsignaturesAutomatic path',
...
__PACKAGE__->method_documentation({
    ...
    'a_obj_ezsignsignature' => {
        datatype => 'ARRAY[CustomEzsignsignatureEzsignsignaturesAutomaticResponse]',
