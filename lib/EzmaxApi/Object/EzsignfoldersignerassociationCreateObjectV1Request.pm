...
#
package EzmaxApi::Object::EzsignfoldersignerassociationCreateObjectV1Request;
...
__PACKAGE__->class_documentation({description => 'Request for the /1/object/ezsignfoldersignerassociation/createObject API Request',
...
__PACKAGE__->method_documentation({
    ...
    'obj_ezsignfoldersignerassociation_compound' => {
        datatype => 'EzsignfoldersignerassociationRequestCompound',
        base_name => 'objEzsignfoldersignerassociationCompound',
        description => '',
        format => '',
        read_only => '',
            },
