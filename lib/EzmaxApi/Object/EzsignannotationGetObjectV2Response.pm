...
#
package EzmaxApi::Object::EzsignannotationGetObjectV2Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /2/object/ezsignannotation/{pkiEzsignannotationID}',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'EzsignannotationGetObjectV2ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
