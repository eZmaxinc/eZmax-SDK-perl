...
#
package EzmaxApi::Object::AttachmentGetDownloadUrlV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /1/object/attachment/{pkiAttachmentID}/getDownloadUrl',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'AttachmentGetDownloadUrlV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
