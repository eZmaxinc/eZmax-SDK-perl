...
#
package EzmaxApi::Object::EzsignsignatureGetObjectV3Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /3/object/ezsignsignature/{pkiEzsignsignatureID}',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'EzsignsignatureGetObjectV3ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
