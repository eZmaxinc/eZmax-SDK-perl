...
#
package EzmaxApi::Object::InscriptiontempGetCommunicationrecipientsV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /1/object/inscriptiontemp/{pkiInscriptiontempID}/getCommunicationrecipients',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'InscriptiontempGetCommunicationrecipientsV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
