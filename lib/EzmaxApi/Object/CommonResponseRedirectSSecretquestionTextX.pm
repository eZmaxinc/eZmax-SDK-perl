...
#
package EzmaxApi::Object::CommonResponseRedirectSSecretquestionTextX;
...
__PACKAGE__->class_documentation({description => '352 Redirect Message containing secret question',
