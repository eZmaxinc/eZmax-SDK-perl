...
#
package EzmaxApi::Object::PaymenttermDeleteObjectV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for DELETE /1/object/paymentterm/{pkiPaymenttermID}',
                                  class => 'PaymenttermDeleteObjectV1Response',
                                  required => [], # TODO
}                                 );
