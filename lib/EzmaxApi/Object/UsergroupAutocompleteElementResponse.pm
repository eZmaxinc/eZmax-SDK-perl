...
#
package EzmaxApi::Object::UsergroupAutocompleteElementResponse;
...
__PACKAGE__->class_documentation({description => 'A Usergroup AutocompleteElement Response',
