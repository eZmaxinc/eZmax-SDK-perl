...
#
package EzmaxApi::Object::EzsigntemplateglobalAutocompleteElementResponse;
...
__PACKAGE__->class_documentation({description => 'A Ezsigntemplate AutocompleteElement Response',
...
__PACKAGE__->method_documentation({
    ...
    'b_ezsigntemplateglobal_isactive' => {
        datatype => 'boolean',
        base_name => 'bEzsigntemplateglobalIsactive',
