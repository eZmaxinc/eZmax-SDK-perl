...
#
package EzmaxApi::Object::EzsigntemplateglobalResponseCompound;
...
__PACKAGE__->class_documentation({description => 'A Ezsigntemplateglobal Object',
...
__PACKAGE__->method_documentation({
    ...
    'a_obj_ezsigntemplateglobalsigner' => {
        datatype => 'ARRAY[EzsigntemplateglobalsignerResponseCompound]',
        base_name => 'a_objEzsigntemplateglobalsigner',
        description => '',
        format => '',
        read_only => '',
            },
