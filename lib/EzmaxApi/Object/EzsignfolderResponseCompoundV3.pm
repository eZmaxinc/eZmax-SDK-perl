...
__PACKAGE__->method_documentation({
    ...
    'i_ezsignfolder_stepcurrent' => {
        datatype => 'int',
        base_name => 'iEzsignfolderStepcurrent',
        description => 'The current step of the ezsignfolder when eEzsignfolderCompletion &#x3D; &#39;PerEzsignfolderStepSync&#39;',
        format => '',
        read_only => '',
            },
    ...
    'e_ezsignfolder_access' => {
        datatype => 'ComputedEEzsignfolderAccess',
        base_name => 'eEzsignfolderAccess',
        description => '',
        format => '',
        read_only => '',
            },
...
__PACKAGE__->openapi_types( {
    ...
    'i_ezsignfolder_stepcurrent' => 'int',
