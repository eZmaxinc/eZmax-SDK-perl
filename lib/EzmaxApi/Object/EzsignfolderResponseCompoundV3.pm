...
#
package EzmaxApi::Object::EzsignfolderResponseCompoundV3;
...
use base ("Class::Accessor", "Class::Data::Inheritable", "EzmaxApi::Object::EzsignfolderResponseV3");
...
sub init
{
    ...
    # initialize parent object EzsignfolderResponseV3
    $self->EzmaxApi::Object::EzsignfolderResponseV3::init(%args);
}
...
sub to_hash {
    ...
    # call EzsignfolderResponseV3 to_hash and then combine hash
    $_hash = { %$_hash, %$self->EzmaxApi::Object::EzsignfolderResponseV3::to_hash };
...
sub TO_JSON {
    ...
    # combine parent (EzsignfolderResponseV3) TO_JSON
    $_data = { %$_data, %$self->EzmaxApi::Object::EzsignfolderResponseV3::TO_JSON };
...
sub from_hash {
    ...
    # call parent (EzsignfolderResponseV3) from_hash
    $self->EzmaxApi::Object::EzsignfolderResponseV3::from_hash($hash);
