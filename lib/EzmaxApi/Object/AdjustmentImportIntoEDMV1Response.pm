...
#
package EzmaxApi::Object::AdjustmentImportIntoEDMV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for POST /1/object/adjustment/{pkiAdjustmentID}/importIntoEDM',
                                  class => 'AdjustmentImportIntoEDMV1Response',
                                  required => [], # TODO
}                                 );
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'AdjustmentImportIntoEDMV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
