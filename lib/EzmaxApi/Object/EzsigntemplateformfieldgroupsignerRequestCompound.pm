...
#
package EzmaxApi::Object::EzsigntemplateformfieldgroupsignerRequestCompound;
...
__PACKAGE__->class_documentation({description => 'An Ezsigntemplateformfieldgroupsigner Object and children to create a complete structure',
...
__PACKAGE__->method_documentation({
    'pki_ezsigntemplateformfieldgroupsigner_id' => {
        datatype => 'int',
        base_name => 'pkiEzsigntemplateformfieldgroupsignerID',
...
__PACKAGE__->openapi_types( {
    'pki_ezsigntemplateformfieldgroupsigner_id' => 'int',
