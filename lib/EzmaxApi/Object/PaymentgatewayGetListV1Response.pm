...
#
package EzmaxApi::Object::PaymentgatewayGetListV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /1/object/paymentgateway/getList',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'PaymentgatewayGetListV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
