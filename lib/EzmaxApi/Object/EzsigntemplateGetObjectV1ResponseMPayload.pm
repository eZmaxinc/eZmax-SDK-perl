...
#
package EzmaxApi::Object::EzsigntemplateGetObjectV1ResponseMPayload;
...
__PACKAGE__->class_documentation({description => 'Payload for GET /1/object/ezsigntemplate/{pkiEzsigntemplateID}',
