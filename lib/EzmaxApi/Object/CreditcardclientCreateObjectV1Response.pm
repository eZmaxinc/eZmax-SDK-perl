...
#
package EzmaxApi::Object::CreditcardclientCreateObjectV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for POST /1/object/creditcardclient',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'CreditcardclientCreateObjectV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
