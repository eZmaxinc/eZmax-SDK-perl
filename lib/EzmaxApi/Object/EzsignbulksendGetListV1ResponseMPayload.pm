...
#
package EzmaxApi::Object::EzsignbulksendGetListV1ResponseMPayload;
...
__PACKAGE__->class_documentation({description => 'Payload for the /1/object/ezsignbulksend/getList API Request',
