...
#
package EzmaxApi::Object::CustomerGetAttachmentsV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /1/object/customer/{pkiCustomerID}/getAttachments',
                                  class => 'CustomerGetAttachmentsV1Response',
                                  required => [], # TODO
}                                 );
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'CustomerGetAttachmentsV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
