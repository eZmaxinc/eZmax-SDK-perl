...
#
package EzmaxApi::Object::EzsigntemplatesignatureResponseCompoundV3;
...
use base ("Class::Accessor", "Class::Data::Inheritable", "EzmaxApi::Object::EzsigntemplatesignatureResponse");
...
sub init
{
    ...
    # initialize parent object EzsigntemplatesignatureResponse
    $self->EzmaxApi::Object::EzsigntemplatesignatureResponse::init(%args);
}
...
sub to_hash {
    ...
    # call EzsigntemplatesignatureResponse to_hash and then combine hash
    $_hash = { %$_hash, %$self->EzmaxApi::Object::EzsigntemplatesignatureResponse::to_hash };
...
sub TO_JSON {
    ...
    # combine parent (EzsigntemplatesignatureResponse) TO_JSON
    $_data = { %$_data, %$self->EzmaxApi::Object::EzsigntemplatesignatureResponse::TO_JSON };
...
sub from_hash {
    ...
    # call parent (EzsigntemplatesignatureResponse) from_hash
    $self->EzmaxApi::Object::EzsigntemplatesignatureResponse::from_hash($hash);
...
__PACKAGE__->method_documentation({
    ...
    'a_obj_ezsigntemplatesignaturecustomdate' => {
        datatype => 'ARRAY[EzsigntemplatesignaturecustomdateResponseCompoundV2]',
