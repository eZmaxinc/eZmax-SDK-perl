...
#
package EzmaxApi::Object::EzsignsignatureEditObjectV3Response;
...
__PACKAGE__->class_documentation({description => 'Response for PUT /3/object/ezsignsignature/{pkiEzsignsignatureID}',
