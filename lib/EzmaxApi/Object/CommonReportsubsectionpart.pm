...
#
package EzmaxApi::Object::CommonReportsubsectionpart;
...
__PACKAGE__->class_documentation({description => 'A part in the Reportsubsection ',
...
__PACKAGE__->method_documentation({
    'e_reportsubsectionpart_type' => {
        datatype => 'string',
        base_name => 'eReportsubsectionpartType',
        description => 'The type of the Reportsubsectionpart',
        format => '',
        read_only => '',
            },
    'a_obj_reportrow' => {
        datatype => 'ARRAY[CommonReportrow]',
        base_name => 'a_objReportrow',
        description => '',
        format => '',
        read_only => '',
            },
