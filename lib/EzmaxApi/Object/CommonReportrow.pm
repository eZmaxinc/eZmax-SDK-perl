...
#
package EzmaxApi::Object::CommonReportrow;
...
__PACKAGE__->class_documentation({description => 'A row in a Reportsubsectionpart ',
...
__PACKAGE__->method_documentation({
    'a_obj_reportcell' => {
        datatype => 'ARRAY[CommonReportcell]',
        base_name => 'a_objReportcell',
        description => '',
        format => '',
        read_only => '',
            },
    ...
    'obj_reportcellstyle_custom' => {
        datatype => 'CommonReportcellstylecustom',
        base_name => 'objReportcellstyleCustom',
        description => '',
        format => '',
        read_only => '',
            },
