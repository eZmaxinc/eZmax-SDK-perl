...
#
package EzmaxApi::Object::WebhookCreateObjectV2Response;
...
__PACKAGE__->class_documentation({description => 'Response for POST /2/object/webhook',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'WebhookCreateObjectV2ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
