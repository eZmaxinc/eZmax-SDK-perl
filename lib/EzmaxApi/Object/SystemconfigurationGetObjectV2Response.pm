...
#
package EzmaxApi::Object::SystemconfigurationGetObjectV2Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /2/object/systemconfiguration/{pkiSystemconfigurationID}',
...
__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'SystemconfigurationGetObjectV2ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
