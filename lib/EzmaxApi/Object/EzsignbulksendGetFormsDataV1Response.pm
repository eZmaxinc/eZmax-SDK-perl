...
#
package EzmaxApi::Object::EzsignbulksendGetFormsDataV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /1/object/ezsignbulksend/{pkiEzsignbulksendID}/getFormsData',
...
__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'EzsignbulksendGetFormsDataV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
