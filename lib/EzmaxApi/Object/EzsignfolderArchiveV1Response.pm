...
#
package EzmaxApi::Object::EzsignfolderArchiveV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for POST /1/object/ezsignfolder/{pkiEzsignfolderID}/archive',
