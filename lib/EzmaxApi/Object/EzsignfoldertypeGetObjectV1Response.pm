...
#
package EzmaxApi::Object::EzsignfoldertypeGetObjectV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for GET /1/object/ezsignfoldertype/{pkiEzsignfoldertypeID}',
...
__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'EzsignfoldertypeGetObjectV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
...
__PACKAGE__->openapi_types( {
    'm_payload' => 'EzsignfoldertypeGetObjectV1ResponseMPayload',
