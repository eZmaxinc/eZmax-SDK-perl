...
#
package EzmaxApi::Object::EzsignfolderDisposeV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for POST /1/object/ezsignfolder/{pkiEzsignfolderID}/dispose',
