...
#
package EzmaxApi::Object::EzsignformfieldgroupsignerResponseCompound;
...
__PACKAGE__->class_documentation({description => 'An Ezsignformfieldgroupsigner Object and children to create a complete structure',
...
__PACKAGE__->method_documentation({
    'pki_ezsignformfieldgroupsigner_id' => {
        datatype => 'int',
        base_name => 'pkiEzsignformfieldgroupsignerID',
...
__PACKAGE__->openapi_types( {
    'pki_ezsignformfieldgroupsigner_id' => 'int',
