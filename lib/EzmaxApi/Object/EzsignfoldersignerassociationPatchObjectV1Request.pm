...
#
package EzmaxApi::Object::EzsignfoldersignerassociationPatchObjectV1Request;
...
__PACKAGE__->class_documentation({description => 'Request for PATCH /1/object/ezsignfoldersignerassociation/{pkiEzsignfoldersignerassociationID}',
...
__PACKAGE__->method_documentation({
    'obj_ezsignfoldersignerassociation' => {
        datatype => 'EzsignfoldersignerassociationRequestPatch',
