...
#
package EzmaxApi::Object::DomainCreateObjectV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for POST /1/object/domain',
...
__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'DomainCreateObjectV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
