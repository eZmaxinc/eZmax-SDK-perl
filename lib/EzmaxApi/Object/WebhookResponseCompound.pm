...
use base ("Class::Accessor", "Class::Data::Inheritable", "EzmaxApi::Object::WebhookResponse");
...
sub init
{
    ...
    # initialize parent object WebhookResponse
    $self->EzmaxApi::Object::WebhookResponse::init(%args);
}
...
sub to_hash {
    ...
    # call WebhookResponse to_hash and then combine hash
    $_hash = { %$_hash, %$self->EzmaxApi::Object::WebhookResponse::to_hash };
...
sub TO_JSON {
    ...
    # combine parent (WebhookResponse) TO_JSON
    $_data = { %$_data, %$self->EzmaxApi::Object::WebhookResponse::TO_JSON };
...
sub from_hash {
    ...
    # call parent (WebhookResponse) from_hash
    $self->EzmaxApi::Object::WebhookResponse::from_hash($hash);
