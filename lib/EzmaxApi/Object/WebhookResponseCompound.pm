...
__PACKAGE__->method_documentation({
    ...
    'e_webhook_ezmaxpartnerevent' => {
        datatype => 'FieldEWebhookEzmaxpartnerevent',
        base_name => 'eWebhookEzmaxpartnerevent',
        description => '',
        format => '',
        read_only => '',
            },
    ...
    's_webhook_authentificationexternalerror' => {
        datatype => 'string',
        base_name => 'sWebhookAuthentificationexternalerror',
        description => 'Error message when token renewal failed or is not configured. Only if an Authenticationexternal is set.',
        format => '',
        read_only => '',
            },
    'a_obj_webhookheader' => {
