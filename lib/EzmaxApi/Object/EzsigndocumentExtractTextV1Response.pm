...
#
package EzmaxApi::Object::EzsigndocumentExtractTextV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for POST /1/object/ezsigndocument/{pkiEzsigndocumentID}/extractText',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'EzsigndocumentExtractTextV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
