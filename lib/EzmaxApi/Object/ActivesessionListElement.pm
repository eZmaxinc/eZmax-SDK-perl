...
#
package EzmaxApi::Object::ActivesessionListElement;
...
__PACKAGE__->class_documentation({description => 'A Activesession List Element',
...
__PACKAGE__->method_documentation({
    ...
    's_activesession_loginname' => {
        datatype => 'string',
        base_name => 'sActivesessionLoginname',
    ...
    'dt_activesession_firsthit' => {
        datatype => 'string',
        base_name => 'dtActivesessionFirsthit',
    ...
    'dt_activesession_lasthit' => {
        datatype => 'string',
        base_name => 'dtActivesessionLasthit',
