...
#
package EzmaxApi::Object::EzsignbulksendtransmissionGetEzsignsignaturesAutomaticV1ResponseMPayload;
...
__PACKAGE__->class_documentation({description => 'Payload for GET /1/object/ezsignbulksendtransmission/{pkiEzsignbulksendtransmissionID}/getEzsignsignaturesAutomatic',
...
__PACKAGE__->method_documentation({
    'a_e_ezsignsignature_type' => {
        datatype => 'ARRAY[FieldEEzsignsignatureType]',
        base_name => 'a_eEzsignsignatureType',
        description => 'All eEzsignsignatureType contained in the response',
        format => '',
        read_only => '',
            },
    'a_obj_ezsignfolder' => {
        datatype => 'ARRAY[CustomEzsignfolderEzsignsignaturesAutomaticResponse]',
