...
#
package EzmaxApi::Object::EzsigntemplatesignerCreateObjectV1ResponseMPayload;
...
__PACKAGE__->class_documentation({description => 'Payload for POST /1/object/ezsigntemplatesigner',
...
__PACKAGE__->method_documentation({
    'a_pki_ezsigntemplatesigner_id' => {
        datatype => 'ARRAY[int]',
        base_name => 'a_pkiEzsigntemplatesignerID',
...
__PACKAGE__->openapi_types( {
    'a_pki_ezsigntemplatesigner_id' => 'ARRAY[int]',
