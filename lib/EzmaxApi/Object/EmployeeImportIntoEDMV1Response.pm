...
#
package EzmaxApi::Object::EmployeeImportIntoEDMV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for POST /1/object/employee/{pkiEmployeeID}/importIntoEDM',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'EmployeeImportIntoEDMV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
