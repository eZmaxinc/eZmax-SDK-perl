...
#
package EzmaxApi::Object::CommonReportsubsection;
...
__PACKAGE__->class_documentation({description => 'A Subsection in a Reportsection. It contains 3 Reportsubsectionparts (Header, Body and Footer) ',
...
__PACKAGE__->method_documentation({
    'a_obj_reportcolumn' => {
        datatype => 'ARRAY[CommonReportcolumn]',
        base_name => 'a_objReportcolumn',
        description => '',
        format => '',
        read_only => '',
            },
    'i_reportsubsection_columncount' => {
        datatype => 'int',
        base_name => 'iReportsubsectionColumncount',
        description => 'The number of Reportcolumns in the Reportsection',
        format => '',
        read_only => '',
            },
    'i_reportsubsection_width' => {
        datatype => 'int',
        base_name => 'iReportsubsectionWidth',
        description => 'The combined width of all the Reportcolumns in the Reportsection',
        format => '',
        read_only => '',
            },
    'obj_reportsubsectionpart_header' => {
        datatype => 'CommonReportsubsectionpart',
        base_name => 'objReportsubsectionpartHeader',
        description => '',
        format => '',
        read_only => '',
            },
    'obj_reportsubsectionpart_body' => {
        datatype => 'CommonReportsubsectionpart',
        base_name => 'objReportsubsectionpartBody',
        description => '',
        format => '',
        read_only => '',
            },
    'obj_reportsubsectionpart_footer' => {
        datatype => 'CommonReportsubsectionpart',
        base_name => 'objReportsubsectionpartFooter',
        description => '',
        format => '',
        read_only => '',
            },
...
__PACKAGE__->openapi_types( {
    ...
    'i_reportsubsection_columncount' => 'int',
    'i_reportsubsection_width' => 'int',
