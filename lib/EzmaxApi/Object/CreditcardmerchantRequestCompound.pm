...
#
package EzmaxApi::Object::CreditcardmerchantRequestCompound;
...
__PACKAGE__->class_documentation({description => 'A Creditcardmerchant Object and children',
...
__PACKAGE__->method_documentation({
    ...
    's_creditcardmerchant_apitoken' => {
        datatype => 'string',
        base_name => 'sCreditcardmerchantApitoken',
        description => 'The apitoken of the Creditcardmerchant',
        format => '',
        read_only => '',
            },
