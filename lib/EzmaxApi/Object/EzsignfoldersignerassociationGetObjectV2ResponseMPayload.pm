...
#
package EzmaxApi::Object::EzsignfoldersignerassociationGetObjectV2ResponseMPayload;
...
__PACKAGE__->class_documentation({description => 'Payload for GET /2/object/ezsignfoldersignerassociation/{pkiEzsignfoldersignerassociationID}',
