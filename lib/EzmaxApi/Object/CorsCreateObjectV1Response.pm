...
#
package EzmaxApi::Object::CorsCreateObjectV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for POST /1/object/cors',
...
__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'CorsCreateObjectV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
