...
#
package EzmaxApi::Object::EzsigndocumentCreateEzsignelementsPositionedByWordV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for POST /1/object/ezsigndocument/{pkiEzsigndocumentID}/createEzsignelementsPositionedByWord',
...
__PACKAGE__->method_documentation({
    ...
    'm_payload' => {
        datatype => 'EzsigndocumentCreateEzsignelementsPositionedByWordV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
