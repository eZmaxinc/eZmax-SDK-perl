...
#
package EzmaxApi::Object::EzsigntemplatepublicResetUrlV1Response;
...
__PACKAGE__->class_documentation({description => 'Response for POST /1/object/ezsigntemplatepublic/{pkiEzsigntemplatepublicID}/resetUrl',
...
__PACKAGE__->method_documentation({
    'm_payload' => {
        datatype => 'EzsigntemplatepublicResetUrlV1ResponseMPayload',
        base_name => 'mPayload',
        description => '',
        format => '',
        read_only => '',
