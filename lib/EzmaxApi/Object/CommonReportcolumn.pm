...
#
package EzmaxApi::Object::CommonReportcolumn;
...
__PACKAGE__->class_documentation({description => 'A column in a Reportsection ',
...
__PACKAGE__->method_documentation({
    'obj_reportcellstyle_default' => {
        datatype => 'CommonReportcellstyle',
        base_name => 'objReportcellstyleDefault',
        description => '',
        format => '',
        read_only => '',
            },
