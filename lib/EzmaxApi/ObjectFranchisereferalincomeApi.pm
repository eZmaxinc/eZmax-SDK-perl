...
# Create a new Franchisereferalincome
#
# @param FranchisereferalincomeCreateObjectV2Request $franchisereferalincome_create_object_v2_request  (required)
{
    my $params = {
    'franchisereferalincome_create_object_v2_request' => {
        data_type => 'FranchisereferalincomeCreateObjectV2Request',
        description => '',
        required => '1',
    },
    };
    __PACKAGE__->method_documentation->{ 'franchisereferalincome_create_object_v2' } = {
        summary => 'Create a new Franchisereferalincome',
        params => $params,
...
#
sub franchisereferalincome_create_object_v2 {
    my ($self, %args) = @_;

    # verify the required parameter 'franchisereferalincome_create_object_v2_request' is set
    unless (exists $args{'franchisereferalincome_create_object_v2_request'}) {
      croak("Missing the required parameter 'franchisereferalincome_create_object_v2_request' when calling franchisereferalincome_create_object_v2");
    }

    # parse inputs
    my $_resource_path = '/2/object/franchisereferalincome';
    ...
    my $_body_data;
    # body params
    if ( exists $args{'franchisereferalincome_create_object_v2_request'}) {
        $_body_data = $args{'franchisereferalincome_create_object_v2_request'};
    }
    ...
    my $_response_object = $self->{api_client}->deserialize('FranchisereferalincomeCreateObjectV2Response', $response);
    return $_response_object;
}
