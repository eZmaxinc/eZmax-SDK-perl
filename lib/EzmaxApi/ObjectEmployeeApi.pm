...
#
package EzmaxApi::ObjectEmployeeApi;
...
# @param string $s_filter  (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'employee_get_list_v1' } = {
...
#
sub employee_get_list_v1 {
    my ($self, %args) = @_;

    # parse inputs
    my $_resource_path = '/1/object/employee/getList';
    ...
    my $_response_object = $self->{api_client}->deserialize('EmployeeGetListV1Response', $response);
...
# @param EmployeeImportIntoEDMV1Request $employee_import_into_edmv1_request  (required)
{
    my $params = {
    'pki_employee_id' => {
        data_type => 'int',
    ...
    'employee_import_into_edmv1_request' => {
        data_type => 'EmployeeImportIntoEDMV1Request',
        description => '',
        required => '1',
    },
    };
    __PACKAGE__->method_documentation->{ 'employee_import_into_edmv1' } = {
...
#
sub employee_import_into_edmv1 {
    my ($self, %args) = @_;

    # verify the required parameter 'pki_employee_id' is set
    unless (exists $args{'pki_employee_id'}) {
      croak("Missing the required parameter 'pki_employee_id' when calling employee_import_into_edmv1");
    }

    # verify the required parameter 'employee_import_into_edmv1_request' is set
    unless (exists $args{'employee_import_into_edmv1_request'}) {
      croak("Missing the required parameter 'employee_import_into_edmv1_request' when calling employee_import_into_edmv1");
    }

    # parse inputs
    my $_resource_path = '/1/object/employee/{pkiEmployeeID}/importIntoEDM';
    ...
    my $_body_data;
    # body params
    if ( exists $args{'employee_import_into_edmv1_request'}) {
        $_body_data = $args{'employee_import_into_edmv1_request'};
    }
    ...
    my $_response_object = $self->{api_client}->deserialize('EmployeeImportIntoEDMV1Response', $response);
    return $_response_object;
}
