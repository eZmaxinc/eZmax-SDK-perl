...
#
package EzmaxApi::Configuration;
...
use constant VERSION => '1.0.30';

=head1 Name

        EzmaxApi::Configuration - holds the configuration for all EzmaxApi Modules
...
default: OpenAPI-Generator/1.0.30/perl
...
default: https://prod.api.appcluster01.ca-central-1.ezmax.com/rest
...
sub new {
    ...
    $p{http_timeout} //= 180;
    $p{http_user_agent} //= 'OpenAPI-Generator/1.0.30/perl';
    ...
    # base_url
    $p{base_url} //= 'https://prod.api.appcluster01.ca-central-1.ezmax.com/rest';
