...
#
package EzmaxApi::ObjectBuyercontractApi;
...
# @param BuyercontractBatchDownloadV1Request $buyercontract_batch_download_v1_request  (required)
{
    my $params = {
    ...
    'buyercontract_batch_download_v1_request' => {
        data_type => 'BuyercontractBatchDownloadV1Request',
        description => '',
        required => '1',
    },
    };
    __PACKAGE__->method_documentation->{ 'buyercontract_batch_download_v1' } = {
        summary => 'Download multiples attachments from a Buyercontract',
        params => $params,
        returns => 'string',
        };
}
# @return string
#
sub buyercontract_batch_download_v1 {
    my ($self, %args) = @_;

    # verify the required parameter 'pki_buyercontract_id' is set
    unless (exists $args{'pki_buyercontract_id'}) {
      croak("Missing the required parameter 'pki_buyercontract_id' when calling buyercontract_batch_download_v1");
    }

    # verify the required parameter 'buyercontract_batch_download_v1_request' is set
    unless (exists $args{'buyercontract_batch_download_v1_request'}) {
      croak("Missing the required parameter 'buyercontract_batch_download_v1_request' when calling buyercontract_batch_download_v1");
    }

    # parse inputs
    my $_resource_path = '/1/object/buyercontract/{pkiBuyercontractID}/batchDownload';
    ...
    my $_body_data;
    # body params
    if ( exists $args{'buyercontract_batch_download_v1_request'}) {
        $_body_data = $args{'buyercontract_batch_download_v1_request'};
    }
...
# @param int $pki_buyercontract_id  (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'buyercontract_get_attachments_v1' } = {
        summary => 'Retrieve Buyercontract&#39;s attachments',
        params => $params,
...
#
sub buyercontract_get_attachments_v1 {
    my ($self, %args) = @_;

    # verify the required parameter 'pki_buyercontract_id' is set
    unless (exists $args{'pki_buyercontract_id'}) {
      croak("Missing the required parameter 'pki_buyercontract_id' when calling buyercontract_get_attachments_v1");
    }

    # parse inputs
    my $_resource_path = '/1/object/buyercontract/{pkiBuyercontractID}/getAttachments';
    ...
    my $_response_object = $self->{api_client}->deserialize('BuyercontractGetAttachmentsV1Response', $response);
    return $_response_object;
}
...
# @param int $pki_buyercontract_id  (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'buyercontract_get_communication_list_v1' } = {
...
#
sub buyercontract_get_communication_list_v1 {
    my ($self, %args) = @_;

    # verify the required parameter 'pki_buyercontract_id' is set
    unless (exists $args{'pki_buyercontract_id'}) {
      croak("Missing the required parameter 'pki_buyercontract_id' when calling buyercontract_get_communication_list_v1");
    }

    # parse inputs
    my $_resource_path = '/1/object/buyercontract/{pkiBuyercontractID}/getCommunicationList';
...
# @param string $s_filter  (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'buyercontract_get_list_v1' } = {
...
#
sub buyercontract_get_list_v1 {
    my ($self, %args) = @_;

    # parse inputs
    my $_resource_path = '/1/object/buyercontract/getList';
    ...
    my $_response_object = $self->{api_client}->deserialize('BuyercontractGetListV1Response', $response);
    return $_response_object;
}
...
#
# @param int $pki_buyercontract_id  (required)
# @param BuyercontractImportIntoEDMV1Request $buyercontract_import_into_edmv1_request  (required)
{
    my $params = {
    'pki_buyercontract_id' => {
        data_type => 'int',
    ...
    'buyercontract_import_into_edmv1_request' => {
        data_type => 'BuyercontractImportIntoEDMV1Request',
        description => '',
        required => '1',
    },
    };
    __PACKAGE__->method_documentation->{ 'buyercontract_import_into_edmv1' } = {
...
#
sub buyercontract_import_into_edmv1 {
    my ($self, %args) = @_;

    # verify the required parameter 'pki_buyercontract_id' is set
    unless (exists $args{'pki_buyercontract_id'}) {
      croak("Missing the required parameter 'pki_buyercontract_id' when calling buyercontract_import_into_edmv1");
    }

    # verify the required parameter 'buyercontract_import_into_edmv1_request' is set
    unless (exists $args{'buyercontract_import_into_edmv1_request'}) {
      croak("Missing the required parameter 'buyercontract_import_into_edmv1_request' when calling buyercontract_import_into_edmv1");
    }

    # parse inputs
    my $_resource_path = '/1/object/buyercontract/{pkiBuyercontractID}/importIntoEDM';
    ...
    my $_body_data;
    # body params
    if ( exists $args{'buyercontract_import_into_edmv1_request'}) {
        $_body_data = $args{'buyercontract_import_into_edmv1_request'};
    }
    ...
    my $_response_object = $self->{api_client}->deserialize('BuyercontractImportIntoEDMV1Response', $response);
    return $_response_object;
}
