...
# Create a new Ezsigntemplatesigner
#
# @param EzsigntemplatesignerCreateObjectV2Request $ezsigntemplatesigner_create_object_v2_request  (required)
{
    my $params = {
    'ezsigntemplatesigner_create_object_v2_request' => {
        data_type => 'EzsigntemplatesignerCreateObjectV2Request',
        description => '',
        required => '1',
    },
    };
    __PACKAGE__->method_documentation->{ 'ezsigntemplatesigner_create_object_v2' } = {
        summary => 'Create a new Ezsigntemplatesigner',
        params => $params,
...
#
sub ezsigntemplatesigner_create_object_v2 {
    my ($self, %args) = @_;

    # verify the required parameter 'ezsigntemplatesigner_create_object_v2_request' is set
    unless (exists $args{'ezsigntemplatesigner_create_object_v2_request'}) {
      croak("Missing the required parameter 'ezsigntemplatesigner_create_object_v2_request' when calling ezsigntemplatesigner_create_object_v2");
    }

    # parse inputs
    my $_resource_path = '/2/object/ezsigntemplatesigner';
    ...
    my $_body_data;
    # body params
    if ( exists $args{'ezsigntemplatesigner_create_object_v2_request'}) {
        $_body_data = $args{'ezsigntemplatesigner_create_object_v2_request'};
    }
    ...
    my $_response_object = $self->{api_client}->deserialize('EzsigntemplatesignerCreateObjectV2Response', $response);
    return $_response_object;
}
...
#
# @param int $pki_ezsigntemplatesigner_id  (required)
# @param EzsigntemplatesignerEditObjectV2Request $ezsigntemplatesigner_edit_object_v2_request  (required)
{
    my $params = {
    'pki_ezsigntemplatesigner_id' => {
        data_type => 'int',
    ...
    'ezsigntemplatesigner_edit_object_v2_request' => {
        data_type => 'EzsigntemplatesignerEditObjectV2Request',
        description => '',
        required => '1',
    },
    };
    __PACKAGE__->method_documentation->{ 'ezsigntemplatesigner_edit_object_v2' } = {
        summary => 'Edit an existing Ezsigntemplatesigner',
        params => $params,
...
#
sub ezsigntemplatesigner_edit_object_v2 {
    my ($self, %args) = @_;

    # verify the required parameter 'pki_ezsigntemplatesigner_id' is set
    unless (exists $args{'pki_ezsigntemplatesigner_id'}) {
      croak("Missing the required parameter 'pki_ezsigntemplatesigner_id' when calling ezsigntemplatesigner_edit_object_v2");
    }

    # verify the required parameter 'ezsigntemplatesigner_edit_object_v2_request' is set
    unless (exists $args{'ezsigntemplatesigner_edit_object_v2_request'}) {
      croak("Missing the required parameter 'ezsigntemplatesigner_edit_object_v2_request' when calling ezsigntemplatesigner_edit_object_v2");
    }
    ...
    my $_body_data;
    # body params
    if ( exists $args{'ezsigntemplatesigner_edit_object_v2_request'}) {
        $_body_data = $args{'ezsigntemplatesigner_edit_object_v2_request'};
    }
    ...
    my $_response_object = $self->{api_client}->deserialize('EzsigntemplatesignerEditObjectV2Response', $response);
    return $_response_object;
}
...
# @param int $pki_ezsigntemplatesigner_id  (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'ezsigntemplatesigner_get_object_v3' } = {
        summary => 'Retrieve an existing Ezsigntemplatesigner',
        params => $params,
...
#
sub ezsigntemplatesigner_get_object_v3 {
    my ($self, %args) = @_;

    # verify the required parameter 'pki_ezsigntemplatesigner_id' is set
    unless (exists $args{'pki_ezsigntemplatesigner_id'}) {
      croak("Missing the required parameter 'pki_ezsigntemplatesigner_id' when calling ezsigntemplatesigner_get_object_v3");
    }

    # parse inputs
    my $_resource_path = '/3/object/ezsigntemplatesigner/{pkiEzsigntemplatesignerID}';
    ...
    my $_response_object = $self->{api_client}->deserialize('EzsigntemplatesignerGetObjectV3Response', $response);
    return $_response_object;
}
