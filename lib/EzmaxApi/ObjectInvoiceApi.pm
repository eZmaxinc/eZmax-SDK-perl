...
# @param InvoiceBatchDownloadV1Request $invoice_batch_download_v1_request  (required)
{
    my $params = {
    'pki_invoice_id' => {
        data_type => 'int',
    ...
    'invoice_batch_download_v1_request' => {
        data_type => 'InvoiceBatchDownloadV1Request',
        description => '',
        required => '1',
    },
    };
    __PACKAGE__->method_documentation->{ 'invoice_batch_download_v1' } = {
...
# @return string
#
sub invoice_batch_download_v1 {
    my ($self, %args) = @_;

    # verify the required parameter 'pki_invoice_id' is set
    unless (exists $args{'pki_invoice_id'}) {
      croak("Missing the required parameter 'pki_invoice_id' when calling invoice_batch_download_v1");
    }

    # verify the required parameter 'invoice_batch_download_v1_request' is set
    unless (exists $args{'invoice_batch_download_v1_request'}) {
      croak("Missing the required parameter 'invoice_batch_download_v1_request' when calling invoice_batch_download_v1");
    }

    # parse inputs
    my $_resource_path = '/1/object/invoice/{pkiInvoiceID}/batchDownload';
    ...
    my $_body_data;
    # body params
    if ( exists $args{'invoice_batch_download_v1_request'}) {
        $_body_data = $args{'invoice_batch_download_v1_request'};
    }
