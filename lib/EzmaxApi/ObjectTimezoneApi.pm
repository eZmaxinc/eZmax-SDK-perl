...
#
package EzmaxApi::ObjectTimezoneApi;
...
#
# @param string $s_selector The type of Timezones to return (required)
...
# @param HeaderAcceptLanguage $accept_language  (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'timezone_get_autocomplete_v1' } = {
...
#
sub timezone_get_autocomplete_v1 {
    my ($self, %args) = @_;

    # verify the required parameter 's_selector' is set
    unless (exists $args{'s_selector'}) {
      croak("Missing the required parameter 's_selector' when calling timezone_get_autocomplete_v1");
    }

    # parse inputs
    my $_resource_path = '/1/object/timezone/getAutocomplete/{sSelector}';
...
# @param HeaderAcceptLanguage $accept_language  (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'timezone_get_autocomplete_v2' } = {
        summary => 'Retrieve Timezones and IDs',
        params => $params,
...
#
sub timezone_get_autocomplete_v2 {
    my ($self, %args) = @_;

    # verify the required parameter 's_selector' is set
    unless (exists $args{'s_selector'}) {
      croak("Missing the required parameter 's_selector' when calling timezone_get_autocomplete_v2");
    }

    # parse inputs
    my $_resource_path = '/2/object/timezone/getAutocomplete/{sSelector}';
    ...
    my $_response_object = $self->{api_client}->deserialize('TimezoneGetAutocompleteV2Response', $response);
    return $_response_object;
}
