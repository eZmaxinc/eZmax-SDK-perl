...
#
package EzmaxApi::ObjectLeadApi;
...
# @param string $s_filter  (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'lead_get_list_v1' } = {
...
#
sub lead_get_list_v1 {
    my ($self, %args) = @_;

    # parse inputs
    my $_resource_path = '/1/object/lead/getList';
    ...
    my $_response_object = $self->{api_client}->deserialize('LeadGetListV1Response', $response);
...
# @param LeadImportIntoEDMV1Request $lead_import_into_edmv1_request  (required)
{
    my $params = {
    'pki_lead_id' => {
        data_type => 'int',
    ...
    'lead_import_into_edmv1_request' => {
        data_type => 'LeadImportIntoEDMV1Request',
        description => '',
        required => '1',
    },
    };
    __PACKAGE__->method_documentation->{ 'lead_import_into_edmv1' } = {
...
#
sub lead_import_into_edmv1 {
    my ($self, %args) = @_;

    # verify the required parameter 'pki_lead_id' is set
    unless (exists $args{'pki_lead_id'}) {
      croak("Missing the required parameter 'pki_lead_id' when calling lead_import_into_edmv1");
    }

    # verify the required parameter 'lead_import_into_edmv1_request' is set
    unless (exists $args{'lead_import_into_edmv1_request'}) {
      croak("Missing the required parameter 'lead_import_into_edmv1_request' when calling lead_import_into_edmv1");
    }

    # parse inputs
    my $_resource_path = '/1/object/lead/{pkiLeadID}/importIntoEDM';
    ...
    my $_body_data;
    # body params
    if ( exists $args{'lead_import_into_edmv1_request'}) {
        $_body_data = $args{'lead_import_into_edmv1_request'};
    }
    ...
    my $_response_object = $self->{api_client}->deserialize('LeadImportIntoEDMV1Response', $response);
    return $_response_object;
}
