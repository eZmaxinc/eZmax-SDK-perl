...
# @param int $pki_webhook_id  (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'webhook_test_url_v1' } = {
...
#
sub webhook_test_url_v1 {
    my ($self, %args) = @_;

    # verify the required parameter 'pki_webhook_id' is set
    unless (exists $args{'pki_webhook_id'}) {
      croak("Missing the required parameter 'pki_webhook_id' when calling webhook_test_url_v1");
    }
