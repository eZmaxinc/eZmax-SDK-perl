...
#
package EzmaxApi::ObjectEzsigntsarequirementApi;
...
#
# @param string $s_selector The type of Ezsigntsarequirements to return (required)
...
# @param HeaderAcceptLanguage $accept_language  (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'ezsigntsarequirement_get_autocomplete_v1' } = {
...
#
sub ezsigntsarequirement_get_autocomplete_v1 {
    my ($self, %args) = @_;

    # verify the required parameter 's_selector' is set
    unless (exists $args{'s_selector'}) {
      croak("Missing the required parameter 's_selector' when calling ezsigntsarequirement_get_autocomplete_v1");
    }

    # parse inputs
    my $_resource_path = '/1/object/ezsigntsarequirement/getAutocomplete/{sSelector}';
...
# @param HeaderAcceptLanguage $accept_language  (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'ezsigntsarequirement_get_autocomplete_v2' } = {
        summary => 'Retrieve Ezsigntsarequirements and IDs',
        params => $params,
...
#
sub ezsigntsarequirement_get_autocomplete_v2 {
    my ($self, %args) = @_;

    # verify the required parameter 's_selector' is set
    unless (exists $args{'s_selector'}) {
      croak("Missing the required parameter 's_selector' when calling ezsigntsarequirement_get_autocomplete_v2");
    }

    # parse inputs
    my $_resource_path = '/2/object/ezsigntsarequirement/getAutocomplete/{sSelector}';
    ...
    my $_response_object = $self->{api_client}->deserialize('EzsigntsarequirementGetAutocompleteV2Response', $response);
    return $_response_object;
}
