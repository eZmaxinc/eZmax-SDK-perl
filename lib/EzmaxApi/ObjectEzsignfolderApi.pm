...
# @param int $pki_ezsignfolder_id The unique ID of the Ezsignfolder (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'ezsignfolder_get_object_get_children_v1' } = { 
...
# @return void
#
sub ezsignfolder_get_object_get_children_v1 {
    my ($self, %args) = @_;

    # verify the required parameter 'pki_ezsignfolder_id' is set
    unless (exists $args{'pki_ezsignfolder_id'}) {
      croak("Missing the required parameter 'pki_ezsignfolder_id' when calling ezsignfolder_get_object_get_children_v1");
    }
