...
sub ezsignfolder_batch_download_v1 {
    ...
    # 'Accept' and 'Content-Type' header
    my $_header_accept = $self->{api_client}->select_header_accept('application/zip', 'application/pdf', 'application/json');
    if ($_header_accept) {
        $header_params->{'Accept'} = $_header_accept;
    }
    $header_params->{'Content-Type'} = $self->{api_client}->select_header_content_type('application/json');
...
# @param int $pki_ezsignfolder_id  (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'ezsignfolder_get_actionable_elements_v2' } = {
        summary => 'Retrieve actionable elements for the Ezsignfolder',
        params => $params,
...
#
sub ezsignfolder_get_actionable_elements_v2 {
    my ($self, %args) = @_;

    # verify the required parameter 'pki_ezsignfolder_id' is set
    unless (exists $args{'pki_ezsignfolder_id'}) {
      croak("Missing the required parameter 'pki_ezsignfolder_id' when calling ezsignfolder_get_actionable_elements_v2");
    }

    # parse inputs
    my $_resource_path = '/2/object/ezsignfolder/{pkiEzsignfolderID}/getActionableElements';
    ...
    my $_response_object = $self->{api_client}->deserialize('EzsignfolderGetActionableElementsV2Response', $response);
    return $_response_object;
}
...
# @param int $pki_ezsignfolder_id  (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'ezsignfolder_get_ezsigndocuments_v2' } = {
        summary => 'Retrieve an existing Ezsignfolder&#39;s Ezsigndocuments',
        params => $params,
...
#
sub ezsignfolder_get_ezsigndocuments_v2 {
    my ($self, %args) = @_;

    # verify the required parameter 'pki_ezsignfolder_id' is set
    unless (exists $args{'pki_ezsignfolder_id'}) {
      croak("Missing the required parameter 'pki_ezsignfolder_id' when calling ezsignfolder_get_ezsigndocuments_v2");
    }

    # parse inputs
    my $_resource_path = '/2/object/ezsignfolder/{pkiEzsignfolderID}/getEzsigndocuments';
    ...
    my $_response_object = $self->{api_client}->deserialize('EzsignfolderGetEzsigndocumentsV2Response', $response);
    return $_response_object;
}
...
# @param int $pki_ezsignfolder_id  (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'ezsignfolder_get_ezsignfoldersignerassociations_v2' } = {
        summary => 'Retrieve an existing Ezsignfolder&#39;s Ezsignfoldersignerassociations',
        params => $params,
...
#
sub ezsignfolder_get_ezsignfoldersignerassociations_v2 {
    my ($self, %args) = @_;

    # verify the required parameter 'pki_ezsignfolder_id' is set
    unless (exists $args{'pki_ezsignfolder_id'}) {
      croak("Missing the required parameter 'pki_ezsignfolder_id' when calling ezsignfolder_get_ezsignfoldersignerassociations_v2");
    }

    # parse inputs
    my $_resource_path = '/2/object/ezsignfolder/{pkiEzsignfolderID}/getEzsignfoldersignerassociations';
    ...
    my $_response_object = $self->{api_client}->deserialize('EzsignfolderGetEzsignfoldersignerassociationsV2Response', $response);
    return $_response_object;
}
...
#
# @param int $pki_ezsignfolder_id  (required)
# @param EzsignfolderImportEzsigntemplatepackageV2Request $ezsignfolder_import_ezsigntemplatepackage_v2_request  (required)
{
    my $params = {
    'pki_ezsignfolder_id' => {
        data_type => 'int',
    ...
    'ezsignfolder_import_ezsigntemplatepackage_v2_request' => {
        data_type => 'EzsignfolderImportEzsigntemplatepackageV2Request',
        description => '',
        required => '1',
    },
    };
    __PACKAGE__->method_documentation->{ 'ezsignfolder_import_ezsigntemplatepackage_v2' } = {
        summary => 'Import an Ezsigntemplatepackage in the Ezsignfolder',
        params => $params,
...
#
sub ezsignfolder_import_ezsigntemplatepackage_v2 {
    my ($self, %args) = @_;

    # verify the required parameter 'pki_ezsignfolder_id' is set
    unless (exists $args{'pki_ezsignfolder_id'}) {
      croak("Missing the required parameter 'pki_ezsignfolder_id' when calling ezsignfolder_import_ezsigntemplatepackage_v2");
    }

    # verify the required parameter 'ezsignfolder_import_ezsigntemplatepackage_v2_request' is set
    unless (exists $args{'ezsignfolder_import_ezsigntemplatepackage_v2_request'}) {
      croak("Missing the required parameter 'ezsignfolder_import_ezsigntemplatepackage_v2_request' when calling ezsignfolder_import_ezsigntemplatepackage_v2");
    }

    # parse inputs
    my $_resource_path = '/2/object/ezsignfolder/{pkiEzsignfolderID}/importEzsigntemplatepackage';
    ...
    my $_body_data;
    # body params
    if ( exists $args{'ezsignfolder_import_ezsigntemplatepackage_v2_request'}) {
        $_body_data = $args{'ezsignfolder_import_ezsigntemplatepackage_v2_request'};
    }
