...
# @param int $pki_ezsignbulksenddocumentmapping_id  (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'ezsignbulksenddocumentmapping_get_object_v3' } = {
        summary => 'Retrieve an existing Ezsignbulksenddocumentmapping',
        params => $params,
...
#
sub ezsignbulksenddocumentmapping_get_object_v3 {
    my ($self, %args) = @_;

    # verify the required parameter 'pki_ezsignbulksenddocumentmapping_id' is set
    unless (exists $args{'pki_ezsignbulksenddocumentmapping_id'}) {
      croak("Missing the required parameter 'pki_ezsignbulksenddocumentmapping_id' when calling ezsignbulksenddocumentmapping_get_object_v3");
    }

    # parse inputs
    my $_resource_path = '/3/object/ezsignbulksenddocumentmapping/{pkiEzsignbulksenddocumentmappingID}';
    ...
    my $_response_object = $self->{api_client}->deserialize('EzsignbulksenddocumentmappingGetObjectV3Response', $response);
    return $_response_object;
}
