...
#
package EzmaxApi::ObjectTaxassignmentApi;
...
#
# @param string $s_selector The type of Taxassignments to return (required)
...
# @param HeaderAcceptLanguage $accept_language  (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'taxassignment_get_autocomplete_v1' } = {
...
#
sub taxassignment_get_autocomplete_v1 {
    my ($self, %args) = @_;

    # verify the required parameter 's_selector' is set
    unless (exists $args{'s_selector'}) {
      croak("Missing the required parameter 's_selector' when calling taxassignment_get_autocomplete_v1");
    }

    # parse inputs
    my $_resource_path = '/1/object/taxassignment/getAutocomplete/{sSelector}';
...
# @param HeaderAcceptLanguage $accept_language  (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'taxassignment_get_autocomplete_v2' } = {
        summary => 'Retrieve Taxassignments and IDs',
        params => $params,
...
#
sub taxassignment_get_autocomplete_v2 {
    my ($self, %args) = @_;

    # verify the required parameter 's_selector' is set
    unless (exists $args{'s_selector'}) {
      croak("Missing the required parameter 's_selector' when calling taxassignment_get_autocomplete_v2");
    }

    # parse inputs
    my $_resource_path = '/2/object/taxassignment/getAutocomplete/{sSelector}';
    ...
    my $_response_object = $self->{api_client}->deserialize('TaxassignmentGetAutocompleteV2Response', $response);
    return $_response_object;
}
