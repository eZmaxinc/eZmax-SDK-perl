...
#
# uncomment below and update the test
#my $ezsignfolder_end_prematurely_v1_pki_ezsignfolder_id = undef; # replace NULL with a proper value
#my $ezsignfolder_end_prematurely_v1_body = undef; # replace NULL with a proper value
#my $ezsignfolder_end_prematurely_v1_result = $api->ezsignfolder_end_prematurely_v1(pki_ezsignfolder_id => $ezsignfolder_end_prematurely_v1_pki_ezsignfolder_id, body => $ezsignfolder_end_prematurely_v1_body);
