...
#
{
    my $sspr_validate_token_v1_request = undef; # replace NULL with a proper value
    my $result = $api->sspr_validate_token_v1(sspr_validate_token_v1_request => $sspr_validate_token_v1_request);
}
